...
namespace UEModLoader.Game
{
    ...
    {
        public GuardianTestResult(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public HmdUserProfile(System.IntPtr ptr) : base(ptr) {}
        ...
        public TArray<System.IntPtr> ExtraFields => new TArray<System.IntPtr>(AddrOf(0x38)); // TArray<struct>
    }

    public class HmdUserProfileField : StructProxy
    {
        public HmdUserProfileField(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public OculusSplashDesc(System.IntPtr ptr) : base(ptr) {}
    ...
    public class OculusFunctionLibrary : BlueprintFunctionLibrary
    {
        ...
        public OculusFunctionLibrary(System.IntPtr ptr) : base(ptr) {}
        public static new OculusFunctionLibrary FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusFunctionLibrary(p);
        ...
        public static System.IntPtr NativeFunc_SetReorientHMDOnControllerRecenter => Memory.ModuleBase() + 0x5C5C4E8;
        ...
        public static System.IntPtr NativeFunc_SetPositionScale3D => Memory.ModuleBase() + 0x5C5C118;
        public void SetPositionScale3D(Vector PosScale3D)
        {
            var __pb = new ParamBuffer(12);
            __pb.Set<System.IntPtr>(0x0, PosScale3D);
        ...
        public static System.IntPtr NativeFunc_SetGuardianVisibility => Memory.ModuleBase() + 0x5C5AEC0;
        ...
        public static System.IntPtr NativeFunc_SetFixedFoveatedRenderingLevel => Memory.ModuleBase() + 0x5C5BA60;
        ...
        public static System.IntPtr NativeFunc_SetDisplayFrequency => Memory.ModuleBase() + 0x5C5B804;
        ...
        public static System.IntPtr NativeFunc_SetCPUAndGPULevels => Memory.ModuleBase() + 0x5C5C584;
        ...
        public static System.IntPtr NativeFunc_SetColorScaleAndOffset => Memory.ModuleBase() + 0x5C5B5AC;
        public void SetColorScaleAndOffset(LinearColor ColorScale, LinearColor ColorOffset, bool bApplyToAllLayers)
        {
            var __pb = new ParamBuffer(33);
            __pb.Set<System.IntPtr>(0x0, ColorScale);
            __pb.Set<System.IntPtr>(0x10, ColorOffset);
        ...
        public static System.IntPtr NativeFunc_SetClientColorDesc => Memory.ModuleBase() + 0x5C5B4AC;
        ...
        public static System.IntPtr NativeFunc_SetBaseRotationAndPositionOffset => Memory.ModuleBase() + 0x5C5C000;
        public void SetBaseRotationAndPositionOffset(Rotator BaseRot, Vector PosOffset, byte Options)
        {
            var __pb = new ParamBuffer(25);
            __pb.Set<System.IntPtr>(0x0, BaseRot);
            __pb.Set<System.IntPtr>(0xC, PosOffset);
        ...
        public static System.IntPtr NativeFunc_SetBaseRotationAndBaseOffsetInMeters => Memory.ModuleBase() + 0x5C5C294;
        public void SetBaseRotationAndBaseOffsetInMeters(Rotator Rotation, Vector BaseOffsetInMeters, byte Options)
        {
            var __pb = new ParamBuffer(25);
            __pb.Set<System.IntPtr>(0x0, Rotation);
            __pb.Set<System.IntPtr>(0xC, BaseOffsetInMeters);
            __pb.Set(0x18, Options);
        ...
        public static System.IntPtr NativeFunc_IsGuardianDisplayed => Memory.ModuleBase() + 0x5C5B3C4;
        ...
        public static System.IntPtr NativeFunc_IsGuardianConfigured => Memory.ModuleBase() + 0x5C5B38C;
        ...
        public static System.IntPtr NativeFunc_IsDeviceTracked => Memory.ModuleBase() + 0x5C5C658;
        ...
        public static System.IntPtr NativeFunc_HasSystemOverlayPresent => Memory.ModuleBase() + 0x5C5BCA4;
        ...
        public static System.IntPtr NativeFunc_HasInputFocus => Memory.ModuleBase() + 0x5C5BCDC;
        ...
        public static System.IntPtr NativeFunc_GetUserProfile => Memory.ModuleBase() + 0x5C5C3AC;
        public bool GetUserProfile(HmdUserProfile Profile)
        {
            var __pb = new ParamBuffer(73);
            __pb.Set<System.IntPtr>(0x0, Profile);
        ...
        public static System.IntPtr NativeFunc_GetSystemHmd3DofModeEnabled => Memory.ModuleBase() + 0x5C5B574;
        ...
        public static System.IntPtr NativeFunc_GetRawSensorData => Memory.ModuleBase() + 0x5C5C700;
        public void GetRawSensorData(Vector AngularAcceleration, Vector LinearAcceleration, Vector AngularVelocity, Vector LinearVelocity, float TimeInSeconds, ETrackedDeviceType DeviceType)
        {
            var __pb = new ParamBuffer(53);
            __pb.Set<System.IntPtr>(0x0, AngularAcceleration);
            __pb.Set<System.IntPtr>(0xC, LinearAcceleration);
            __pb.Set<System.IntPtr>(0x18, AngularVelocity);
            __pb.Set<System.IntPtr>(0x24, LinearVelocity);
        ...
        public static System.IntPtr NativeFunc_GetPose => Memory.ModuleBase() + 0x5C5C92C;
        public void GetPose(Rotator DeviceRotation, Vector DevicePosition, Vector NeckPosition, bool bUseOrienationForPlayerCamera, bool bUsePositionForPlayerCamera, Vector PositionScale)
        {
            var __pb = new ParamBuffer(52);
            __pb.Set<System.IntPtr>(0x0, DeviceRotation);
            __pb.Set<System.IntPtr>(0xC, DevicePosition);
            __pb.Set<System.IntPtr>(0x18, NeckPosition);
            __pb.Set<byte>(0x24, (byte)(bUseOrienationForPlayerCamera?1:0));
            __pb.Set<byte>(0x25, (byte)(bUsePositionForPlayerCamera?1:0));
            __pb.Set<System.IntPtr>(0x28, PositionScale);
        ...
        public static System.IntPtr NativeFunc_GetPointGuardianIntersection => Memory.ModuleBase() + 0x5C5B04C;
        public GuardianTestResult GetPointGuardianIntersection(Vector Point, EBoundaryType BoundaryType)
        {
            var __pb = new ParamBuffer(48);
            __pb.Set<System.IntPtr>(0x0, Point);
            __pb.Set<byte>(0xC, (byte)BoundaryType);
            CallRaw("GetPointGuardianIntersection", __pb.Bytes);
            return __pb.Get<GuardianTestResult>(0x10);
        }
        /// <summary>[Native] thunk RVA 0x5C5B13C — hookable via Hooks.InstallAt(NativeFunc_GetPlayAreaTransform).</summary>
        public static System.IntPtr NativeFunc_GetPlayAreaTransform => Memory.ModuleBase() + 0x5C5B13C;
        public Transform GetPlayAreaTransform()
        {
            var __pb = new ParamBuffer(48);
        ...
        public static System.IntPtr NativeFunc_GetNodeGuardianIntersection => Memory.ModuleBase() + 0x5C5AF5C;
        public GuardianTestResult GetNodeGuardianIntersection(ETrackedDeviceType DeviceType, EBoundaryType BoundaryType)
        {
            var __pb = new ParamBuffer(36);
            __pb.Set<byte>(0x0, (byte)DeviceType);
            __pb.Set<byte>(0x1, (byte)BoundaryType);
            CallRaw("GetNodeGuardianIntersection", __pb.Bytes);
            return __pb.Get<GuardianTestResult>(0x4);
        }
        /// <summary>[Native] thunk RVA 0x5C5B540 — hookable via Hooks.InstallAt(NativeFunc_GetHmdColorDesc).</summary>
        public static System.IntPtr NativeFunc_GetHmdColorDesc => Memory.ModuleBase() + 0x5C5B540;
        ...
        public static System.IntPtr NativeFunc_GetGuardianPoints => Memory.ModuleBase() + 0x5C5B250;
        public System.IntPtr GetGuardianPoints(EBoundaryType BoundaryType, bool UsePawnSpace)
        {
        ...
        public static System.IntPtr NativeFunc_GetGuardianDimensions => Memory.ModuleBase() + 0x5C5B1A8;
        public Vector GetGuardianDimensions(EBoundaryType BoundaryType)
        {
        ...
        public static System.IntPtr NativeFunc_GetGPUUtilization => Memory.ModuleBase() + 0x5C5BBA8;
        ...
        public static System.IntPtr NativeFunc_GetGPUFrameTime => Memory.ModuleBase() + 0x5C5BB74;
        ...
        public static System.IntPtr NativeFunc_GetFixedFoveatedRenderingLevel => Memory.ModuleBase() + 0x5C5BB40;
        ...
        public static System.IntPtr NativeFunc_GetDeviceType => Memory.ModuleBase() + 0x5C5B97C;
        ...
        public static System.IntPtr NativeFunc_GetDeviceName => Memory.ModuleBase() + 0x5C5B9B0;
        public System.IntPtr GetDeviceName()
        {
            var __pb = new ParamBuffer(16);
        ...
        public static System.IntPtr NativeFunc_GetDeviceBuildNumber => Memory.ModuleBase() + 0x5C5B3FC;
        public System.IntPtr GetDeviceBuildNumber()
        {
            var __pb = new ParamBuffer(16);
        ...
        public static System.IntPtr NativeFunc_GetCurrentDisplayFrequency => Memory.ModuleBase() + 0x5C5B898;
        ...
        public static System.IntPtr NativeFunc_GetBaseRotationAndPositionOffset => Memory.ModuleBase() + 0x5C5BF0C;
        public void GetBaseRotationAndPositionOffset(Rotator OutRot, Vector OutPosOffset)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, OutRot);
            __pb.Set<System.IntPtr>(0xC, OutPosOffset);
        ...
        public static System.IntPtr NativeFunc_GetBaseRotationAndBaseOffsetInMeters => Memory.ModuleBase() + 0x5C5C1A0;
        public void GetBaseRotationAndBaseOffsetInMeters(Rotator OutRotation, Vector OutBaseOffsetInMeters)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, OutRotation);
            __pb.Set<System.IntPtr>(0xC, OutBaseOffsetInMeters);
        ...
        public static System.IntPtr NativeFunc_GetAvailableDisplayFrequencies => Memory.ModuleBase() + 0x5C5B8CC;
        public System.IntPtr GetAvailableDisplayFrequencies()
        {
            var __pb = new ParamBuffer(16);
        ...
        public static System.IntPtr NativeFunc_EnablePositionTracking => Memory.ModuleBase() + 0x5C5B768;
        ...
        public static System.IntPtr NativeFunc_EnableOrientationTracking => Memory.ModuleBase() + 0x5C5B6CC;
        ...
        public static System.IntPtr NativeFunc_ClearLoadingSplashScreens => Memory.ModuleBase() + 0x5C5BD14;
        ...
        public static System.IntPtr NativeFunc_AddLoadingSplashScreen => Memory.ModuleBase() + 0x5C5BD28;
        public void AddLoadingSplashScreen(Texture2D Texture, Vector TranslationInMeters, Rotator Rotation, Vector2D SizeInMeters, Rotator DeltaRotation, bool bClearBeforeAdd)
        {
            var __pb = new ParamBuffer(53);
            __pb.SetObject(0x0, Texture);
            __pb.Set<System.IntPtr>(0x8, TranslationInMeters);
            __pb.Set<System.IntPtr>(0x14, Rotation);
            __pb.Set<System.IntPtr>(0x20, SizeInMeters);
    ...
    public class OculusHMDRuntimeSettings : Object
    {
        ...
        public OculusHMDRuntimeSettings(System.IntPtr ptr) : base(ptr) {}
        public static new OculusHMDRuntimeSettings FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusHMDRuntimeSettings(p);
        ...
        public TArray<System.IntPtr> SplashDescs => new TArray<System.IntPtr>(AddrOf(0x30)); // TArray<struct>
    ...
    public class OculusResourceHolder : Object
    {
        ...
        public OculusResourceHolder(System.IntPtr ptr) : base(ptr) {}
        public static new OculusResourceHolder FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusResourceHolder(p);
        ...
        public Material PokeAHoleMaterial { get { var __p = GetAt<System.IntPtr>(0x28); return __p==System.IntPtr.Zero?null:new Material(__p); } set => SetAt(0x28, value?.Pointer ?? System.IntPtr.Zero); }
    }

    public class OculusSceneCaptureCubemap : Object
    {
        public const string UeClassName = "OculusSceneCaptureCubemap";
        public OculusSceneCaptureCubemap(System.IntPtr ptr) : base(ptr) {}
        public static new OculusSceneCaptureCubemap FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusSceneCaptureCubemap(p);
        ...
        public TArray<System.IntPtr> CaptureComponents => new TArray<System.IntPtr>(AddrOf(0x38)); // TArray<UObject*>
    }
