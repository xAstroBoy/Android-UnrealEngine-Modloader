...
namespace UEModLoader.Game
{
    ...
    {
        public OverlayItem(System.IntPtr ptr) : base(ptr) {}
    ...
    public class Overlays : Object
    {
        ...
        public Overlays(System.IntPtr ptr) : base(ptr) {}
        public static new Overlays FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new Overlays(p);
    ...
    public class BasicOverlays : Overlays
    {
        ...
        public BasicOverlays(System.IntPtr ptr) : base(ptr) {}
        public static new BasicOverlays FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new BasicOverlays(p);
        ...
        public TArray<System.IntPtr> Overlays => new TArray<System.IntPtr>(AddrOf(0x28)); // TArray<struct>
    }

    public class LocalizedOverlays : Overlays
    {
        public const string UeClassName = "LocalizedOverlays";
        public LocalizedOverlays(System.IntPtr ptr) : base(ptr) {}
        public static new LocalizedOverlays FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new LocalizedOverlays(p);
        ...
        public BasicOverlays DefaultOverlays { get { var __p = GetAt<System.IntPtr>(0x28); return __p==System.IntPtr.Zero?null:new BasicOverlays(__p); } set => SetAt(0x28, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr LocaleToOverlaysMap => AddrOf(0x30); // 
    }
