...
namespace UEModLoader.Game
{
    public class VR4GamePlayerAmmo_Wep13_BP_C : VR4GamePlayerAmmo
    {
        ...
        public VR4GamePlayerAmmo_Wep13_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4GamePlayerAmmo_Wep13_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4GamePlayerAmmo_Wep13_BP_C(p);
        ...
        public AudioComponent SFX_Ammo { get { var __p = GetAt<System.IntPtr>(0x638); return __p==System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x638, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public VR4GamePlayerGripIKTarget SkeletalPrimaryGripIKTarget { get { var __p = GetAt<System.IntPtr>(0x658); return __p==System.IntPtr.Zero?null:new VR4GamePlayerGripIKTarget(__p); } set => SetAt(0x658, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent PouchRocket { get { var __p = GetAt<System.IntPtr>(0x660); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x660, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent Pivot { get { var __p = GetAt<System.IntPtr>(0x668); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x668, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent TopRef { get { var __p = GetAt<System.IntPtr>(0x670); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x670, value?.Pointer ?? System.IntPtr.Zero); }
        public SkeletalMeshComponent PouchMesh { get { var __p = GetAt<System.IntPtr>(0x678); return __p==System.IntPtr.Zero?null:new SkeletalMeshComponent(__p); } set => SetAt(0x678, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Ammo_ScaleIn { get { var __p = GetAt<System.IntPtr>(0x688); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x688, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TArray<System.IntPtr> ReloadHandPosePair => new TArray<System.IntPtr>(AddrOf(0x698)); // TArray<struct>
