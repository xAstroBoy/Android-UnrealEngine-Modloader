...
namespace UEModLoader.Game
{
    public class UI_MerchantScreen_Cover_BP_C : Actor
    {
        ...
        public UI_MerchantScreen_Cover_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_MerchantScreen_Cover_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_MerchantScreen_Cover_BP_C(p);
        ...
        public StaticMeshComponent CoverSlat { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_2 { get { var __p = GetAt<System.IntPtr>(0x230); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x230, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_3 { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_4 { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_5 { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_6 { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_7 { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_8 { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_9 { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent CoverSlat_10 { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent DefaultSceneRoot { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline { get { var __p = GetAt<System.IntPtr>(0x2D8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2D8, value?.Pointer ?? System.IntPtr.Zero); }
        public TArray<System.IntPtr> MotionArray => new TArray<System.IntPtr>(AddrOf(0x2E0)); // TArray<float>
        public TArray<System.IntPtr> RotationArray => new TArray<System.IntPtr>(AddrOf(0x2F0)); // TArray<float>
        public TArray<System.IntPtr> MeshArray => new TArray<System.IntPtr>(AddrOf(0x300)); // TArray<UObject*>
        ...
        public System.IntPtr OnAnimationDone => AddrOf(0x318); // 
