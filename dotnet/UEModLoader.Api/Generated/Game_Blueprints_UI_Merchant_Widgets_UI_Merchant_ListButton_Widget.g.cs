...
namespace UEModLoader.Game
{
    public class UI_Merchant_ListButton_Widget_C : UI_Merchant_Button_Widget_BP_C
    {
        ...
        public UI_Merchant_ListButton_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Merchant_ListButton_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Merchant_ListButton_Widget_C(p);
        ...
        public Image StrikeThrough { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Currency { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Name { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Value { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Underline { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr Price => AddrOf(0x298); // 
        public System.IntPtr Name => AddrOf(0x2B0); // 
        public VR4MerchantBuyItem Item => new VR4MerchantBuyItem(AddrOf(0x2C8));
        public System.IntPtr MerchantColors => AddrOf(0x6C8); // struct UI_MerchantColors_Struct
