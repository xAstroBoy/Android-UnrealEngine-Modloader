...
namespace UEModLoader.Game
{
    public class UI_PauseMenu_Header_Base_BP_C : Actor
    {
        ...
        public UI_PauseMenu_Header_Base_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_PauseMenu_Header_Base_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_PauseMenu_Header_Base_BP_C(p);
        ...
        public ChildActorComponent TitleBar { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new ChildActorComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public UI_TabTitle_BP_C Ref_Title { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new UI_TabTitle_BP_C(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public UI_PauseMenu_BP_C Ref_Parent_PauseMenu { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new UI_PauseMenu_BP_C(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public TArray<System.IntPtr> HeaderButtons => new TArray<System.IntPtr>(AddrOf(0x248)); // TArray<UObject*>
        ...
        public void UpdateTitle(System.IntPtr NewTitle)
        {
