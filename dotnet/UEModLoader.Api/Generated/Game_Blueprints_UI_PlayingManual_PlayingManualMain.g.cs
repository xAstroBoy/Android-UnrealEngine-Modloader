...
namespace UEModLoader.Game
{
    public class PlayingManualMain_C : VR4UIScreen
    {
        ...
        public PlayingManualMain_C(System.IntPtr ptr) : base(ptr) {}
        public static new PlayingManualMain_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new PlayingManualMain_C(p);
        ...
        public WidgetComponent Widget_Main { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_TransitionFinish { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_NormalTransitionStart { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_FirstSelection { get { var __p = GetAt<System.IntPtr>(0x298); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x298, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_MovieFade { get { var __p = GetAt<System.IntPtr>(0x2A8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2A8, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr ActiveDisplay => AddrOf(0x2B0); // struct PlayingManualEntry
        public PlayingManualMainWidget_C Widget { get { var __p = GetAt<System.IntPtr>(0x328); return __p==System.IntPtr.Zero?null:new PlayingManualMainWidget_C(__p); } set => SetAt(0x328, value?.Pointer ?? System.IntPtr.Zero); }
        public TimerHandle FadeDelayTimer => new TimerHandle(AddrOf(0x330));
        public System.IntPtr SkipText => AddrOf(0x338); // 
        public bool NoSelection { get => Native.GetPropBool(Pointer, "NoSelection"); set => Native.SetPropBool(Pointer, "NoSelection", value); }
        public System.IntPtr TransitionComplete => AddrOf(0x358); // 
        public System.IntPtr FadeInStarted => AddrOf(0x368); // 
        ...
        public TArray<System.IntPtr> ControllerCallouts => new TArray<System.IntPtr>(AddrOf(0x380)); // TArray<FText>
        public System.IntPtr BlankString => AddrOf(0x390); // 
        public BinkMediaPlayer BinkMediaPlayer { get { var __p = GetAt<System.IntPtr>(0x3A8); return __p==System.IntPtr.Zero?null:new BinkMediaPlayer(__p); } set => SetAt(0x3A8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void NewCategory(System.IntPtr Category)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Category);
