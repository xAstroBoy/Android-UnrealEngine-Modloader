...
namespace UEModLoader.Game
{
    public class UI_PauseMenu_Content_Files_BP_C : UI_PauseMenu_Content_BP_C
    {
        ...
        public UI_PauseMenu_Content_Files_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_PauseMenu_Content_Files_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_PauseMenu_Content_Files_BP_C(p);
        ...
        public StaticMeshComponent Track_Right { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Track_Left { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Frame_Right { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent Panel_Notes { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent Panel_Menu { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Frame_Left { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent Content { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent NoteBlocker { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent MenuBlocker { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_OpenToFile { get { var __p = GetAt<System.IntPtr>(0x298); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x298, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Unfold { get { var __p = GetAt<System.IntPtr>(0x2A8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2A8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent FoldUp_BigPanel { get { var __p = GetAt<System.IntPtr>(0x2B8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2B8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent PopBack { get { var __p = GetAt<System.IntPtr>(0x2C8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2C8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent PopForward { get { var __p = GetAt<System.IntPtr>(0x2D8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2D8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent ContractFrame { get { var __p = GetAt<System.IntPtr>(0x300); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x300, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent WidenFrame { get { var __p = GetAt<System.IntPtr>(0x328); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x328, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Panel_SlideOut { get { var __p = GetAt<System.IntPtr>(0x338); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x338, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent FoldUp { get { var __p = GetAt<System.IntPtr>(0x348); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x348, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Panel_SlideIn { get { var __p = GetAt<System.IntPtr>(0x358); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x358, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public MaterialInstanceDynamic NoteMaterial { get { var __p = GetAt<System.IntPtr>(0x368); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x368, value?.Pointer ?? System.IntPtr.Zero); }
        public TArray<System.IntPtr> NotesArray => new TArray<System.IntPtr>(AddrOf(0x370)); // TArray<FText>
        public TArray<System.IntPtr> PageNumberArray => new TArray<System.IntPtr>(AddrOf(0x380)); // TArray<FText>
        public FilesUIScreen_Entries_BP_C EntriesScreen { get { var __p = GetAt<System.IntPtr>(0x390); return __p==System.IntPtr.Zero?null:new FilesUIScreen_Entries_BP_C(__p); } set => SetAt(0x390, value?.Pointer ?? System.IntPtr.Zero); }
        public bool SkipList { get => Native.GetPropBool(Pointer, "SkipList"); set => Native.SetPropBool(Pointer, "SkipList", value); }
        public FilesUIScreen_Note_BP_C NoteScreen { get { var __p = GetAt<System.IntPtr>(0x3A0); return __p==System.IntPtr.Zero?null:new FilesUIScreen_Note_BP_C(__p); } set => SetAt(0x3A0, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4MissionFileContent FirstFile => new VR4MissionFileContent(AddrOf(0x3A8));
        public VR4GameInstance_BP_C GameInstance { get { var __p = GetAt<System.IntPtr>(0x3C8); return __p==System.IntPtr.Zero?null:new VR4GameInstance_BP_C(__p); } set => SetAt(0x3C8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void ShowFile(VR4MissionFileContent Content)
        {
