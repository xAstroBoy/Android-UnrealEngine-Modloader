...
namespace UEModLoader.Game
{
    public class ButtonImage_C : UserWidget
    {
        ...
        public ButtonImage_C(System.IntPtr ptr) : base(ptr) {}
        public static new ButtonImage_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new ButtonImage_C(p);
        ...
        public WidgetAnimation FillClear { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new WidgetAnimation(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetAnimation Fill { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new WidgetAnimation(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public Image ButtonImage { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Ring { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
