...
namespace UEModLoader.Game
{
    public class CutsceneListener_C : Interface
    {
        ...
        public CutsceneListener_C(System.IntPtr ptr) : base(ptr) {}
        public static new CutsceneListener_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new CutsceneListener_C(p);
        ...
        public void CutsceneEnded(System.IntPtr Cutscene, bool Callback)
        {
        ...
        public void CutsceneStarted(System.IntPtr Cutscene, bool Callback)
        {
            var __pb = new ParamBuffer(17);
            __pb.Set<System.IntPtr>(0x0, Cutscene);
            __pb.Set<byte>(0x10, (byte)(Callback?1:0));
