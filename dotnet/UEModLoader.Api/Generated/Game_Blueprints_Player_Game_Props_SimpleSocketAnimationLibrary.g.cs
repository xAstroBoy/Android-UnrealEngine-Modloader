...
namespace UEModLoader.Game
{
    public class SimpleSocketAnimationLibrary_C : BlueprintFunctionLibrary
    {
        ...
        public SimpleSocketAnimationLibrary_C(System.IntPtr ptr) : base(ptr) {}
        public static new SimpleSocketAnimationLibrary_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new SimpleSocketAnimationLibrary_C(p);
        ...
        public void ApplySimpleTransformAnimationToPoseableMesh(PoseableMeshComponent MeshComponent, FName BoneName, byte BoneSpace, float alpha, System.IntPtr Transforms, Object __WorldContext)
        {
            ...
            __pb.Set(0x14, alpha);
            __pb.Set<System.IntPtr>(0x20, Transforms);
            __pb.SetObject(0x80, __WorldContext);
            CallRaw("ApplySimpleTransformAnimationToPoseableMesh", __pb.Bytes);
        }
        public void ApplySimpleLocalTransformAnimationToPoseableMesh(PoseableMeshComponent MeshComponent, FName BoneName, float alpha, System.IntPtr Transforms, Object __WorldContext)
        {
            var __pb = new ParamBuffer(136);
            __pb.SetObject(0x0, MeshComponent);
            __pb.Set(0x8, BoneName);
        ...
        public void GetSimpleSocketAnimationTransforms(SceneComponent SocketSource, System.IntPtr Settings, byte TransformSpace, Object __WorldContext, System.IntPtr Transforms)
        {
            var __pb = new ParamBuffer(144);
            __pb.SetObject(0x0, SocketSource);
            __pb.Set<System.IntPtr>(0x8, Settings);
            __pb.Set(0x20, TransformSpace);
            __pb.SetObject(0x28, __WorldContext);
            __pb.Set<System.IntPtr>(0x30, Transforms);
