...
namespace UEModLoader.Game
{
    public class PlayingManualInfoTextWidget_C : UserWidget
    {
        ...
        public PlayingManualInfoTextWidget_C(System.IntPtr ptr) : base(ptr) {}
        public static new PlayingManualInfoTextWidget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new PlayingManualInfoTextWidget_C(p);
        ...
        public RichTextBlock InfoText { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new RichTextBlock(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public RichTextBlock InfoTextMerc { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new RichTextBlock(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public WidgetSwitcher WidgetSwitcher_text { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new WidgetSwitcher(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
