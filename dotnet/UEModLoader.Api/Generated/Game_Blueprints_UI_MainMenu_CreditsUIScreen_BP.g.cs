...
namespace UEModLoader.Game
{
    public class CreditsUIScreen_BP_C : VR4UIScreen
    {
        ...
        public CreditsUIScreen_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new CreditsUIScreen_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new CreditsUIScreen_BP_C(p);
        ...
        public WidgetComponent CreditWidget { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_ImageSwap { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_ImageFade { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Fade { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_CreditsRoll { get { var __p = GetAt<System.IntPtr>(0x2A0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2A0, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr CreditsComplete => AddrOf(0x2A8); // 
        public UI_Credits_Header_Widget_C CreditsWidget { get { var __p = GetAt<System.IntPtr>(0x2B8); return __p==System.IntPtr.Zero?null:new UI_Credits_Header_Widget_C(__p); } set => SetAt(0x2B8, value?.Pointer ?? System.IntPtr.Zero); }
        public float CreditsScrollSpeed { get => GetAt<float>(0x2C0); set => SetAt(0x2C0, value); }
        public TArray<System.IntPtr> CreditEntries => new TArray<System.IntPtr>(AddrOf(0x2C8)); // TArray<UObject*>
        ...
        public System.IntPtr ThanksForPlaying_ => AddrOf(0x320); // 
        public AudioComponent CreditsMusicSound2D { get { var __p = GetAt<System.IntPtr>(0x338); return __p==System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x338, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TArray<System.IntPtr> ImageNames => new TArray<System.IntPtr>(AddrOf(0x348)); // TArray<FName>
        ...
        public System.IntPtr EndCreditsStarted => AddrOf(0x370); // 
