...
namespace UEModLoader.Game
{
    public class ItemThumbnailWidget_C : UserWidget
    {
        ...
        public ItemThumbnailWidget_C(System.IntPtr ptr) : base(ptr) {}
        public static new ItemThumbnailWidget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new ItemThumbnailWidget_C(p);
        ...
        public SizeBox QuestionMark { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new SizeBox(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock TextBlock { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
