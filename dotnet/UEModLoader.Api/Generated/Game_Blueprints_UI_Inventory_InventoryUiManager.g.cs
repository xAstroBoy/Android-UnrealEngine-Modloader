...
namespace UEModLoader.Game
{
    public class InventoryUiManager_C : Actor
    {
        ...
        public InventoryUiManager_C(System.IntPtr ptr) : base(ptr) {}
        public static new InventoryUiManager_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new InventoryUiManager_C(p);
        ...
        public WidgetComponent WidgetUiParent { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public AttacheUiParent_C UiParent { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new AttacheUiParent_C(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public AttacheCase_BP_C AttacheCase { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new AttacheCase_BP_C(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
