...
namespace UEModLoader.Game
{
    ...
    {
        public FileManifestData(System.IntPtr ptr) : base(ptr) {}
        public string Filename => Native.ReadFStringAt(AddrOf(0x0)); // FString
        public SHAHashData FileHash => new SHAHashData(AddrOf(0x10));
        public TArray<System.IntPtr> FileChunkParts => new TArray<System.IntPtr>(AddrOf(0x28)); // TArray<struct>
        public TArray<System.IntPtr> InstallTags => new TArray<System.IntPtr>(AddrOf(0x38)); // TArray<FString>
    ...
    {
        public ChunkPartData(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public SHAHashData(System.IntPtr ptr) : base(ptr) {}
        public System.IntPtr Hash => AddrOf(0x0); // [20] static array
    }

    public class ChunkInfoData : StructProxy
    {
        public ChunkInfoData(System.IntPtr ptr) : base(ptr) {}
        public Guid Guid => new Guid(AddrOf(0x0));
    ...
    {
        public CustomFieldData(System.IntPtr ptr) : base(ptr) {}
    ...
    public class BuildPatchManifest : Object
    {
        ...
        public BuildPatchManifest(System.IntPtr ptr) : base(ptr) {}
        public static new BuildPatchManifest FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new BuildPatchManifest(p);
        ...
        public System.IntPtr PrereqIds => AddrOf(0x70); // 
        ...
        public TArray<System.IntPtr> FileManifestList => new TArray<System.IntPtr>(AddrOf(0xF0)); // TArray<struct>
        public TArray<System.IntPtr> ChunkList => new TArray<System.IntPtr>(AddrOf(0x100)); // TArray<struct>
        public TArray<System.IntPtr> CustomFields => new TArray<System.IntPtr>(AddrOf(0x110)); // TArray<struct>
    }
