...
namespace UEModLoader.Game
{
    public class UI_MerchantSubScreen_BP_C : VR4PauseUIScreen
    {
        ...
        public UI_MerchantSubScreen_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_MerchantSubScreen_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_MerchantSubScreen_BP_C(p);
        ...
        public UI_MerchantScreen_BP_C MerchantScreen { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new UI_MerchantScreen_BP_C(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr OnEnabledChanged => AddrOf(0x278); // 
        public TArray<System.IntPtr> Buttons => new TArray<System.IntPtr>(AddrOf(0x288)); // TArray<UObject*>
        public System.IntPtr OnAnimationDone => AddrOf(0x298); // 
        public TArray<System.IntPtr> ExtraButtons => new TArray<System.IntPtr>(AddrOf(0x2A8)); // TArray<UObject*>
        ...
        public void BindToButtonOnToggle(ChildActorComponent component, System.IntPtr Event)
        {
            var __pb = new ParamBuffer(24);
            __pb.SetObject(0x0, component);
            __pb.Set<System.IntPtr>(0x8, Event);
            CallRaw("BindToButtonOnToggle", __pb.Bytes);
        }
        public void BindToButtonOnUnhover(ChildActorComponent component, System.IntPtr Event)
        {
            var __pb = new ParamBuffer(24);
            __pb.SetObject(0x0, component);
            __pb.Set<System.IntPtr>(0x8, Event);
        ...
        public void BindToButtonOnHover(ChildActorComponent component, System.IntPtr Event)
        {
            var __pb = new ParamBuffer(24);
            __pb.SetObject(0x0, component);
            __pb.Set<System.IntPtr>(0x8, Event);
        ...
        public void BindToButtonOnClick(ChildActorComponent component, System.IntPtr Event)
        {
            var __pb = new ParamBuffer(24);
            __pb.SetObject(0x0, component);
            __pb.Set<System.IntPtr>(0x8, Event);
