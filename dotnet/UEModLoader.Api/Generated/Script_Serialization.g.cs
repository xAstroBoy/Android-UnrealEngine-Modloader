...
namespace UEModLoader.Game
{
    ...
    {
        public StructSerializerTestStruct(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public StructSerializerSetTestStruct(System.IntPtr ptr) : base(ptr) {}
        public System.IntPtr StrSet => AddrOf(0x0); // 
        public System.IntPtr IntSet => AddrOf(0x50); // 
        public System.IntPtr NameSet => AddrOf(0xA0); // 
        public System.IntPtr StructSet => AddrOf(0xF0); // 
    }

    public class StructSerializerBuiltinTestStruct : StructProxy
    {
        public StructSerializerBuiltinTestStruct(System.IntPtr ptr) : base(ptr) {}
        ...
        public System.IntPtr Text => AddrOf(0x28); // 
    ...
    {
        public StructSerializerMapTestStruct(System.IntPtr ptr) : base(ptr) {}
        public System.IntPtr IntToStr => AddrOf(0x0); // 
        public System.IntPtr StrToStr => AddrOf(0x50); // 
        public System.IntPtr StrToVec => AddrOf(0xA0); // 
        public System.IntPtr StrToStruct => AddrOf(0xF0); // 
    }

    public class StructSerializerArrayTestStruct : StructProxy
    {
        public StructSerializerArrayTestStruct(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> Int32Array => new TArray<System.IntPtr>(AddrOf(0x0)); // TArray<int32>
        public TArray<System.IntPtr> ByteArray => new TArray<System.IntPtr>(AddrOf(0x10)); // TArray<uint8>
        public int StaticSingleElement { get => GetAt<int>(0x20); set => SetAt(0x20, value); }
        public System.IntPtr StaticInt32Array => AddrOf(0x24); // [3] static array
        public System.IntPtr StaticFloatArray => AddrOf(0x30); // [3] static array
        public TArray<System.IntPtr> VectorArray => new TArray<System.IntPtr>(AddrOf(0x40)); // TArray<struct>
        public TArray<System.IntPtr> StructArray => new TArray<System.IntPtr>(AddrOf(0x50)); // TArray<struct>
    }

    public class StructSerializerObjectTestStruct : StructProxy
    {
        public StructSerializerObjectTestStruct(System.IntPtr ptr) : base(ptr) {}
        public Object Class { get { var __p = GetAt<System.IntPtr>(0x0); return __p==System.IntPtr.Zero?null:new Object(__p); } set => SetAt(0x0, value?.Pointer ?? System.IntPtr.Zero); }
        public MetaData SubClass { get { var __p = GetAt<System.IntPtr>(0x8); return __p==System.IntPtr.Zero?null:new MetaData(__p); } set => SetAt(0x8, value?.Pointer ?? System.IntPtr.Zero); }
        public UObject SoftClass { get { var __p = GetAt<System.IntPtr>(0x10); return __p==System.IntPtr.Zero?null:new UObject(__p); } set => SetAt(0x10, value?.Pointer ?? System.IntPtr.Zero); }
        public Object Object { get { var __p = GetAt<System.IntPtr>(0x38); return __p==System.IntPtr.Zero?null:new Object(__p); } set => SetAt(0x38, value?.Pointer ?? System.IntPtr.Zero); }
        public MetaData WeakObject { get { var __p = GetAt<System.IntPtr>(0x40); return __p==System.IntPtr.Zero?null:new MetaData(__p); } set => SetAt(0x40, value?.Pointer ?? System.IntPtr.Zero); }
        public MetaData SoftObject { get { var __p = GetAt<System.IntPtr>(0x48); return __p==System.IntPtr.Zero?null:new MetaData(__p); } set => SetAt(0x48, value?.Pointer ?? System.IntPtr.Zero); }
    ...
    {
        public StructSerializerBooleanTestStruct(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public StructSerializerNumericTestStruct(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public StructSerializerByteArray(System.IntPtr ptr) : base(ptr) {}
        public int Dummy1 { get => GetAt<int>(0x0); set => SetAt(0x0, value); }
        public TArray<System.IntPtr> ByteArray => new TArray<System.IntPtr>(AddrOf(0x8)); // TArray<uint8>
        public int Dummy2 { get => GetAt<int>(0x18); set => SetAt(0x18, value); }
        public TArray<System.IntPtr> Int8Array => new TArray<System.IntPtr>(AddrOf(0x20)); // TArray<int8>
