...
namespace UEModLoader.Game
{
    public class UI_Button_Discard_BP_C : Actor
    {
        ...
        public UI_Button_Discard_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Button_Discard_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Button_Discard_BP_C(p);
        ...
        public StaticMeshComponent Static_Button { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent Widget_Discard { get { var __p = GetAt<System.IntPtr>(0x230); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x230, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Rotate { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Flash { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public UI_Button_Discard_Widget_C Ref_Widget { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new UI_Button_Discard_Widget_C(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void Button_Click(VR4UIComponent component, VR4UIClickState State)
        {
