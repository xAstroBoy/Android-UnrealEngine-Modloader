...
namespace UEModLoader.Game
{
    public class RichTextDecorater_C : RichTextBlockImageDecorator
    {
        ...
        public RichTextDecorater_C(System.IntPtr ptr) : base(ptr) {}
        public static new RichTextDecorater_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new RichTextDecorater_C(p);
