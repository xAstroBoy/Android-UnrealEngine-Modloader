...
namespace UEModLoader.Game
{
    ...
    {
        public AnimNode_SkeletalControlBase(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_BlendSpacePlayer(System.IntPtr ptr) : base(ptr) {}
        ...
        public BlendSpaceBase BlendSpace { get { var __p = GetAt<System.IntPtr>(0x48); return __p==System.IntPtr.Zero?null:new BlendSpaceBase(__p); } set => SetAt(0x48, value?.Pointer ?? System.IntPtr.Zero); }
        public BlendSpaceBase PreviousBlendSpace { get { var __p = GetAt<System.IntPtr>(0xD8); return __p==System.IntPtr.Zero?null:new BlendSpaceBase(__p); } set => SetAt(0xD8, value?.Pointer ?? System.IntPtr.Zero); }
    }

    public class AnimNode_AimOffsetLookAt : StructProxy
    {
        public AnimNode_AimOffsetLookAt(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_AnimDynamics(System.IntPtr ptr) : base(ptr) {}
        ...
        public TArray<System.IntPtr> SphericalLimits => new TArray<System.IntPtr>(AddrOf(0x210)); // TArray<struct>
        ...
        public TArray<System.IntPtr> PlanarLimits => new TArray<System.IntPtr>(AddrOf(0x230)); // TArray<struct>
        ...
        public Actor ExternalSimActor { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new Actor(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
    ...
    {
        public RotationRetargetingInfo(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimPhysPlanarLimit(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimPhysSphericalLimit(System.IntPtr ptr) : base(ptr) {}
        public BoneReference DrivingBone => new BoneReference(AddrOf(0x0));
    ...
    {
        public AnimPhysConstraintSetup(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_ApplyAdditive(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_ApplyLimits(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> AngularRangeLimits => new TArray<System.IntPtr>(AddrOf(0xC8)); // TArray<struct>
        public TArray<System.IntPtr> AngularOffsets => new TArray<System.IntPtr>(AddrOf(0xD8)); // TArray<struct>
    }

    public class AngularRangeLimit : StructProxy
    {
        public AngularRangeLimit(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_BlendBoneByChannel(System.IntPtr ptr) : base(ptr) {}
        public PoseLink A => new PoseLink(AddrOf(0x10));
        public PoseLink B => new PoseLink(AddrOf(0x20));
        public TArray<System.IntPtr> BoneDefinitions => new TArray<System.IntPtr>(AddrOf(0x30)); // TArray<struct>
    ...
    {
        public BlendBoneByChannelEntry(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_BlendListBase(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> BlendPose => new TArray<System.IntPtr>(AddrOf(0x10)); // TArray<struct>
        public TArray<System.IntPtr> BlendTime => new TArray<System.IntPtr>(AddrOf(0x20)); // TArray<float>
        ...
        public CurveFloat CustomBlendCurve { get { var __p = GetAt<System.IntPtr>(0x38); return __p==System.IntPtr.Zero?null:new CurveFloat(__p); } set => SetAt(0x38, value?.Pointer ?? System.IntPtr.Zero); }
        public BlendProfile BlendProfile { get { var __p = GetAt<System.IntPtr>(0x40); return __p==System.IntPtr.Zero?null:new BlendProfile(__p); } set => SetAt(0x40, value?.Pointer ?? System.IntPtr.Zero); }
    }

    public class AnimNode_BlendListByBool : StructProxy
    {
        public AnimNode_BlendListByBool(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_BlendListByEnum(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> EnumToPoseIndex => new TArray<System.IntPtr>(AddrOf(0x98)); // TArray<int32>
        public byte ActiveEnumValue { get => GetAt<byte>(0xA8); set => SetAt(0xA8, value); }
    }

    public class AnimNode_BlendListByInt : StructProxy
    {
        public AnimNode_BlendListByInt(System.IntPtr ptr) : base(ptr) {}
        public int ActiveChildIndex { get => GetAt<int>(0x98); set => SetAt(0x98, value); }
    }

    public class AnimNode_BlendSpaceEvaluator : StructProxy
    {
        public AnimNode_BlendSpaceEvaluator(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_BoneDrivenController(System.IntPtr ptr) : base(ptr) {}
        public BoneReference SourceBone => new BoneReference(AddrOf(0xC8));
        public CurveFloat DrivingCurve { get { var __p = GetAt<System.IntPtr>(0xD8); return __p==System.IntPtr.Zero?null:new CurveFloat(__p); } set => SetAt(0xD8, value?.Pointer ?? System.IntPtr.Zero); }
    ...
    {
        public AnimNode_CCDIK(System.IntPtr ptr) : base(ptr) {}
        ...
        public TArray<System.IntPtr> RotationLimitPerJoints => new TArray<System.IntPtr>(AddrOf(0x170)); // TArray<float>
    }

    public class BoneSocketTarget : StructProxy
    {
        public BoneSocketTarget(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public SocketReference(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_Constraint(System.IntPtr ptr) : base(ptr) {}
        public BoneReference BoneToModify => new BoneReference(AddrOf(0xC8));
        public TArray<System.IntPtr> ConstraintSetup => new TArray<System.IntPtr>(AddrOf(0xD8)); // TArray<struct>
        public TArray<System.IntPtr> ConstraintWeights => new TArray<System.IntPtr>(AddrOf(0xE8)); // TArray<float>
    }

    public class Constraint : StructProxy
    {
        public Constraint(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_CopyBone(System.IntPtr ptr) : base(ptr) {}
        public BoneReference SourceBone => new BoneReference(AddrOf(0xC8));
    ...
    {
        public AnimNode_CopyBoneDelta(System.IntPtr ptr) : base(ptr) {}
        public BoneReference SourceBone => new BoneReference(AddrOf(0xC8));
        public BoneReference TargetBone => new BoneReference(AddrOf(0xD8));
        public bool bCopyTranslation { get => (GetAt<byte>(0xE8) & 0xFF) != 0; set { var __b = GetAt<byte>(0xE8); SetAt(0xE8, (byte)(value ? (__b | 0xFF) : (__b & ~0xFF))); } }
        public bool bCopyRotation { get => (GetAt<byte>(0xE9) & 0xFF) != 0; set { var __b = GetAt<byte>(0xE9); SetAt(0xE9, (byte)(value ? (__b | 0xFF) : (__b & ~0xFF))); } }
    ...
    {
        public AnimNode_CopyPoseFromMesh(System.IntPtr ptr) : base(ptr) {}
        public SkeletalMeshComponent SourceMeshComponent { get { var __p = GetAt<System.IntPtr>(0x10); return __p==System.IntPtr.Zero?null:new SkeletalMeshComponent(__p); } set => SetAt(0x10, value?.Pointer ?? System.IntPtr.Zero); }
    ...
    {
        public AnimNode_CurveSource(System.IntPtr ptr) : base(ptr) {}
        ...
        public UObject CurveSource { get { var __p = GetAt<System.IntPtr>(0x30); return __p==System.IntPtr.Zero?null:new UObject(__p); } set => SetAt(0x30, value?.Pointer ?? System.IntPtr.Zero); }
    }

    public class AnimNode_Fabrik : StructProxy
    {
        public AnimNode_Fabrik(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_HandIKRetargeting(System.IntPtr ptr) : base(ptr) {}
        ...
        public TArray<System.IntPtr> IKBonesToMove => new TArray<System.IntPtr>(AddrOf(0x108)); // TArray<struct>
        public float HandFKWeight { get => GetAt<float>(0x118); set => SetAt(0x118, value); }
    }

    public class AnimNode_LayeredBoneBlend : StructProxy
    {
        public AnimNode_LayeredBoneBlend(System.IntPtr ptr) : base(ptr) {}
        public PoseLink BasePose => new PoseLink(AddrOf(0x10));
        public TArray<System.IntPtr> BlendPoses => new TArray<System.IntPtr>(AddrOf(0x20)); // TArray<struct>
        public TArray<System.IntPtr> LayerSetup => new TArray<System.IntPtr>(AddrOf(0x30)); // TArray<struct>
        public TArray<System.IntPtr> BlendWeights => new TArray<System.IntPtr>(AddrOf(0x40)); // TArray<float>
        ...
        public TArray<System.IntPtr> PerBoneBlendWeights => new TArray<System.IntPtr>(AddrOf(0x60)); // TArray<struct>
    ...
    {
        public AnimNode_LegIK(System.IntPtr ptr) : base(ptr) {}
        ...
        public TArray<System.IntPtr> LegsDefinition => new TArray<System.IntPtr>(AddrOf(0xD0)); // TArray<struct>
    }

    public class AnimLegIKDefinition : StructProxy
    {
        public AnimLegIKDefinition(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimLegIKData(System.IntPtr ptr) : base(ptr) {}
    }

    public class IKChain : StructProxy
    {
        public IKChain(System.IntPtr ptr) : base(ptr) {}
    }

    public class IKChainLink : StructProxy
    {
        public IKChainLink(System.IntPtr ptr) : base(ptr) {}
    }

    public class AnimNode_LookAt : StructProxy
    {
        public AnimNode_LookAt(System.IntPtr ptr) : base(ptr) {}
        public BoneReference BoneToModify => new BoneReference(AddrOf(0xC8));
    ...
    {
        public AnimNode_MakeDynamicAdditive(System.IntPtr ptr) : base(ptr) {}
        public PoseLink Base => new PoseLink(AddrOf(0x10));
        public PoseLink Additive => new PoseLink(AddrOf(0x20));
    ...
    {
        public AnimNode_ModifyBone(System.IntPtr ptr) : base(ptr) {}
        public BoneReference BoneToModify => new BoneReference(AddrOf(0xC8));
    ...
    {
        public AnimNode_ModifyCurve(System.IntPtr ptr) : base(ptr) {}
        public PoseLink SourcePose => new PoseLink(AddrOf(0x10));
        public TArray<System.IntPtr> CurveValues => new TArray<System.IntPtr>(AddrOf(0x20)); // TArray<float>
        public TArray<System.IntPtr> CurveNames => new TArray<System.IntPtr>(AddrOf(0x30)); // TArray<FName>
        public float alpha { get => GetAt<float>(0x50); set => SetAt(0x50, value); }
    ...
    {
        public AnimNode_MultiWayBlend(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> Poses => new TArray<System.IntPtr>(AddrOf(0x10)); // TArray<struct>
        public TArray<System.IntPtr> DesiredAlphas => new TArray<System.IntPtr>(AddrOf(0x20)); // TArray<float>
    ...
    {
        public AnimNode_ObserveBone(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_PoseHandler(System.IntPtr ptr) : base(ptr) {}
        public PoseAsset PoseAsset { get { var __p = GetAt<System.IntPtr>(0x30); return __p==System.IntPtr.Zero?null:new PoseAsset(__p); } set => SetAt(0x30, value?.Pointer ?? System.IntPtr.Zero); }
    }

    public class AnimNode_PoseBlendNode : StructProxy
    {
        public AnimNode_PoseBlendNode(System.IntPtr ptr) : base(ptr) {}
        ...
        public CurveFloat CustomCurve { get { var __p = GetAt<System.IntPtr>(0x90); return __p==System.IntPtr.Zero?null:new CurveFloat(__p); } set => SetAt(0x90, value?.Pointer ?? System.IntPtr.Zero); }
    }

    public class AnimNode_PoseByName : StructProxy
    {
        public AnimNode_PoseByName(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_PoseDriver(System.IntPtr ptr) : base(ptr) {}
        public PoseLink SourcePose => new PoseLink(AddrOf(0x78));
        public TArray<System.IntPtr> SourceBones => new TArray<System.IntPtr>(AddrOf(0x88)); // TArray<struct>
        public TArray<System.IntPtr> OnlyDriveBones => new TArray<System.IntPtr>(AddrOf(0x98)); // TArray<struct>
        public TArray<System.IntPtr> PoseTargets => new TArray<System.IntPtr>(AddrOf(0xA8)); // TArray<struct>
    ...
    {
        public RBFParams(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public PoseDriverTarget(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> BoneTransforms => new TArray<System.IntPtr>(AddrOf(0x0)); // TArray<struct>
    ...
    {
        public PoseDriverTransform(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_PoseSnapshot(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_RandomPlayer(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> Entries => new TArray<System.IntPtr>(AddrOf(0x10)); // TArray<struct>
    ...
    {
        public RandomPlayerSequenceEntry(System.IntPtr ptr) : base(ptr) {}
        public AnimSequence Sequence { get { var __p = GetAt<System.IntPtr>(0x0); return __p==System.IntPtr.Zero?null:new AnimSequence(__p); } set => SetAt(0x0, value?.Pointer ?? System.IntPtr.Zero); }
    ...
    {
        public AnimNode_MeshSpaceRefPose(System.IntPtr ptr) : base(ptr) {}
    }

    public class AnimNode_RefPose : StructProxy
    {
        public AnimNode_RefPose(System.IntPtr ptr) : base(ptr) {}
        public byte RefPoseType { get => GetAt<byte>(0x10); set => SetAt(0x10, value); }
    }

    public class AnimNode_ResetRoot : StructProxy
    {
        public AnimNode_ResetRoot(System.IntPtr ptr) : base(ptr) {}
    }

    public class AnimNode_RigidBody : StructProxy
    {
        public AnimNode_RigidBody(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_RigidBody_Chaos(System.IntPtr ptr) : base(ptr) {}
        public PhysicsAsset OverridePhysicsAsset { get { var __p = GetAt<System.IntPtr>(0xC8); return __p==System.IntPtr.Zero?null:new PhysicsAsset(__p); } set => SetAt(0xC8, value?.Pointer ?? System.IntPtr.Zero); }
    ...
    {
        public AnimNode_RotateRootBone(System.IntPtr ptr) : base(ptr) {}
        public PoseLink BasePose => new PoseLink(AddrOf(0x10));
    ...
    {
        public AnimNode_RotationMultiplier(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_RotationOffsetBlendSpace(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_ScaleChainLength(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_SequenceEvaluator(System.IntPtr ptr) : base(ptr) {}
        public AnimSequenceBase Sequence { get { var __p = GetAt<System.IntPtr>(0x30); return __p==System.IntPtr.Zero?null:new AnimSequenceBase(__p); } set => SetAt(0x30, value?.Pointer ?? System.IntPtr.Zero); }
    ...
    {
        public AnimNode_Slot(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_SplineIK(System.IntPtr ptr) : base(ptr) {}
        ...
        public TArray<System.IntPtr> ControlPoints => new TArray<System.IntPtr>(AddrOf(0xF0)); // TArray<struct>
    ...
    {
        public SplineIKCachedBoneData(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_SpringBone(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_StateResult(System.IntPtr ptr) : base(ptr) {}
    }

    public class AnimNode_Trail : StructProxy
    {
        public AnimNode_Trail(System.IntPtr ptr) : base(ptr) {}
        ...
        public TArray<System.IntPtr> RotationLimits => new TArray<System.IntPtr>(AddrOf(0x1D8)); // TArray<struct>
        public TArray<System.IntPtr> RotationOffsets => new TArray<System.IntPtr>(AddrOf(0x1E8)); // TArray<struct>
        public TArray<System.IntPtr> PlanarLimits => new TArray<System.IntPtr>(AddrOf(0x1F8)); // TArray<struct>
    ...
    {
        public RotationLimit(System.IntPtr ptr) : base(ptr) {}
        public Vector LimitMin => new Vector(AddrOf(0x0));
        public Vector LimitMax => new Vector(AddrOf(0xC));
    }
    ...
    {
        public AnimNode_TwistCorrectiveNode(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public ReferenceBoneFrame(System.IntPtr ptr) : base(ptr) {}
        public BoneReference Bone => new BoneReference(AddrOf(0x0));
    ...
    {
        public AnimNode_TwoBoneIK(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public AnimNode_TwoWayBlend(System.IntPtr ptr) : base(ptr) {}
        public PoseLink A => new PoseLink(AddrOf(0x10));
        public PoseLink B => new PoseLink(AddrOf(0x20));
    ...
    {
        public AnimSequencerInstanceProxy(System.IntPtr ptr) : base(ptr) {}
    }

    public class PositionHistory : StructProxy
    {
        public PositionHistory(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> Positions => new TArray<System.IntPtr>(AddrOf(0x0)); // TArray<struct>
        public float Range { get => GetAt<float>(0x10); set => SetAt(0x10, value); }
    }

    public class RBFEntry : StructProxy
    {
        public RBFEntry(System.IntPtr ptr) : base(ptr) {}
        public TArray<System.IntPtr> Values => new TArray<System.IntPtr>(AddrOf(0x0)); // TArray<float>
    }

    public class RBFTarget : StructProxy
    {
        public RBFTarget(System.IntPtr ptr) : base(ptr) {}
    ...
    public class AnimNotify_PlayMontageNotify : AnimNotify
    {
        ...
        public AnimNotify_PlayMontageNotify(System.IntPtr ptr) : base(ptr) {}
        public static new AnimNotify_PlayMontageNotify FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new AnimNotify_PlayMontageNotify(p);
    ...
    public class AnimNotify_PlayMontageNotifyWindow : AnimNotifyState
    {
        ...
        public AnimNotify_PlayMontageNotifyWindow(System.IntPtr ptr) : base(ptr) {}
        public static new AnimNotify_PlayMontageNotifyWindow FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new AnimNotify_PlayMontageNotifyWindow(p);
    ...
    public class AnimSequencerInstance : AnimInstance
    {
        ...
        public AnimSequencerInstance(System.IntPtr ptr) : base(ptr) {}
        public static new AnimSequencerInstance FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new AnimSequencerInstance(p);
    ...
    public class KismetAnimationLibrary : BlueprintFunctionLibrary
    {
        ...
        public KismetAnimationLibrary(System.IntPtr ptr) : base(ptr) {}
        public static new KismetAnimationLibrary FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new KismetAnimationLibrary(p);
        ...
        public static System.IntPtr NativeFunc_K2_TwoBoneIK => Memory.ModuleBase() + 0x7C482A8;
        public void K2_TwoBoneIK(Vector RootPos, Vector JointPos, Vector EndPos, Vector JointTarget, Vector Effector, Vector OutJointPos, Vector OutEndPos, bool bAllowStretching, float StartStretchRatio, float MaxStretchScale)
        {
            var __pb = new ParamBuffer(96);
            __pb.Set<System.IntPtr>(0x0, RootPos);
            __pb.Set<System.IntPtr>(0xC, JointPos);
            __pb.Set<System.IntPtr>(0x18, EndPos);
            __pb.Set<System.IntPtr>(0x24, JointTarget);
            __pb.Set<System.IntPtr>(0x30, Effector);
            __pb.Set<System.IntPtr>(0x3C, OutJointPos);
            __pb.Set<System.IntPtr>(0x48, OutEndPos);
        ...
        public static System.IntPtr NativeFunc_K2_StartProfilingTimer => Memory.ModuleBase() + 0x7C4720C;
        ...
        public static System.IntPtr NativeFunc_K2_MakePerlinNoiseVectorAndRemap => Memory.ModuleBase() + 0x7C47960;
        public Vector K2_MakePerlinNoiseVectorAndRemap(float X, float Y, float Z, float RangeOutMinX, float RangeOutMaxX, float RangeOutMinY, float RangeOutMaxY, float RangeOutMinZ, float RangeOutMaxZ)
        {
            ...
            return __pb.Get<Vector>(0x24);
        }
        /// <summary>[Native] thunk RVA 0x7C47838 — hookable via Hooks.InstallAt(NativeFunc_K2_MakePerlinNoiseAndRemap).</summary>
        public static System.IntPtr NativeFunc_K2_MakePerlinNoiseAndRemap => Memory.ModuleBase() + 0x7C47838;
        ...
        public static System.IntPtr NativeFunc_K2_LookAt => Memory.ModuleBase() + 0x7C48050;
        public Transform K2_LookAt(Transform CurrentTransform, Vector TargetPosition, Vector LookAtVector, bool bUseUpVector, Vector UpVector, float ClampConeInDegree)
        {
            var __pb = new ParamBuffer(144);
            __pb.Set<System.IntPtr>(0x0, CurrentTransform);
            __pb.Set<System.IntPtr>(0x30, TargetPosition);
            __pb.Set<System.IntPtr>(0x3C, LookAtVector);
            __pb.Set<byte>(0x48, (byte)(bUseUpVector?1:0));
            __pb.Set<System.IntPtr>(0x4C, UpVector);
        ...
        public static System.IntPtr NativeFunc_K2_EndProfilingTimer => Memory.ModuleBase() + 0x7C4710C;
        public float K2_EndProfilingTimer(bool bLog, System.IntPtr LogPrefix)
        {
            var __pb = new ParamBuffer(28);
            __pb.Set<byte>(0x0, (byte)(bLog?1:0));
            __pb.Set<System.IntPtr>(0x8, LogPrefix);
        ...
        public static System.IntPtr NativeFunc_K2_DistanceBetweenTwoSocketsAndMapRange => Memory.ModuleBase() + 0x7C47D48;
        ...
        public static System.IntPtr NativeFunc_K2_DirectionBetweenSockets => Memory.ModuleBase() + 0x7C47C1C;
        public Vector K2_DirectionBetweenSockets(SkeletalMeshComponent component, FName SocketOrBoneNameFrom, FName SocketOrBoneNameTo)
        {
            ...
            return __pb.Get<Vector>(0x18);
        }
        /// <summary>[Native] thunk RVA 0x7C47220 — hookable via Hooks.InstallAt(NativeFunc_K2_CalculateVelocityFromSockets).</summary>
        public static System.IntPtr NativeFunc_K2_CalculateVelocityFromSockets => Memory.ModuleBase() + 0x7C47220;
        public float K2_CalculateVelocityFromSockets(float DeltaSeconds, SkeletalMeshComponent component, FName SocketOrBoneName, FName ReferenceSocketOrBone, byte SocketSpace, Vector OffsetInBoneSpace, PositionHistory History, int NumberOfSamples, float VelocityMin, float VelocityMax, EEasingFuncType EasingType, RuntimeFloatCurve CustomCurve)
        {
            ...
            __pb.Set<System.IntPtr>(0x24, OffsetInBoneSpace);
            __pb.Set<System.IntPtr>(0x30, History);
            __pb.Set(0x60, NumberOfSamples);
            __pb.Set(0x64, VelocityMin);
            __pb.Set(0x68, VelocityMax);
            __pb.Set<byte>(0x6C, (byte)EasingType);
            __pb.Set<System.IntPtr>(0x70, CustomCurve);
        ...
        public static System.IntPtr NativeFunc_K2_CalculateVelocityFromPositionHistory => Memory.ModuleBase() + 0x7C47624;
        public float K2_CalculateVelocityFromPositionHistory(float DeltaSeconds, Vector Position, PositionHistory History, int NumberOfSamples, float VelocityMin, float VelocityMax)
        {
            var __pb = new ParamBuffer(80);
            __pb.Set(0x0, DeltaSeconds);
            __pb.Set<System.IntPtr>(0x4, Position);
            __pb.Set<System.IntPtr>(0x10, History);
    ...
    public class PlayMontageCallbackProxy : Object
    {
        ...
        public PlayMontageCallbackProxy(System.IntPtr ptr) : base(ptr) {}
        public static new PlayMontageCallbackProxy FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new PlayMontageCallbackProxy(p);
        ...
        public System.IntPtr OnCompleted => AddrOf(0x28); // 
        public System.IntPtr OnBlendOut => AddrOf(0x38); // 
        public System.IntPtr OnInterrupted => AddrOf(0x48); // 
        public System.IntPtr OnNotifyBegin => AddrOf(0x58); // 
        public System.IntPtr OnNotifyEnd => AddrOf(0x68); // 
        /// <summary>[Native] thunk RVA 0x7C49854 — hookable via Hooks.InstallAt(NativeFunc_OnNotifyEndReceived).</summary>
        public static System.IntPtr NativeFunc_OnNotifyEndReceived => Memory.ModuleBase() + 0x7C49854;
        public void OnNotifyEndReceived(FName NotifyName, BranchingPointNotifyPayload BranchingPointNotifyPayload)
        {
            var __pb = new ParamBuffer(40);
            __pb.Set(0x0, NotifyName);
            __pb.Set<System.IntPtr>(0x8, BranchingPointNotifyPayload);
        ...
        public static System.IntPtr NativeFunc_OnNotifyBeginReceived => Memory.ModuleBase() + 0x7C49950;
        public void OnNotifyBeginReceived(FName NotifyName, BranchingPointNotifyPayload BranchingPointNotifyPayload)
        {
            var __pb = new ParamBuffer(40);
            __pb.Set(0x0, NotifyName);
            __pb.Set<System.IntPtr>(0x8, BranchingPointNotifyPayload);
        ...
        public static System.IntPtr NativeFunc_OnMontageEnded => Memory.ModuleBase() + 0x7C49A4C;
        ...
        public static System.IntPtr NativeFunc_OnMontageBlendingOut => Memory.ModuleBase() + 0x7C49B3C;
        ...
        public static System.IntPtr NativeFunc_CreateProxyObjectForPlayMontage => Memory.ModuleBase() + 0x7C49C2C;
        public PlayMontageCallbackProxy CreateProxyObjectForPlayMontage(SkeletalMeshComponent InSkeletalMeshComponent, AnimMontage MontageToPlay, float PlayRate, float StartingPosition, FName StartingSection)
        {
            ...
            { var __p = __pb.Get<System.IntPtr>(0x20); return __p==System.IntPtr.Zero?null:new PlayMontageCallbackProxy(__p); }
        }
    }
    ...
    public class SequencerAnimationSupport : Interface
    {
        ...
        public SequencerAnimationSupport(System.IntPtr ptr) : base(ptr) {}
        public static new SequencerAnimationSupport FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new SequencerAnimationSupport(p);
