...
namespace UEModLoader.Game
{
    public class UI_Treasure_Item_BP_C : Actor
    {
        ...
        public UI_Treasure_Item_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Treasure_Item_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Treasure_Item_BP_C(p);
        ...
        public SpotLightComponent SpotLight { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new SpotLightComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent LightMesh { get { var __p = GetAt<System.IntPtr>(0x230); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x230, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4DynamicHandPoseComponent GenericGrabbedHandPose { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new VR4DynamicHandPoseComponent(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public SkeletalMeshComponent SkeletalMesh { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new SkeletalMeshComponent(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent CombineIndicator { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4GamePlayerGripIKTarget PrimaryGripIKTarget { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new VR4GamePlayerGripIKTarget(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public GenericLocator PrimaryGripControllerLocatorRight { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new GenericLocator(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public GenericLocator PrimaryGripControllerLocatorLeft { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new GenericLocator(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4GamePlayerGrip PrimaryGrip { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new VR4GamePlayerGrip(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public ChildActorComponent GrabButton { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new ChildActorComponent(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent CountGroup { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent CountIndicator { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public ChildActorComponent NextButton { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new ChildActorComponent(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent StaticMesh { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr Models => AddrOf(0x2E0); // 
        ...
        public TArray<System.IntPtr> Items => new TArray<System.IntPtr>(AddrOf(0x338)); // TArray<int32>
        public UI_KeysTreasures_Count_Widget_C CountIndicatorWidget { get { var __p = GetAt<System.IntPtr>(0x348); return __p==System.IntPtr.Zero?null:new UI_KeysTreasures_Count_Widget_C(__p); } set => SetAt(0x348, value?.Pointer ?? System.IntPtr.Zero); }
        public AttacheItem_CombineWidget_C CombineIndicatorWidget { get { var __p = GetAt<System.IntPtr>(0x350); return __p==System.IntPtr.Zero?null:new AttacheItem_CombineWidget_C(__p); } set => SetAt(0x350, value?.Pointer ?? System.IntPtr.Zero); }
        public UI_KeysTreasures_Sold_Widget_C SoldIndicatorWidget { get { var __p = GetAt<System.IntPtr>(0x358); return __p==System.IntPtr.Zero?null:new UI_KeysTreasures_Sold_Widget_C(__p); } set => SetAt(0x358, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr SkeletalModels => AddrOf(0x360); // 
        ...
        public UI_Button_BP_C Ref_NextButton { get { var __p = GetAt<System.IntPtr>(0x410); return __p==System.IntPtr.Zero?null:new UI_Button_BP_C(__p); } set => SetAt(0x410, value?.Pointer ?? System.IntPtr.Zero); }
        public UI_KeysTreasures_Grab_Button_BP_C Ref_GrabButton { get { var __p = GetAt<System.IntPtr>(0x418); return __p==System.IntPtr.Zero?null:new UI_KeysTreasures_Grab_Button_BP_C(__p); } set => SetAt(0x418, value?.Pointer ?? System.IntPtr.Zero); }
        public Transform HoldOffset => new Transform(AddrOf(0x420));
        public Vector2D GrabButtonSize => new Vector2D(AddrOf(0x450));
        public VR4UIScreen Screen { get { var __p = GetAt<System.IntPtr>(0x458); return __p==System.IntPtr.Zero?null:new VR4UIScreen(__p); } set => SetAt(0x458, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4PausePlayerHand_BP_C GrabbedHand { get { var __p = GetAt<System.IntPtr>(0x460); return __p==System.IntPtr.Zero?null:new VR4PausePlayerHand_BP_C(__p); } set => SetAt(0x460, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr OnGrabHovered => AddrOf(0x4B0); // 
        public System.IntPtr OnGrabbed => AddrOf(0x4C0); // 
        public System.IntPtr OnDropped => AddrOf(0x4D0); // 
        public System.IntPtr OnGrabUnHovered => AddrOf(0x4E0); // 
        ...
        public System.IntPtr SoldText => AddrOf(0x4F8); // 
        public System.IntPtr UsedText => AddrOf(0x510); // 
        ...
        public System.IntPtr OnPlaySound => AddrOf(0x530); // 
        ...
        public System.IntPtr ModelExtraText => AddrOf(0x548); // 
        public SoundBase GrabSound { get { var __p = GetAt<System.IntPtr>(0x598); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x598, value?.Pointer ?? System.IntPtr.Zero); }
        public SoundBase DroppedSound { get { var __p = GetAt<System.IntPtr>(0x5A0); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x5A0, value?.Pointer ?? System.IntPtr.Zero); }
        public SoundBase CombineSound { get { var __p = GetAt<System.IntPtr>(0x5A8); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x5A8, value?.Pointer ?? System.IntPtr.Zero); }
        public AttacheItem AttacheItem { get { var __p = GetAt<System.IntPtr>(0x5B0); return __p==System.IntPtr.Zero?null:new AttacheItem(__p); } set => SetAt(0x5B0, value?.Pointer ?? System.IntPtr.Zero); }
        public AttacheCase AttacheCase { get { var __p = GetAt<System.IntPtr>(0x5B8); return __p==System.IntPtr.Zero?null:new AttacheCase(__p); } set => SetAt(0x5B8, value?.Pointer ?? System.IntPtr.Zero); }
        public InventoryUIScreen_BP_C InventoryUIScreen { get { var __p = GetAt<System.IntPtr>(0x5C0); return __p==System.IntPtr.Zero?null:new InventoryUIScreen_BP_C(__p); } set => SetAt(0x5C0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public SceneComponent LightComponent { get { var __p = GetAt<System.IntPtr>(0x658); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x658, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMesh LightModel { get { var __p = GetAt<System.IntPtr>(0x660); return __p==System.IntPtr.Zero?null:new StaticMesh(__p); } set => SetAt(0x660, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void GetAdjustedGrabButtonTransform(Transform Transform)
        {
        ...
        public void SetToTreasureConfiguration(System.IntPtr Configuration)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Configuration);
            CallRaw("SetToTreasureConfiguration", __pb.Bytes);
        }
        public void FlyTo(Transform Target)
        {
            var __pb = new ParamBuffer(48);
            __pb.Set<System.IntPtr>(0x0, Target);
        ...
        public void UpdateSelectedIndex(int PreferedItemId, int OldItemId, System.IntPtr OldItemIds)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set(0x0, PreferedItemId);
            __pb.Set(0x4, OldItemId);
            __pb.Set<System.IntPtr>(0x8, OldItemIds);
        ...
        public void InpActEvt_Button_B_K2Node_InputActionEvent_3(Key Key)
        {
            var __pb = new ParamBuffer(24);
        ...
        public void InpActEvt_Button_Y_K2Node_InputActionEvent_1(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button Y_K2Node_InputActionEvent_1", __pb.Bytes);
        }
        public void InpActEvt_Button_Y_K2Node_InputActionEvent_0(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
