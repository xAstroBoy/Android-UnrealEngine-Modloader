...
namespace UEModLoader.Game
{
    public class ParticleGeneric_C : Actor
    {
        ...
        public ParticleGeneric_C(System.IntPtr ptr) : base(ptr) {}
        public static new ParticleGeneric_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new ParticleGeneric_C(p);
        ...
        public ParticleSystemComponent ParticleSystem { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new ParticleSystemComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        public ParticleSystem Template { get { var __p = GetAt<System.IntPtr>(0x230); return __p==System.IntPtr.Zero?null:new ParticleSystem(__p); } set => SetAt(0x230, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public Actor AttachParent { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new Actor(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public SceneComponent AttachComponent { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void SetVectorParameter(FName ParameterName, Vector Vector)
        {
            var __pb = new ParamBuffer(20);
            __pb.Set(0x0, ParameterName);
            __pb.Set<System.IntPtr>(0x8, Vector);
