...
namespace UEModLoader.Game
{
    public class BPC_RainLogic_C : ActorComponent
    {
        ...
        public BPC_RainLogic_C(System.IntPtr ptr) : base(ptr) {}
        public static new BPC_RainLogic_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new BPC_RainLogic_C(p);
        ...
        public void UpdateMaterialParams(ParticleSystemComponent ParticleSystem, int MaterialIndex, VR4RainSettings RoomInfo)
        {
            var __pb = new ParamBuffer(52);
            __pb.SetObject(0x0, ParticleSystem);
            __pb.Set(0x8, MaterialIndex);
            __pb.Set<System.IntPtr>(0xC, RoomInfo);
