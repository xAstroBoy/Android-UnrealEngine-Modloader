...
namespace UEModLoader.Game
{
    public class ActionCamera_StunHit_BP_C : VR4CameraActionBase
    {
        ...
        public ActionCamera_StunHit_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new ActionCamera_StunHit_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new ActionCamera_StunHit_BP_C(p);
        ...
        public CurveFloat FadeColorScaleCurve { get { var __p = GetAt<System.IntPtr>(0x58); return __p==System.IntPtr.Zero?null:new CurveFloat(__p); } set => SetAt(0x58, value?.Pointer ?? System.IntPtr.Zero); }
        public LinearColor FadeColorOffset => new LinearColor(AddrOf(0x60));
        public CurveFloat FadeColorOffsetCurve { get { var __p = GetAt<System.IntPtr>(0x70); return __p==System.IntPtr.Zero?null:new CurveFloat(__p); } set => SetAt(0x70, value?.Pointer ?? System.IntPtr.Zero); }
