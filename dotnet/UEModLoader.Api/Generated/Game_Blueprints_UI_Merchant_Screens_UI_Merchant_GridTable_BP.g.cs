...
namespace UEModLoader.Game
{
    public class UI_Merchant_GridTable_BP_C : UI_MerchantSubScreen_BP_C
    {
        ...
        public UI_Merchant_GridTable_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Merchant_GridTable_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Merchant_GridTable_BP_C(p);
        ...
        public ChildActorComponent GunVice { get { var __p = GetAt<System.IntPtr>(0x2C0); return __p==System.IntPtr.Zero?null:new ChildActorComponent(__p); } set => SetAt(0x2C0, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent AttachePoint { get { var __p = GetAt<System.IntPtr>(0x2C8); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x2C8, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent GridMesh { get { var __p = GetAt<System.IntPtr>(0x2D0); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x2D0, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent panel1 { get { var __p = GetAt<System.IntPtr>(0x2D8); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x2D8, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent Table { get { var __p = GetAt<System.IntPtr>(0x2E0); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x2E0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Rotate { get { var __p = GetAt<System.IntPtr>(0x2F0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2F0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public InventoryUIScreen_BP_C Ref_InventoryScreen { get { var __p = GetAt<System.IntPtr>(0x300); return __p==System.IntPtr.Zero?null:new InventoryUIScreen_BP_C(__p); } set => SetAt(0x300, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr OnGridActive => AddrOf(0x308); // 
        public GunVice_BP_C Ref_GunVice { get { var __p = GetAt<System.IntPtr>(0x318); return __p==System.IntPtr.Zero?null:new GunVice_BP_C(__p); } set => SetAt(0x318, value?.Pointer ?? System.IntPtr.Zero); }
