...
namespace UEModLoader.Game
{
    public class WarningConfirm_BP_C : VR4PauseUIScreen
    {
        ...
        public WarningConfirm_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new WarningConfirm_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new WarningConfirm_BP_C(p);
        ...
        public ChildActorComponent ButtonOk { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new ChildActorComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Scale { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        public WarningConfirmWidget_C WarningWidget { get { var __p = GetAt<System.IntPtr>(0x298); return __p==System.IntPtr.Zero?null:new WarningConfirmWidget_C(__p); } set => SetAt(0x298, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr ButtonColors => AddrOf(0x2A0); // struct UI_WidgetColors_Struct
        public System.IntPtr WarningTryAgain => AddrOf(0x4A8); // 
