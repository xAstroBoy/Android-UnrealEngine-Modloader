...
namespace UEModLoader.Game
{
    public class GunVice_BP_C : VR4GunVice
    {
        ...
        public GunVice_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new GunVice_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new GunVice_BP_C(p);
        ...
        public StaticMeshComponent StaticMesh2 { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent StaticMesh3 { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent SlideRootL { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent SlideLeftAnchor { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent StaticMeshSlideR { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent SlideRootR { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent StaticMesh4 { get { var __p = GetAt<System.IntPtr>(0x298); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x298, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_MoveSlideR { get { var __p = GetAt<System.IntPtr>(0x2A8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2A8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_MoveSlideL { get { var __p = GetAt<System.IntPtr>(0x2B8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2B8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public AudioComponent SFX_SlideL { get { var __p = GetAt<System.IntPtr>(0x2F8); return __p==System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x2F8, value?.Pointer ?? System.IntPtr.Zero); }
        public AudioComponent SFX_SlideR { get { var __p = GetAt<System.IntPtr>(0x300); return __p==System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x300, value?.Pointer ?? System.IntPtr.Zero); }
