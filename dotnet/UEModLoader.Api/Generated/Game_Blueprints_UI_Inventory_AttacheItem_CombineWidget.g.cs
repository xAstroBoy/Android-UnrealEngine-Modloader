...
namespace UEModLoader.Game
{
    public class AttacheItem_CombineWidget_C : UserWidget
    {
        ...
        public AttacheItem_CombineWidget_C(System.IntPtr ptr) : base(ptr) {}
        public static new AttacheItem_CombineWidget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new AttacheItem_CombineWidget_C(p);
        ...
        public WidgetAnimation ShowLabelAnimation { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new WidgetAnimation(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public ProgressBar BG_Label_Fill { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new ProgressBar(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public Image BG_Preamble { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public Image CombineIcon { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public Overlay Overlay_Label { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new Overlay(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public Overlay Overlay_Preamble { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new Overlay(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public RichTextBlock RichText_Preamble { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new RichTextBlock(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Ring { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public Texture2D linkIcon { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new Texture2D(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public Texture2D UnlinkIcon { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new Texture2D(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        public bool FlipIcon { get => Native.GetPropBool(Pointer, "FlipIcon"); set => Native.SetPropBool(Pointer, "FlipIcon", value); }
        public System.IntPtr Text_Stack_Label => AddrOf(0x298); // 
        public System.IntPtr Text_Mix_Label => AddrOf(0x2B0); // 
        public System.IntPtr Text_Attach_Label => AddrOf(0x2C8); // 
        public System.IntPtr Text_Seperate_Label => AddrOf(0x2E0); // 
        ...
        public System.IntPtr Text_HoldTo => AddrOf(0x300); // 
        public System.IntPtr Text_DropHere => AddrOf(0x318); // 
