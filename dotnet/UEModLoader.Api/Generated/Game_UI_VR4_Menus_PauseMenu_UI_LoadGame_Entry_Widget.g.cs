...
namespace UEModLoader.Game
{
    public class UI_LoadGame_Entry_Widget_C : UserWidget
    {
        ...
        public UI_LoadGame_Entry_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_LoadGame_Entry_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_LoadGame_Entry_Widget_C(p);
        ...
        public TextBlock ChapterText { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Highlight { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock IndexText { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock ModeText { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock ModeText_Plus { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock RoundText { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock SavesText { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock TimeText { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Underline { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public bool IsSelected { get => Native.GetPropBool(Pointer, "IsSelected"); set => Native.SetPropBool(Pointer, "IsSelected", value); }
        public System.IntPtr ColorList => AddrOf(0x290); // struct UI_WidgetColors_Struct
        ...
        public System.IntPtr NewGamePlusColorList => AddrOf(0x4A0); // struct UI_WidgetColors_NGPlus_Struct
        ...
        public void SetEntryInfo(int Index, System.IntPtr Chapter, int Saves, System.IntPtr Time, int Round, EGameMode Mode, bool IsEndGameSave)
        {
