...
namespace UEModLoader.Game
{
    public class VR4CutsceneManager_BP_C : VR4CutsceneManager
    {
        ...
        public VR4CutsceneManager_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4CutsceneManager_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4CutsceneManager_BP_C(p);
        ...
        public TimelineComponent Timeline_EndFade { get { var __p = GetAt<System.IntPtr>(0x3E8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x3E8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr UpdateSubtitle => AddrOf(0x3F8); // 
        public System.IntPtr CutsceneNameUpdated => AddrOf(0x408); // 
        public System.IntPtr UpdateCommand => AddrOf(0x418); // 
        ...
        public System.IntPtr UpdateMessage => AddrOf(0x430); // 
        ...
        public CutsceneTheatreBox_C CutsceneTheaterBox { get { var __p = GetAt<System.IntPtr>(0x448); return __p==System.IntPtr.Zero?null:new CutsceneTheatreBox_C(__p); } set => SetAt(0x448, value?.Pointer ?? System.IntPtr.Zero); }
        public EndGameFlow_CreditsUnlocks_BP_C EndGame_BP { get { var __p = GetAt<System.IntPtr>(0x450); return __p==System.IntPtr.Zero?null:new EndGameFlow_CreditsUnlocks_BP_C(__p); } set => SetAt(0x450, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4CutscenePlayerPawn_BP_C PlayerBP { get { var __p = GetAt<System.IntPtr>(0x458); return __p==System.IntPtr.Zero?null:new VR4CutscenePlayerPawn_BP_C(__p); } set => SetAt(0x458, value?.Pointer ?? System.IntPtr.Zero); }
        public TArray<System.IntPtr> ActiveEffects => new TArray<System.IntPtr>(AddrOf(0x460)); // TArray<enum>
        public float MaterialLifetime { get => GetAt<float>(0x470); set => SetAt(0x470, value); }
        public MaterialInterface CurrentMat { get { var __p = GetAt<System.IntPtr>(0x478); return __p==System.IntPtr.Zero?null:new MaterialInterface(__p); } set => SetAt(0x478, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr OnUpdateTimerDisplay => AddrOf(0x488); // 
        ...
        public void OnSceEventBegin(System.IntPtr Name)
        {
        ...
        public void SetSubtitle(System.IntPtr subtitleKey, float Duration)
        {
            var __pb = new ParamBuffer(20);
            __pb.Set<System.IntPtr>(0x0, subtitleKey);
        ...
        public void ShowCommand(System.IntPtr Message, EVR4CommandButton Command, EActionButtonType actionType, EQTEId QTEId)
        {
        ...
        public void UpdateMessage__DelegateSignature(System.IntPtr Text)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Text);
            CallRaw("UpdateMessage__DelegateSignature", __pb.Bytes);
        }
        public void UpdateCommand__DelegateSignature(bool Show, System.IntPtr Message, EVR4CommandButton Command, EActionButtonType actionType, EQTEId QTEId)
        {
        ...
        public void CutsceneNameUpdated__DelegateSignature(System.IntPtr ActiveCutscene)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<System.IntPtr>(0x0, ActiveCutscene);
            CallRaw("CutsceneNameUpdated__DelegateSignature", __pb.Bytes);
        }
        public void UpdateSubtitle__DelegateSignature(System.IntPtr Key, float Duration)
        {
            var __pb = new ParamBuffer(20);
