...
namespace UEModLoader.Game
{
    public class UI_Inventory_Health_Label_Widget_C : UserWidget
    {
        ...
        public UI_Inventory_Health_Label_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Inventory_Health_Label_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Inventory_Health_Label_Widget_C(p);
        ...
        public TextBlock Text_Label_Name { get { var __p = GetAt<System.IntPtr>(0x230); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x230, value?.Pointer ?? System.IntPtr.Zero); }
        public void SetNameLabel(System.IntPtr Text)
        {
