...
namespace UEModLoader.Game
{
    public class VR4ItemMenuButton_BP_C : VR4ItemMenuButton
    {
        ...
        public VR4ItemMenuButton_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4ItemMenuButton_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4ItemMenuButton_BP_C(p);
        ...
        public BoxComponent Box { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new BoxComponent(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4GamePlayerGripIndicator VR4GamePlayerGripIndicator { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new VR4GamePlayerGripIndicator(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public VR4GamePlayerGrip VR4GamePlayerGrip { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new VR4GamePlayerGrip(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4GrabbableComponent VR4Grabbable { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new VR4GrabbableComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public float NewVar { get => GetAt<float>(0x280); set => SetAt(0x280, value); }
        public System.IntPtr OnShrunk => AddrOf(0x288); // 
