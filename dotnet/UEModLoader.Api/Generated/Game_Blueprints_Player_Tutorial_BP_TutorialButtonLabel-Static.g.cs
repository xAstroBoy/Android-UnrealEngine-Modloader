...
namespace UEModLoader.Game
{
    public class BP_TutorialButtonLabel_Static_C : Actor
    {
        ...
        public BP_TutorialButtonLabel_Static_C(System.IntPtr ptr) : base(ptr) {}
        public static new BP_TutorialButtonLabel_Static_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new BP_TutorialButtonLabel_Static_C(p);
        ...
        public StaticMeshComponent SphereRoot { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public SceneComponent ButtonAnchor { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent Widget { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent WidgetRoot { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent LabelLineAnchor { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent AnchorDiagonal { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public LineComponent line { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new LineComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent AnchorLine { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent LineDiagonal { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public LineComponent RightLine { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new LineComponent(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Sphere { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Widget { get { var __p = GetAt<System.IntPtr>(0x298); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x298, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_LabelLine { get { var __p = GetAt<System.IntPtr>(0x2A8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2A8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Diagonal { get { var __p = GetAt<System.IntPtr>(0x2B8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2B8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Leader { get { var __p = GetAt<System.IntPtr>(0x2C8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2C8, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr ButtonPress => AddrOf(0x2D0); // 
        public SceneComponent SceneAnchor { get { var __p = GetAt<System.IntPtr>(0x2E0); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x2E0, value?.Pointer ?? System.IntPtr.Zero); }
        public LineComponent LineAnchor { get { var __p = GetAt<System.IntPtr>(0x2E8); return __p==System.IntPtr.Zero?null:new LineComponent(__p); } set => SetAt(0x2E8, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr HeaderText => AddrOf(0x2F0); // 
        public System.IntPtr LabelText => AddrOf(0x308); // 
        public ButtonLabelWidget_C LabelWidget { get { var __p = GetAt<System.IntPtr>(0x320); return __p==System.IntPtr.Zero?null:new ButtonLabelWidget_C(__p); } set => SetAt(0x320, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr ButtonRemoved => AddrOf(0x368); // 
