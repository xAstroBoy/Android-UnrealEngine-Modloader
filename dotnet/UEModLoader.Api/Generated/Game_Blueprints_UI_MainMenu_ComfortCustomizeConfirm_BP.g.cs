...
namespace UEModLoader.Game
{
    public class ComfortCustomizeConfirm_BP_C : VR4PauseUIScreen
    {
        ...
        public ComfortCustomizeConfirm_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new ComfortCustomizeConfirm_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new ComfortCustomizeConfirm_BP_C(p);
        ...
        public TimelineComponent Timeline_MovieFade { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr TitleText => AddrOf(0x2C0); // 
        public System.IntPtr DescriptionText => AddrOf(0x2D8); // 
        public float ButtonOffset { get => GetAt<float>(0x2F0); set => SetAt(0x2F0, value); }
        public UI_FullMotionConfirm_Widget_C ConfirmWidget { get { var __p = GetAt<System.IntPtr>(0x2F8); return __p==System.IntPtr.Zero?null:new UI_FullMotionConfirm_Widget_C(__p); } set => SetAt(0x2F8, value?.Pointer ?? System.IntPtr.Zero); }
        public MediaPlayer MediaPlayer { get { var __p = GetAt<System.IntPtr>(0x300); return __p==System.IntPtr.Zero?null:new MediaPlayer(__p); } set => SetAt(0x300, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public BinkMediaPlayer BinkMediaPlayer { get { var __p = GetAt<System.IntPtr>(0x310); return __p==System.IntPtr.Zero?null:new BinkMediaPlayer(__p); } set => SetAt(0x310, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr ModeConfirmed => AddrOf(0x318); // 
