...
namespace UEModLoader.Game
{
    public class UI_WristWatch_Face_Widget_C : UserWidget
    {
        ...
        public UI_WristWatch_Face_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_WristWatch_Face_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_WristWatch_Face_Widget_C(p);
        ...
        public Overlay Overlay_Alt { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new Overlay(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Ammo { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Ammo100 { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_AmmoInventory { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Empty { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_MercScore { get { var __p = GetAt<System.IntPtr>(0x298); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x298, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Money { get { var __p = GetAt<System.IntPtr>(0x2A0); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x2A0, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Time { get { var __p = GetAt<System.IntPtr>(0x2A8); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x2A8, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Time_Merc { get { var __p = GetAt<System.IntPtr>(0x2B0); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x2B0, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_Time_Merc_s { get { var __p = GetAt<System.IntPtr>(0x2B8); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x2B8, value?.Pointer ?? System.IntPtr.Zero); }
