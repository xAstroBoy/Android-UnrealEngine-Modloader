...
namespace UEModLoader.Game
{
    public class UI_Map_Button_Widget_C : UserWidget
    {
        ...
        public UI_Map_Button_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Map_Button_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Map_Button_Widget_C(p);
        ...
        public Image BG { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public Image InnerHighlight { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TextBlock TextBlock_Label { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Toggle_BG { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Toggle_Fill { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr LabelText => AddrOf(0x278); // 
        ...
        public void SetButtonColors(SlateColor ForegroundColor, SlateColor BackgroundColor)
        {
            var __pb = new ParamBuffer(80);
            __pb.Set<System.IntPtr>(0x0, ForegroundColor);
            __pb.Set<System.IntPtr>(0x28, BackgroundColor);
