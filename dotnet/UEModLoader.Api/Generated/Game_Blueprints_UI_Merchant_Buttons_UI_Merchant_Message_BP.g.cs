...
namespace UEModLoader.Game
{
    public class UI_Merchant_Message_BP_C : UI_MerchantScreen_Button_BP_C
    {
        ...
        public UI_Merchant_Message_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Merchant_Message_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Merchant_Message_BP_C(p);
        ...
        public AudioComponent SFX_Pulse_Loop { get { var __p = GetAt<System.IntPtr>(0x318); return __p==System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x318, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4UIButtonComponent Button_Icon { get { var __p = GetAt<System.IntPtr>(0x320); return __p==System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x320, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent Widget_Icon { get { var __p = GetAt<System.IntPtr>(0x328); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x328, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_ScaleDownMessage { get { var __p = GetAt<System.IntPtr>(0x340); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x340, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_ScaleUpMessage { get { var __p = GetAt<System.IntPtr>(0x358); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x358, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr Message => AddrOf(0x360); // 
        ...
        public UI_Merchant_MessageIcon_Widget_C Ref_Icon_Widget { get { var __p = GetAt<System.IntPtr>(0x388); return __p==System.IntPtr.Zero?null:new UI_Merchant_MessageIcon_Widget_C(__p); } set => SetAt(0x388, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public UI_Merchant_Message_Widget_C Ref_Message_Widget { get { var __p = GetAt<System.IntPtr>(0x398); return __p==System.IntPtr.Zero?null:new UI_Merchant_Message_Widget_C(__p); } set => SetAt(0x398, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr OnMessageRead => AddrOf(0x3C0); // 
        ...
        public void ShowQuestDialog(VR4MerchantQuestDialog QuestDialog, bool OverrideRead)
        {
        ...
        public void TypeOutMessage(System.IntPtr Message)
        {
        ...
        public void BndEvt__Button_Icon_K2Node_ComponentBoundEvent_0_OnUIComponentClicked__DelegateSignature(VR4UIComponent component, VR4UIClickState State)
        {
        ...
        public void OnMessageRead__DelegateSignature(VR4MerchantQuestDialog QuestDialog)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, QuestDialog);
