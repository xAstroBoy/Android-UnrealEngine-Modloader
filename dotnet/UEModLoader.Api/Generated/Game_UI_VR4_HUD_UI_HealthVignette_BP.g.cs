...
namespace UEModLoader.Game
{
    public class UI_HealthVignette_BP_C : Actor
    {
        ...
        public UI_HealthVignette_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_HealthVignette_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_HealthVignette_BP_C(p);
        ...
        public StaticMeshComponent VignetteQte { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent QteAnchor { get { var __p = GetAt<System.IntPtr>(0x230); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x230, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent MessageTextWidget { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent ForwardGuide { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent Heartbeat_Parent { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent DamageMessage_Parent { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent HeartbeatWaveform { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent HeartbeatBG { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent DefaultSceneRoot { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_ShowSpikesMerc { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_ShowSpikes { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Pulse_FadeOut { get { var __p = GetAt<System.IntPtr>(0x2A0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2A0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Pulse_Loop { get { var __p = GetAt<System.IntPtr>(0x2B8); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2B8, value?.Pointer ?? System.IntPtr.Zero); }
        public UI_HealthVignette_Widget_C MessageWidget { get { var __p = GetAt<System.IntPtr>(0x2C0); return __p==System.IntPtr.Zero?null:new UI_HealthVignette_Widget_C(__p); } set => SetAt(0x2C0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public MaterialInstanceDynamic DynamicBGMaterial { get { var __p = GetAt<System.IntPtr>(0x2D0); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x2D0, value?.Pointer ?? System.IntPtr.Zero); }
        public MaterialInstanceDynamic DynamicWaveformMaterial { get { var __p = GetAt<System.IntPtr>(0x2D8); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x2D8, value?.Pointer ?? System.IntPtr.Zero); }
        public MaterialInstanceDynamic DynamicVignetteMaterial { get { var __p = GetAt<System.IntPtr>(0x2E0); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x2E0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr Name_Fine => AddrOf(0x2F0); // 
        public System.IntPtr Name_Caution => AddrOf(0x308); // 
        public System.IntPtr Name_Danger => AddrOf(0x320); // 
        ...
        public SoundBase Sound_Breath_File { get { var __p = GetAt<System.IntPtr>(0x348); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x348, value?.Pointer ?? System.IntPtr.Zero); }
        public SoundBase Sound_Breath_Caution { get { var __p = GetAt<System.IntPtr>(0x350); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x350, value?.Pointer ?? System.IntPtr.Zero); }
        public SoundBase Sound_Breath_Danger { get { var __p = GetAt<System.IntPtr>(0x358); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x358, value?.Pointer ?? System.IntPtr.Zero); }
        public SoundBase Sound_HeartBeat { get { var __p = GetAt<System.IntPtr>(0x360); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x360, value?.Pointer ?? System.IntPtr.Zero); }
