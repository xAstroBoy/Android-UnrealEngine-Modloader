...
namespace UEModLoader.Game
{
    ...
    {
        public OculusMR_PlaneMeshTriangle(System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public TrackedCamera(System.IntPtr ptr) : base(ptr) {}
    ...
    public class OculusMRFunctionLibrary : BlueprintFunctionLibrary
    {
        ...
        public OculusMRFunctionLibrary(System.IntPtr ptr) : base(ptr) {}
        public static new OculusMRFunctionLibrary FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusMRFunctionLibrary(p);
        ...
        public static System.IntPtr NativeFunc_SetTrackingReferenceComponent => Memory.ModuleBase() + 0x5C8316C;
        ...
        public static System.IntPtr NativeFunc_SetMrcScalingFactor => Memory.ModuleBase() + 0x5C83090;
        ...
        public static System.IntPtr NativeFunc_IsMrcEnabled => Memory.ModuleBase() + 0x5C83058;
        ...
        public static System.IntPtr NativeFunc_IsMrcActive => Memory.ModuleBase() + 0x5C83020;
        ...
        public static System.IntPtr NativeFunc_GetTrackingReferenceComponent => Memory.ModuleBase() + 0x5C83214;
        ...
        public static System.IntPtr NativeFunc_GetOculusMRSettings => Memory.ModuleBase() + 0x5C83248;
        public OculusMR_Settings GetOculusMRSettings()
        {
            var __pb = new ParamBuffer(8);
            CallRaw("GetOculusMRSettings", __pb.Bytes);
            { var __p = __pb.Get<System.IntPtr>(0x0); return __p==System.IntPtr.Zero?null:new OculusMR_Settings(__p); }
        }
        /// <summary>[Native] thunk RVA 0x5C83138 — hookable via Hooks.InstallAt(NativeFunc_GetMrcScalingFactor).</summary>
        public static System.IntPtr NativeFunc_GetMrcScalingFactor => Memory.ModuleBase() + 0x5C83138;
    ...
    public class OculusMR_CastingCameraActor : SceneCapture2D
    {
        ...
        public OculusMR_CastingCameraActor(System.IntPtr ptr) : base(ptr) {}
        public static new OculusMR_CastingCameraActor FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusMR_CastingCameraActor(p);
        ...
        public VRNotificationsComponent VRNotificationComponent { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new VRNotificationsComponent(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public Texture2D CameraColorTexture { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new Texture2D(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public Texture2D CameraDepthTexture { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new Texture2D(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public OculusMR_PlaneMeshComponent PlaneMeshComponent { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new OculusMR_PlaneMeshComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public Material ChromaKeyMaterial { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new Material(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public Material OpaqueColoredMaterial { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new Material(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public MaterialInstanceDynamic ChromaKeyMaterialInstance { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public MaterialInstanceDynamic CameraFrameMaterialInstance { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public MaterialInstanceDynamic BackdropMaterialInstance { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public Texture2D DefaultTexture_White { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new Texture2D(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public TArray<System.IntPtr> BackgroundRenderTargets => new TArray<System.IntPtr>(AddrOf(0x2D8)); // TArray<UObject*>
        public SceneCapture2D ForegroundCaptureActor { get { var __p = GetAt<System.IntPtr>(0x2E8); return __p==System.IntPtr.Zero?null:new SceneCapture2D(__p); } set => SetAt(0x2E8, value?.Pointer ?? System.IntPtr.Zero); }
        public TArray<System.IntPtr> ForegroundRenderTargets => new TArray<System.IntPtr>(AddrOf(0x2F0)); // TArray<UObject*>
        public TArray<System.IntPtr> PoseTimes => new TArray<System.IntPtr>(AddrOf(0x300)); // TArray<double>
        public OculusMR_Settings MRSettings { get { var __p = GetAt<System.IntPtr>(0x310); return __p==System.IntPtr.Zero?null:new OculusMR_Settings(__p); } set => SetAt(0x310, value?.Pointer ?? System.IntPtr.Zero); }
        public OculusMR_State MRState { get { var __p = GetAt<System.IntPtr>(0x318); return __p==System.IntPtr.Zero?null:new OculusMR_State(__p); } set => SetAt(0x318, value?.Pointer ?? System.IntPtr.Zero); }
    }

    public class OculusMR_PlaneMeshComponent : MeshComponent
    {
        public const string UeClassName = "OculusMR_PlaneMeshComponent";
        public OculusMR_PlaneMeshComponent(System.IntPtr ptr) : base(ptr) {}
        public static new OculusMR_PlaneMeshComponent FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusMR_PlaneMeshComponent(p);
        ...
        public static System.IntPtr NativeFunc_SetCustomMeshTriangles => Memory.ModuleBase() + 0x5C844E8;
        public bool SetCustomMeshTriangles(System.IntPtr Triangles)
        {
        ...
        public static System.IntPtr NativeFunc_ClearCustomMeshTriangles => Memory.ModuleBase() + 0x5C84414;
        ...
        public static System.IntPtr NativeFunc_AddCustomMeshTriangles => Memory.ModuleBase() + 0x5C84428;
        public void AddCustomMeshTriangles(System.IntPtr Triangles)
        {
    ...
    public class OculusMR_Settings : Object
    {
        ...
        public OculusMR_Settings(System.IntPtr ptr) : base(ptr) {}
        public static new OculusMR_Settings FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusMR_Settings(p);
        ...
        public static System.IntPtr NativeFunc_SetIsCasting => Memory.ModuleBase() + 0x5C85538;
        ...
        public static System.IntPtr NativeFunc_SetCompositionMethod => Memory.ModuleBase() + 0x5C856C0;
        ...
        public static System.IntPtr NativeFunc_SetCapturingCamera => Memory.ModuleBase() + 0x5C85600;
        ...
        public static System.IntPtr NativeFunc_SaveToIni => Memory.ModuleBase() + 0x5C85450;
        ...
        public static System.IntPtr NativeFunc_LoadFromIni => Memory.ModuleBase() + 0x5C85464;
        ...
        public static System.IntPtr NativeFunc_GetIsCasting => Memory.ModuleBase() + 0x5C855E4;
        ...
        public static System.IntPtr NativeFunc_GetCompositionMethod => Memory.ModuleBase() + 0x5C85764;
        ...
        public static System.IntPtr NativeFunc_GetCapturingCamera => Memory.ModuleBase() + 0x5C856A4;
        ...
        public static System.IntPtr NativeFunc_GetBindToTrackedCameraIndex => Memory.ModuleBase() + 0x5C85478;
        ...
        public static System.IntPtr NativeFunc_BindToTrackedCameraIndexIfAvailable => Memory.ModuleBase() + 0x5C85494;
    ...
    public class OculusMR_State : Object
    {
        ...
        public OculusMR_State(System.IntPtr ptr) : base(ptr) {}
        public static new OculusMR_State FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new OculusMR_State(p);
        ...
        public SceneComponent TrackingReferenceComponent { get { var __p = GetAt<System.IntPtr>(0xA0); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0xA0, value?.Pointer ?? System.IntPtr.Zero); }
