...
namespace UEModLoader.Game
{
    public class VR4GamePlayerAmmo_ShotgunShell_Base_BP_C : VR4GamePlayerAmmo_Clustered_Base_BP_C
    {
        ...
        public VR4GamePlayerAmmo_ShotgunShell_Base_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4GamePlayerAmmo_ShotgunShell_Base_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4GamePlayerAmmo_ShotgunShell_Base_BP_C(p);
        ...
        public StaticMeshComponent Shell8 { get { var __p = GetAt<System.IntPtr>(0x718); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x718, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Shell7 { get { var __p = GetAt<System.IntPtr>(0x720); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x720, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Shell6 { get { var __p = GetAt<System.IntPtr>(0x728); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x728, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Shell5 { get { var __p = GetAt<System.IntPtr>(0x730); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x730, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Shell4 { get { var __p = GetAt<System.IntPtr>(0x738); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x738, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Shell3 { get { var __p = GetAt<System.IntPtr>(0x740); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x740, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Shell2 { get { var __p = GetAt<System.IntPtr>(0x748); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x748, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Shell1 { get { var __p = GetAt<System.IntPtr>(0x750); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x750, value?.Pointer ?? System.IntPtr.Zero); }
        public int VisibleHeldShells { get => GetAt<int>(0x758); set => SetAt(0x758, value); }
        public TArray<System.IntPtr> ClusterHandPoses => new TArray<System.IntPtr>(AddrOf(0x760)); // TArray<struct>
