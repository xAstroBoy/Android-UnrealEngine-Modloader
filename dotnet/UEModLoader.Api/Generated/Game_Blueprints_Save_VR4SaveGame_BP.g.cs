...
namespace UEModLoader.Game
{
    public class VR4SaveGame_BP_C : VR4SaveGame
    {
        ...
        public VR4SaveGame_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4SaveGame_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4SaveGame_BP_C(p);
        ...
        public System.IntPtr SaveSlotData => AddrOf(0x598); // 
        public System.IntPtr CurrentSlotData => AddrOf(0x5E8); // struct SaveSlotData
        ...
        public TArray<System.IntPtr> SelectedChallenge => new TArray<System.IntPtr>(AddrOf(0x608)); // TArray<FName>
        ...
        public void HasNewChallengeRelativeToDate(DateTime InDate, bool HasNew)
        {
            var __pb = new ParamBuffer(9);
            __pb.Set<System.IntPtr>(0x0, InDate);
        ...
        public void Get_Now(DateTime Now)
        {
            var __pb = new ParamBuffer(8);
            __pb.Set<System.IntPtr>(0x0, Now);
