...
namespace UEModLoader.Game
{
    public class VR4Bio4PlayerHand_BP_C : VR4Bio4PlayerHand
    {
        ...
        public VR4Bio4PlayerHand_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4Bio4PlayerHand_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4Bio4PlayerHand_BP_C(p);
        ...
        public VR4DynamicHandPoseComponent NullGripHandPose { get { var __p = GetAt<System.IntPtr>(0x538); return __p==System.IntPtr.Zero?null:new VR4DynamicHandPoseComponent(__p); } set => SetAt(0x538, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent HandProxy { get { var __p = GetAt<System.IntPtr>(0x540); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x540, value?.Pointer ?? System.IntPtr.Zero); }
        public SkeletalMeshComponent Gun { get { var __p = GetAt<System.IntPtr>(0x548); return __p==System.IntPtr.Zero?null:new SkeletalMeshComponent(__p); } set => SetAt(0x548, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent SpaceFix { get { var __p = GetAt<System.IntPtr>(0x550); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x550, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Controller { get { var __p = GetAt<System.IntPtr>(0x558); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x558, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TArray<System.IntPtr> NullGripClosingOrigins_LH => new TArray<System.IntPtr>(AddrOf(0x568)); // TArray<FName>
        public TArray<System.IntPtr> NullGripClosingOrigins_RH => new TArray<System.IntPtr>(AddrOf(0x578)); // TArray<FName>
        public TArray<System.IntPtr> NullGripOpeningOrigins_LH => new TArray<System.IntPtr>(AddrOf(0x588)); // TArray<FName>
        public TArray<System.IntPtr> NullGripOpeningOrigins_RH => new TArray<System.IntPtr>(AddrOf(0x598)); // TArray<FName>
