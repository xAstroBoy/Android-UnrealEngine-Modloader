...
namespace UEModLoader.Game
{
    public class AttacheUiParent_C : UserWidget
    {
        ...
        public AttacheUiParent_C(System.IntPtr ptr) : base(ptr) {}
        public static new AttacheUiParent_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new AttacheUiParent_C(p);
        ...
        public UniformGridPanel GridPanel { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new UniformGridPanel(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public SizeBox SizeBox_Grid { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new SizeBox(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public SizeBox SizeBox_Master { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new SizeBox(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public TArray<System.IntPtr> GridSlots => new TArray<System.IntPtr>(AddrOf(0x250)); // TArray<UObject*>
        public System.IntPtr AutoDraw => AddrOf(0x260); // 
        public TArray<System.IntPtr> AnimatingSlots => new TArray<System.IntPtr>(AddrOf(0x270)); // TArray<UObject*>
