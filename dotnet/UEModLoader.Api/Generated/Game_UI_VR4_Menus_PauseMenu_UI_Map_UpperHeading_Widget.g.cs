...
namespace UEModLoader.Game
{
    public class UI_Map_UpperHeading_Widget_C : UserWidget
    {
        ...
        public UI_Map_UpperHeading_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Map_UpperHeading_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Map_UpperHeading_Widget_C(p);
        ...
        public Image BG_Heading { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public Image BG_Subheading { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TextBlock Text_Subheading { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr MercColors => AddrOf(0x258); // struct UI_WidgetColorsMercenaries_Struct
        ...
        public void SetSubheadingText(System.IntPtr newText)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, newText);
