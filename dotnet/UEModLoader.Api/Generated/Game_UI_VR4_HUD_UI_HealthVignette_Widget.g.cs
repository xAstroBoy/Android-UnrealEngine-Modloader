...
namespace UEModLoader.Game
{
    public class UI_HealthVignette_Widget_C : UserWidget
    {
        ...
        public UI_HealthVignette_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_HealthVignette_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_HealthVignette_Widget_C(p);
        ...
        public CanvasPanel Canvas_HealthStatus { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new CanvasPanel(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Label_HealthStatus { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void SetText(System.IntPtr newText)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, newText);
            CallRaw("SetText", __pb.Bytes);
        }
        public void SetTextAndColor(System.IntPtr newText, Color Color)
        {
            var __pb = new ParamBuffer(28);
            __pb.Set<System.IntPtr>(0x0, newText);
            __pb.Set<System.IntPtr>(0x18, Color);
