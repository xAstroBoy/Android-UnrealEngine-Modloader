...
namespace UEModLoader.Game
{
    public class TutorialHelper_C : Actor
    {
        ...
        public TutorialHelper_C(System.IntPtr ptr) : base(ptr) {}
        public static new TutorialHelper_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new TutorialHelper_C(p);
        ...
        public TArray<System.IntPtr> LabelAnchors => new TArray<System.IntPtr>(AddrOf(0x238)); // TArray<UObject*>
        ...
        public TutorialInstruction OpenTutorial { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new TutorialInstruction(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public Actor BindingActor { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new Actor(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public float DisplayTimeLimit { get => GetAt<float>(0x260); set => SetAt(0x260, value); }
        public System.IntPtr TimeLimitReached => AddrOf(0x268); // 
        public TArray<System.IntPtr> Headers => new TArray<System.IntPtr>(AddrOf(0x278)); // TArray<FText>
        public TArray<System.IntPtr> Labels => new TArray<System.IntPtr>(AddrOf(0x288)); // TArray<FText>
        public TArray<System.IntPtr> HeaderLabels => new TArray<System.IntPtr>(AddrOf(0x298)); // TArray<UObject*>
        public TArray<System.IntPtr> ScaleOverrides => new TArray<System.IntPtr>(AddrOf(0x2A8)); // TArray<float>
        public int AnchorCount { get => GetAt<int>(0x2B8); set => SetAt(0x2B8, value); }
        public System.IntPtr TutorialInfo => AddrOf(0x2C0); // struct TutorialEntry
        public System.IntPtr TutorialData => AddrOf(0x310); // struct TutorialEntry
        public System.IntPtr TutorialDisplayed => AddrOf(0x360); // 
        public TutorialHand_Base_BP_C LeftHand { get { var __p = GetAt<System.IntPtr>(0x370); return __p==System.IntPtr.Zero?null:new TutorialHand_Base_BP_C(__p); } set => SetAt(0x370, value?.Pointer ?? System.IntPtr.Zero); }
        public TutorialHand_Base_BP_C RightHand { get { var __p = GetAt<System.IntPtr>(0x378); return __p==System.IntPtr.Zero?null:new TutorialHand_Base_BP_C(__p); } set => SetAt(0x378, value?.Pointer ?? System.IntPtr.Zero); }
        public BP_DynamicTutorialManager_C ManagerBP { get { var __p = GetAt<System.IntPtr>(0x380); return __p==System.IntPtr.Zero?null:new BP_DynamicTutorialManager_C(__p); } set => SetAt(0x380, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr HandsCreated => AddrOf(0x388); // 
        ...
        public TArray<System.IntPtr> AdditionalLabels => new TArray<System.IntPtr>(AddrOf(0x3C0)); // TArray<FName>
        public BP_TutorialButtonLabel_Group_C GroupLabel { get { var __p = GetAt<System.IntPtr>(0x3D0); return __p==System.IntPtr.Zero?null:new BP_TutorialButtonLabel_Group_C(__p); } set => SetAt(0x3D0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TutorialHelperStatic_C TutorialButtonStatic { get { var __p = GetAt<System.IntPtr>(0x3E0); return __p==System.IntPtr.Zero?null:new TutorialHelperStatic_C(__p); } set => SetAt(0x3E0, value?.Pointer ?? System.IntPtr.Zero); }
