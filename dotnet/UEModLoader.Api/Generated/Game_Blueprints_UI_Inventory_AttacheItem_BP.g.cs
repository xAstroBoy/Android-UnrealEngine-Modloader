...
namespace UEModLoader.Game
{
    public class AttacheItem_BP_C : AttacheItem
    {
        ...
        public AttacheItem_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new AttacheItem_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new AttacheItem_BP_C(p);
        ...
        public SkeletalMeshComponent SkeletalMesh { get { var __p = GetAt<System.IntPtr>(0x348); return __p==System.IntPtr.Zero?null:new SkeletalMeshComponent(__p); } set => SetAt(0x348, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4DynamicHandPoseComponent GenericGrabbedHandPose { get { var __p = GetAt<System.IntPtr>(0x350); return __p==System.IntPtr.Zero?null:new VR4DynamicHandPoseComponent(__p); } set => SetAt(0x350, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4DynamicHandPoseComponent PrimaryGripGrabbedHandPose { get { var __p = GetAt<System.IntPtr>(0x358); return __p==System.IntPtr.Zero?null:new VR4DynamicHandPoseComponent(__p); } set => SetAt(0x358, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4GamePlayerGrip PrimaryGrip { get { var __p = GetAt<System.IntPtr>(0x360); return __p==System.IntPtr.Zero?null:new VR4GamePlayerGrip(__p); } set => SetAt(0x360, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent LowResMesh { get { var __p = GetAt<System.IntPtr>(0x368); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x368, value?.Pointer ?? System.IntPtr.Zero); }
        public GenericLocator PrimaryGripControllerLocatorRight { get { var __p = GetAt<System.IntPtr>(0x370); return __p==System.IntPtr.Zero?null:new GenericLocator(__p); } set => SetAt(0x370, value?.Pointer ?? System.IntPtr.Zero); }
        public GenericLocator PrimaryGripControllerLocatorLeft { get { var __p = GetAt<System.IntPtr>(0x378); return __p==System.IntPtr.Zero?null:new GenericLocator(__p); } set => SetAt(0x378, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4GamePlayerGripIKTarget PrimaryGripIKTarget { get { var __p = GetAt<System.IntPtr>(0x380); return __p==System.IntPtr.Zero?null:new VR4GamePlayerGripIKTarget(__p); } set => SetAt(0x380, value?.Pointer ?? System.IntPtr.Zero); }
        public AudioComponent CombineButtonSFX { get { var __p = GetAt<System.IntPtr>(0x388); return __p==System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x388, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent ShadowMesh { get { var __p = GetAt<System.IntPtr>(0x390); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x390, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4UIButtonComponent CombineButton { get { var __p = GetAt<System.IntPtr>(0x398); return __p==System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x398, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent StaticMesh { get { var __p = GetAt<System.IntPtr>(0x3A0); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x3A0, value?.Pointer ?? System.IntPtr.Zero); }
        public byte Timeline_FlipLinkIcon__Direction_2AB715ED4F020D396FF2ACAC95F37647 { get => GetAt<byte>(0x3A8); set => SetAt(0x3A8, value); }
        public TimelineComponent Timeline_FlipLinkIcon { get { var __p = GetAt<System.IntPtr>(0x3B0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x3B0, value?.Pointer ?? System.IntPtr.Zero); }
        public TArray<System.IntPtr> EquipTextures => new TArray<System.IntPtr>(AddrOf(0x3B8)); // TArray<UObject*>
        public TArray<System.IntPtr> CombineLinkTextures => new TArray<System.IntPtr>(AddrOf(0x3C8)); // TArray<UObject*>
        public TArray<System.IntPtr> CombineUnlinkTextures => new TArray<System.IntPtr>(AddrOf(0x3D8)); // TArray<UObject*>
        public TArray<System.IntPtr> CombineMixTextures => new TArray<System.IntPtr>(AddrOf(0x3E8)); // TArray<UObject*>
        ...
        public MaterialInstanceDynamic ShadowMaterial { get { var __p = GetAt<System.IntPtr>(0x410); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x410, value?.Pointer ?? System.IntPtr.Zero); }
        public AttacheItem_CombineWidget_C CombineWidgetRef { get { var __p = GetAt<System.IntPtr>(0x418); return __p==System.IntPtr.Zero?null:new AttacheItem_CombineWidget_C(__p); } set => SetAt(0x418, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public MeshComponent ActiveMeshComponent { get { var __p = GetAt<System.IntPtr>(0x428); return __p==System.IntPtr.Zero?null:new MeshComponent(__p); } set => SetAt(0x428, value?.Pointer ?? System.IntPtr.Zero); }
        public Object ActiveMeshReference { get { var __p = GetAt<System.IntPtr>(0x430); return __p==System.IntPtr.Zero?null:new Object(__p); } set => SetAt(0x430, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr HandPoses_LH => AddrOf(0x47C); // struct AttacheItemHandPoseSet
        public System.IntPtr HandPoses_RH => AddrOf(0x484); // struct AttacheItemHandPoseSet
        ...
        public InventoryGridSlot_C CountSlotRef { get { var __p = GetAt<System.IntPtr>(0x510); return __p==System.IntPtr.Zero?null:new InventoryGridSlot_C(__p); } set => SetAt(0x510, value?.Pointer ?? System.IntPtr.Zero); }
        public InventoryGridSlot_C EquipIconRef { get { var __p = GetAt<System.IntPtr>(0x518); return __p==System.IntPtr.Zero?null:new InventoryGridSlot_C(__p); } set => SetAt(0x518, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public Object StaticMeshAsset { get { var __p = GetAt<System.IntPtr>(0x540); return __p==System.IntPtr.Zero?null:new Object(__p); } set => SetAt(0x540, value?.Pointer ?? System.IntPtr.Zero); }
        public Object SkeletalMeshAsset { get { var __p = GetAt<System.IntPtr>(0x548); return __p==System.IntPtr.Zero?null:new Object(__p); } set => SetAt(0x548, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TArray<System.IntPtr> vOriginalMaterials => new TArray<System.IntPtr>(AddrOf(0x558)); // TArray<UObject*>
        public TArray<System.IntPtr> vOriginalLowResMaterials => new TArray<System.IntPtr>(AddrOf(0x568)); // TArray<UObject*>
        public TArray<System.IntPtr> vGoldenGunMaterials => new TArray<System.IntPtr>(AddrOf(0x578)); // TArray<UObject*>
        public VR4ItemTableRow ItemTableRow => new VR4ItemTableRow(AddrOf(0x588));
        public void SetUsingOverrideMaterials(MeshComponent MeshComponent, bool UsingOverrides, System.IntPtr OriginalMaterials, System.IntPtr GoldenGunsMaterials, bool ShouldUseOverrides)
        {
            var __pb = new ParamBuffer(73);
            __pb.SetObject(0x0, MeshComponent);
            __pb.Set<byte>(0x8, (byte)(UsingOverrides?1:0));
            __pb.Set<System.IntPtr>(0x10, OriginalMaterials);
            __pb.Set<System.IntPtr>(0x20, GoldenGunsMaterials);
        ...
        public void SetHeldScale(Vector HeldScale)
        {
            var __pb = new ParamBuffer(12);
            __pb.Set<System.IntPtr>(0x0, HeldScale);
            CallRaw("SetHeldScale", __pb.Bytes);
        }
        public void GetCombineTextures(System.IntPtr Textures)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<System.IntPtr>(0x0, Textures);
        ...
        public void GetHandPoseSet(EHandedness Hand, System.IntPtr HandPoseSet)
        {
            var __pb = new ParamBuffer(12);
            __pb.Set<byte>(0x0, (byte)Hand);
            __pb.Set<System.IntPtr>(0x4, HandPoseSet);
            CallRaw("GetHandPoseSet", __pb.Bytes);
        }
        public void SetUpControllerLocator(SceneComponent SocketOwner, System.IntPtr SocketNames, SceneComponent Locator, SceneComponent LocatorUsed)
        {
            var __pb = new ParamBuffer(40);
            __pb.SetObject(0x0, SocketOwner);
            __pb.Set<System.IntPtr>(0x8, SocketNames);
        ...
        public void GetHighlightColor(EAttacheItemState State, LinearColor Color)
        {
            var __pb = new ParamBuffer(20);
            __pb.Set<byte>(0x0, (byte)State);
            __pb.Set<System.IntPtr>(0x4, Color);
        ...
        public void BndEvt__CombineButton_K2Node_ComponentBoundEvent_1_OnUIComponentClicked__DelegateSignature(VR4UIComponent component, VR4UIClickState State)
        {
        ...
        public void BndEvt__CombineButton_K2Node_ComponentBoundEvent_2_OnUIComponentClicked__DelegateSignature(VR4UIComponent component, VR4UIClickState State)
        {
            var __pb = new ParamBuffer(56);
            __pb.SetObject(0x0, component);
            __pb.Set<System.IntPtr>(0x8, State);
        ...
        public void LoadShadow(System.IntPtr ShadowTexture)
        {
            var __pb = new ParamBuffer(40);
            __pb.Set<System.IntPtr>(0x0, ShadowTexture);
