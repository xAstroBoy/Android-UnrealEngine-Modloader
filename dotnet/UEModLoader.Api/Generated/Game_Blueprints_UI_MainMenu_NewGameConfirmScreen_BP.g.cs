...
namespace UEModLoader.Game
{
    public class NewGameConfirmScreen_BP_C : VR4UIScreen
    {
        ...
        public NewGameConfirmScreen_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new NewGameConfirmScreen_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new NewGameConfirmScreen_BP_C(p);
        ...
        public VR4UIButtonComponent VR4UIButton_Reject { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4UIButtonComponent VR4UIButton_Confirm { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4UIButtonComponent VR4UIButton_Back { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public WidgetComponent HeaderWidget { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent BackButton_Widget { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent RejectButton_Widget { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent ConfirmButton_Widget { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public UI_MainMenu_NewGame_Button_Widget_C ConfimButton { get { var __p = GetAt<System.IntPtr>(0x2A0); return __p==System.IntPtr.Zero?null:new UI_MainMenu_NewGame_Button_Widget_C(__p); } set => SetAt(0x2A0, value?.Pointer ?? System.IntPtr.Zero); }
        public UI_MainMenu_NewGame_Button_Widget_C RejectButton { get { var __p = GetAt<System.IntPtr>(0x2A8); return __p==System.IntPtr.Zero?null:new UI_MainMenu_NewGame_Button_Widget_C(__p); } set => SetAt(0x2A8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public UI_MainMenu_NewGame_Button_Widget_C BackButton { get { var __p = GetAt<System.IntPtr>(0x2B8); return __p==System.IntPtr.Zero?null:new UI_MainMenu_NewGame_Button_Widget_C(__p); } set => SetAt(0x2B8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void BndEvt__VR4UIButton_Back_K2Node_ComponentBoundEvent_8_OnUIComponentClicked__DelegateSignature(VR4UIComponent component, VR4UIClickState State)
        {
            var __pb = new ParamBuffer(56);
            __pb.SetObject(0x0, component);
            __pb.Set<System.IntPtr>(0x8, State);
