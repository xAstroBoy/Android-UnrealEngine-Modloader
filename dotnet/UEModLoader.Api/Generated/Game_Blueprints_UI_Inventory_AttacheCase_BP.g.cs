...
namespace UEModLoader.Game
{
    public class AttacheCase_BP_C : AttacheCase
    {
        ...
        public AttacheCase_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new AttacheCase_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new AttacheCase_BP_C(p);
        ...
        public InventoryUiManager_C UIManager { get { var __p = GetAt<System.IntPtr>(0x2C0); return __p==System.IntPtr.Zero?null:new InventoryUiManager_C(__p); } set => SetAt(0x2C0, value?.Pointer ?? System.IntPtr.Zero); }
        public void DebugDrawRegion(VR4ItemRegion region, LinearColor Color)
        {
            var __pb = new ParamBuffer(32);
            __pb.Set<System.IntPtr>(0x0, region);
