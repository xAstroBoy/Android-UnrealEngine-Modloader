...
namespace UEModLoader.Game
{
    public class BPFX_Interior_DustMotes_MainMenu_C : Emitter
    {
        ...
        public BPFX_Interior_DustMotes_MainMenu_C(System.IntPtr ptr) : base(ptr) {}
        public static new BPFX_Interior_DustMotes_MainMenu_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new BPFX_Interior_DustMotes_MainMenu_C(p);
        ...
        public BoxComponent Box { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new BoxComponent(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public BillboardComponent Billboard { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new BillboardComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
    }
