...
namespace UEModLoader.Game
{
    public class BP_TutorialButtonLabel_C : VR4TutorialButtonLabel
    {
        ...
        public BP_TutorialButtonLabel_C(System.IntPtr ptr) : base(ptr) {}
        public static new BP_TutorialButtonLabel_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new BP_TutorialButtonLabel_C(p);
        ...
        public StaticMeshComponent Sphere { get { var __p = GetAt<System.IntPtr>(0x2C0); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x2C0, value?.Pointer ?? System.IntPtr.Zero); }
        public LineComponent InitialLine { get { var __p = GetAt<System.IntPtr>(0x2C8); return __p==System.IntPtr.Zero?null:new LineComponent(__p); } set => SetAt(0x2C8, value?.Pointer ?? System.IntPtr.Zero); }
        public LineComponent EndLine { get { var __p = GetAt<System.IntPtr>(0x2D0); return __p==System.IntPtr.Zero?null:new LineComponent(__p); } set => SetAt(0x2D0, value?.Pointer ?? System.IntPtr.Zero); }
        public LineComponent LeftLine { get { var __p = GetAt<System.IntPtr>(0x2D8); return __p==System.IntPtr.Zero?null:new LineComponent(__p); } set => SetAt(0x2D8, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent StaticMesh1 { get { var __p = GetAt<System.IntPtr>(0x2E0); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x2E0, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent StaticMesh { get { var __p = GetAt<System.IntPtr>(0x2E8); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x2E8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_ScaleWidget { get { var __p = GetAt<System.IntPtr>(0x300); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x300, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr OnClose => AddrOf(0x308); // 
        public EHandedness Handness { get => (EHandedness)GetAt<byte>(0x318); set => SetAt(0x318, (byte)value); }
        public SceneComponent SceneAnchor { get { var __p = GetAt<System.IntPtr>(0x320); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x320, value?.Pointer ?? System.IntPtr.Zero); }
        public LineComponent LineAnchor { get { var __p = GetAt<System.IntPtr>(0x328); return __p==System.IntPtr.Zero?null:new LineComponent(__p); } set => SetAt(0x328, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr HeaderText => AddrOf(0x330); // 
        public System.IntPtr CompareText => AddrOf(0x348); // 
        public LineComponent FirstLine { get { var __p = GetAt<System.IntPtr>(0x360); return __p==System.IntPtr.Zero?null:new LineComponent(__p); } set => SetAt(0x360, value?.Pointer ?? System.IntPtr.Zero); }
        public Vector EndLineOffset => new Vector(AddrOf(0x368));
        public ButtonLabelWidget_C LabelWidget { get { var __p = GetAt<System.IntPtr>(0x378); return __p==System.IntPtr.Zero?null:new ButtonLabelWidget_C(__p); } set => SetAt(0x378, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TArray<System.IntPtr> Lines => new TArray<System.IntPtr>(AddrOf(0x388)); // TArray<UObject*>
        ...
        public void SetLabel(System.IntPtr Text)
        {
        ...
        public void SetHeaderText(System.IntPtr Text, float Scale)
        {
