...
namespace UEModLoader.Game
{
    public class TutorialBox_C : UserWidget
    {
        ...
        public TutorialBox_C(System.IntPtr ptr) : base(ptr) {}
        public static new TutorialBox_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new TutorialBox_C(p);
