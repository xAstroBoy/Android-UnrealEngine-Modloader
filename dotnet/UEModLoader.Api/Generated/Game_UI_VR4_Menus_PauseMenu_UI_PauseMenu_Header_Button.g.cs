...
namespace UEModLoader.Game
{
    public class UI_PauseMenu_Header_Button_C : Actor
    {
        ...
        public UI_PauseMenu_Header_Button_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_PauseMenu_Header_Button_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_PauseMenu_Header_Button_C(p);
        ...
        public WidgetComponent Widget_Icon { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent StaticMesh_BackingPlate { get { var __p = GetAt<System.IntPtr>(0x230); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x230, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4UIButtonComponent Button { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_NewIndicator { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Pulse { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Flickeroff { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_FlickerOn { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        public Texture2D Icon_Tab { get { var __p = GetAt<System.IntPtr>(0x298); return __p==System.IntPtr.Zero?null:new Texture2D(__p); } set => SetAt(0x298, value?.Pointer ?? System.IntPtr.Zero); }
        public UI_PauseMenu_Tab_Widget_C Ref_Tab_Widget { get { var __p = GetAt<System.IntPtr>(0x2A0); return __p==System.IntPtr.Zero?null:new UI_PauseMenu_Tab_Widget_C(__p); } set => SetAt(0x2A0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public Texture2D Icon_Tab_Highlight { get { var __p = GetAt<System.IntPtr>(0x2B0); return __p==System.IntPtr.Zero?null:new Texture2D(__p); } set => SetAt(0x2B0, value?.Pointer ?? System.IntPtr.Zero); }
        public bool IsSelected { get => Native.GetPropBool(Pointer, "IsSelected"); set => Native.SetPropBool(Pointer, "IsSelected", value); }
        public StaticMesh BackingPlate { get { var __p = GetAt<System.IntPtr>(0x2C0); return __p==System.IntPtr.Zero?null:new StaticMesh(__p); } set => SetAt(0x2C0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr TabTitle => AddrOf(0x2D0); // 
        public System.IntPtr Clicked => AddrOf(0x2E8); // 
        public UI_PauseMenu_Header_Base_BP_C Ref_Parent_Header { get { var __p = GetAt<System.IntPtr>(0x2F8); return __p==System.IntPtr.Zero?null:new UI_PauseMenu_Header_Base_BP_C(__p); } set => SetAt(0x2F8, value?.Pointer ?? System.IntPtr.Zero); }
        public bool IsHovered { get => Native.GetPropBool(Pointer, "IsHovered"); set => Native.SetPropBool(Pointer, "IsHovered", value); }
        public void SetTitle(System.IntPtr NewTitle)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, NewTitle);
        ...
        public void OnClick(VR4UIComponent component, VR4UIClickState State)
        {
