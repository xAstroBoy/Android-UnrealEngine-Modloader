...
namespace UEModLoader.Game
{
    public class UI_Merchant_Message_Widget_C : UI_Merchant_Button_Widget_BP_C
    {
        ...
        public UI_Merchant_Message_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Merchant_Message_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Merchant_Message_Widget_C(p);
        ...
        public Image Image_Arrow { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TextBlock Text_Description { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public TextBlock Text_InvisibleSizeSetter { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new TextBlock(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void SetFullTextSize(System.IntPtr NewParam)
        {
