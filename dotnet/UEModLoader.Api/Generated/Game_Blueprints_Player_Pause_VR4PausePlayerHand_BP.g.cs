...
namespace UEModLoader.Game
{
    public class VR4PausePlayerHand_BP_C : VR4PausePlayerHand
    {
        ...
        public VR4PausePlayerHand_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4PausePlayerHand_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4PausePlayerHand_BP_C(p);
        ...
        public VR4DynamicHandPoseComponent AnimatedHandPose { get { var __p = GetAt<System.IntPtr>(0x5A8); return __p==System.IntPtr.Zero?null:new VR4DynamicHandPoseComponent(__p); } set => SetAt(0x5A8, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4DynamicHandPoseComponent StaticHandPose { get { var __p = GetAt<System.IntPtr>(0x5B0); return __p==System.IntPtr.Zero?null:new VR4DynamicHandPoseComponent(__p); } set => SetAt(0x5B0, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4PriorityListHandPoseSourceComponent MainHandPose { get { var __p = GetAt<System.IntPtr>(0x5B8); return __p==System.IntPtr.Zero?null:new VR4PriorityListHandPoseSourceComponent(__p); } set => SetAt(0x5B8, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4MenuHandPoseHelper_C HandPoseHelper { get { var __p = GetAt<System.IntPtr>(0x5C0); return __p==System.IntPtr.Zero?null:new VR4MenuHandPoseHelper_C(__p); } set => SetAt(0x5C0, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent ExamineWidget { get { var __p = GetAt<System.IntPtr>(0x5C8); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x5C8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public Inventory_ExamineWidget_C Ref_ExamineWidget { get { var __p = GetAt<System.IntPtr>(0x5D8); return __p==System.IntPtr.Zero?null:new Inventory_ExamineWidget_C(__p); } set => SetAt(0x5D8, value?.Pointer ?? System.IntPtr.Zero); }
