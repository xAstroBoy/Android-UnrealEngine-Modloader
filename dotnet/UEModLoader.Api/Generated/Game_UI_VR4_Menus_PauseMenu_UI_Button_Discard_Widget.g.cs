...
namespace UEModLoader.Game
{
    public class UI_Button_Discard_Widget_C : UserWidget
    {
        ...
        public UI_Button_Discard_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_Button_Discard_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_Button_Discard_Widget_C(p);
        ...
        public ProgressBar Fill { get { var __p = GetAt<System.IntPtr>(0x238); return __p==System.IntPtr.Zero?null:new ProgressBar(__p); } set => SetAt(0x238, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Icon { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Icon_Flash { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Image_BG { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Image_BGFlash { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public Image Image_BGHighlight { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr Colors => AddrOf(0x4A0); // struct UI_WidgetColors_Struct
