...
namespace UEModLoader.Game
{
    public class VR4PlayerController_BP_C : VR4PlayerController
    {
        ...
        public VR4PlayerController_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4PlayerController_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4PlayerController_BP_C(p);
        ...
        public TArray<System.IntPtr> SlomoOptionsSlow => new TArray<System.IntPtr>(AddrOf(0x5F8)); // TArray<float>
        public TArray<System.IntPtr> SlomoOptionsFast => new TArray<System.IntPtr>(AddrOf(0x608)); // TArray<float>
        ...
        public TArray<System.IntPtr> WorldScaleOptions => new TArray<System.IntPtr>(AddrOf(0x630)); // TArray<float>
        ...
        public void SlomoDecrement(int Index, System.IntPtr Array)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set(0x0, Index);
            __pb.Set<System.IntPtr>(0x8, Array);
            CallRaw("SlomoDecrement", __pb.Bytes);
        }
        public void SlomoIncrement(int Index, System.IntPtr Array)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set(0x0, Index);
            __pb.Set<System.IntPtr>(0x8, Array);
        ...
        public void InpActEvt__L__Thumbstick_Press_K2Node_InputActionEvent_2(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_(L) Thumbstick Press_K2Node_InputActionEvent_2", __pb.Bytes);
        }
        public void InpActEvt__R__Thumbstick_Press_K2Node_InputActionEvent_1(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
