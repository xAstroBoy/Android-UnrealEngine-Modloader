...
namespace UEModLoader.Game
{
    public class WeaponWheel_C : Actor
    {
        ...
        public WeaponWheel_C(System.IntPtr ptr) : base(ptr) {}
        public static new WeaponWheel_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new WeaponWheel_C(p);
        ...
        public TimelineComponent Timeline_Fill { get { var __p = GetAt<System.IntPtr>(0x240); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x240, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public WeaponWheelWidget_C WheelWidget { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new WeaponWheelWidget_C(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public SoundBase Rollover { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4Bio4PlayerPawn_BP_C PlayerBP { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new VR4Bio4PlayerPawn_BP_C(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public CurveFloat InputBiasL { get { var __p = GetAt<System.IntPtr>(0x318); return __p==System.IntPtr.Zero?null:new CurveFloat(__p); } set => SetAt(0x318, value?.Pointer ?? System.IntPtr.Zero); }
        public CurveFloat InputBiasR { get { var __p = GetAt<System.IntPtr>(0x320); return __p==System.IntPtr.Zero?null:new CurveFloat(__p); } set => SetAt(0x320, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr StickActiveChanged => AddrOf(0x330); // 
        ...
        public System.IntPtr AshleyCommandMade => AddrOf(0x348); // 
