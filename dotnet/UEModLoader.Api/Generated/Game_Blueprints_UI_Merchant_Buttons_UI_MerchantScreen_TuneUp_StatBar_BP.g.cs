...
namespace UEModLoader.Game
{
    public class UI_MerchantScreen_TuneUp_StatBar_BP_C : UI_MerchantScreen_Button_BP_C
    {
        ...
        public UI_MerchantScreen_TuneUp_StatBar_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_MerchantScreen_TuneUp_StatBar_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_MerchantScreen_TuneUp_StatBar_BP_C(p);
        ...
        public ChildActorComponent RemoveUpgrade { get { var __p = GetAt<System.IntPtr>(0x318); return __p==System.IntPtr.Zero?null:new ChildActorComponent(__p); } set => SetAt(0x318, value?.Pointer ?? System.IntPtr.Zero); }
        public ChildActorComponent AddUpgrade { get { var __p = GetAt<System.IntPtr>(0x320); return __p==System.IntPtr.Zero?null:new ChildActorComponent(__p); } set => SetAt(0x320, value?.Pointer ?? System.IntPtr.Zero); }
        public UI_Merchant_TuneUp_StatBar2_Widget_C Ref_Stat_Widget { get { var __p = GetAt<System.IntPtr>(0x328); return __p==System.IntPtr.Zero?null:new UI_Merchant_TuneUp_StatBar2_Widget_C(__p); } set => SetAt(0x328, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4MerchantBuyItemStat stat => new VR4MerchantBuyItemStat(AddrOf(0x330));
        public System.IntPtr OnAddUpgrade => AddrOf(0x378); // 
        public System.IntPtr OnRemoveUpgrade => AddrOf(0x388); // 
        public UI_Button_BP_C RemoveUpgrade_Ref { get { var __p = GetAt<System.IntPtr>(0x398); return __p==System.IntPtr.Zero?null:new UI_Button_BP_C(__p); } set => SetAt(0x398, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void SetStat(VR4MerchantBuyItemStat stat, bool CanRemove, VR4MerchantBuyItemStat DowngradeState)
        {
            var __pb = new ParamBuffer(152);
            __pb.Set<System.IntPtr>(0x0, stat);
            __pb.Set<byte>(0x48, (byte)(CanRemove?1:0));
            __pb.Set<System.IntPtr>(0x50, DowngradeState);
        ...
        public void ClickedMainButton(VR4UIComponent component, VR4UIClickState State)
        {
        ...
        public void OnRemoveUpgrade__DelegateSignature(VR4MerchantBuyItemStat stat)
        {
            var __pb = new ParamBuffer(72);
            __pb.Set<System.IntPtr>(0x0, stat);
            CallRaw("OnRemoveUpgrade__DelegateSignature", __pb.Bytes);
        }
        public void OnAddUpgrade__DelegateSignature(VR4MerchantBuyItemStat stat)
        {
            var __pb = new ParamBuffer(72);
            __pb.Set<System.IntPtr>(0x0, stat);
