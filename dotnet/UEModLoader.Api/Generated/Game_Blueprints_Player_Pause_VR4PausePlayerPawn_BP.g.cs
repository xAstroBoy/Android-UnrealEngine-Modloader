...
namespace UEModLoader.Game
{
    public class VR4PausePlayerPawn_BP_C : VR4PausePlayerPawn
    {
        ...
        public VR4PausePlayerPawn_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4PausePlayerPawn_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4PausePlayerPawn_BP_C(p);
        ...
        public SceneComponent AmmoRoot2 { get { var __p = GetAt<System.IntPtr>(0x11C8); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x11C8, value?.Pointer ?? System.IntPtr.Zero); }
        public SkeletalMeshComponent Ammo2 { get { var __p = GetAt<System.IntPtr>(0x11D0); return __p==System.IntPtr.Zero?null:new SkeletalMeshComponent(__p); } set => SetAt(0x11D0, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent FakeGrenade { get { var __p = GetAt<System.IntPtr>(0x11D8); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x11D8, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent grenade { get { var __p = GetAt<System.IntPtr>(0x11E0); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x11E0, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Gun1 { get { var __p = GetAt<System.IntPtr>(0x11E8); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x11E8, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent GunRoot { get { var __p = GetAt<System.IntPtr>(0x11F0); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x11F0, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Knife { get { var __p = GetAt<System.IntPtr>(0x11F8); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x11F8, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent KnifeRoot { get { var __p = GetAt<System.IntPtr>(0x1200); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x1200, value?.Pointer ?? System.IntPtr.Zero); }
        public SkeletalMeshComponent Ammo { get { var __p = GetAt<System.IntPtr>(0x1208); return __p==System.IntPtr.Zero?null:new SkeletalMeshComponent(__p); } set => SetAt(0x1208, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent AmmoRoot { get { var __p = GetAt<System.IntPtr>(0x1210); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x1210, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent OffsetProps { get { var __p = GetAt<System.IntPtr>(0x1218); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x1218, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Fade { get { var __p = GetAt<System.IntPtr>(0x1228); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x1228, value?.Pointer ?? System.IntPtr.Zero); }
        public float FadeDuration { get => GetAt<float>(0x1230); set => SetAt(0x1230, value); }
        public Actor watchActor { get { var __p = GetAt<System.IntPtr>(0x1238); return __p==System.IntPtr.Zero?null:new Actor(__p); } set => SetAt(0x1238, value?.Pointer ?? System.IntPtr.Zero); }
        public UObject Watch { get { var __p = GetAt<System.IntPtr>(0x1240); return __p==System.IntPtr.Zero?null:new UObject(__p); } set => SetAt(0x1240, value?.Pointer ?? System.IntPtr.Zero); }
        public System.IntPtr TutorialPerHandStateLH => AddrOf(0x1250); // struct VR4TutorialPlayerPawnPerHandState
        public System.IntPtr TutorialPerHandStateRH => AddrOf(0x1252); // struct VR4TutorialPlayerPawnPerHandState
        public TimerHandle PropTimerHandle => new TimerHandle(AddrOf(0x1258));
        public TArray<System.IntPtr> PropsDisplayed => new TArray<System.IntPtr>(AddrOf(0x1260)); // TArray<enum>
