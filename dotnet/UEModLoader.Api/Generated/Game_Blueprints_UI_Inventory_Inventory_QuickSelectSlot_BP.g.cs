...
namespace UEModLoader.Game
{
    public class Inventory_QuickSelectSlot_BP_C : Actor
    {
        ...
        public Inventory_QuickSelectSlot_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new Inventory_QuickSelectSlot_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new Inventory_QuickSelectSlot_BP_C(p);
        ...
        public StaticMeshComponent GUI_Inventory_QuickSelect { get { var __p = GetAt<System.IntPtr>(0x228); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x228, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent Widget_QuickSelect { get { var __p = GetAt<System.IntPtr>(0x230); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x230, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr SlotName => AddrOf(0x250); // 
        public int EquippedItemID { get => GetAt<int>(0x268); set => SetAt(0x268, value); }
        public UI_Inventory_QuickSelect_Widget_C Ref_Widget { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new UI_Inventory_QuickSelect_Widget_C(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
