...
namespace UEModLoader.Game
{
    public class VR4CutscenePlayerPawn_BP_C : VR4CutscenePlayerPawn
    {
        ...
        public VR4CutscenePlayerPawn_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4CutscenePlayerPawn_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4CutscenePlayerPawn_BP_C(p);
        ...
        public TimelineComponent Timeline_RevealInfo { get { var __p = GetAt<System.IntPtr>(0x1180); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x1180, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_RevealPause { get { var __p = GetAt<System.IntPtr>(0x1190); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x1190, value?.Pointer ?? System.IntPtr.Zero); }
        public CutsceneTheatreBox_C TheatreBox { get { var __p = GetAt<System.IntPtr>(0x1198); return __p==System.IntPtr.Zero?null:new CutsceneTheatreBox_C(__p); } set => SetAt(0x1198, value?.Pointer ?? System.IntPtr.Zero); }
        public Actor watchActor { get { var __p = GetAt<System.IntPtr>(0x11A0); return __p==System.IntPtr.Zero?null:new Actor(__p); } set => SetAt(0x11A0, value?.Pointer ?? System.IntPtr.Zero); }
        public bool AllowSkip { get => Native.GetPropBool(Pointer, "AllowSkip"); set => Native.SetPropBool(Pointer, "AllowSkip", value); }
        public CutsceneInfo_C InfoWidget { get { var __p = GetAt<System.IntPtr>(0x11B0); return __p==System.IntPtr.Zero?null:new CutsceneInfo_C(__p); } set => SetAt(0x11B0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public VideoManager_BP_C VideoManager { get { var __p = GetAt<System.IntPtr>(0x11D8); return __p==System.IntPtr.Zero?null:new VideoManager_BP_C(__p); } set => SetAt(0x11D8, value?.Pointer ?? System.IntPtr.Zero); }
        public TimerHandle HidePauseTimer => new TimerHandle(AddrOf(0x11E0));
        public CutscenePaused_C PausedWidget { get { var __p = GetAt<System.IntPtr>(0x11E8); return __p==System.IntPtr.Zero?null:new CutscenePaused_C(__p); } set => SetAt(0x11E8, value?.Pointer ?? System.IntPtr.Zero); }
        public UObject Watch { get { var __p = GetAt<System.IntPtr>(0x11F0); return __p==System.IntPtr.Zero?null:new UObject(__p); } set => SetAt(0x11F0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr SkipCredits => AddrOf(0x1208); // 
        public bool JetSkiActive { get => Native.GetPropBool(Pointer, "JetSkiActive"); set => Native.SetPropBool(Pointer, "JetSkiActive", value); }
        public System.IntPtr Materials => AddrOf(0x1220); // 
        public TArray<System.IntPtr> MaterialNames => new TArray<System.IntPtr>(AddrOf(0x1270)); // TArray<FName>
        ...
        public Actor JetSki { get { var __p = GetAt<System.IntPtr>(0x1288); return __p==System.IntPtr.Zero?null:new Actor(__p); } set => SetAt(0x1288, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void InpActEvt_Button_A_K2Node_InputActionEvent_10(Key Key)
        {
        ...
        public void InpActEvt_Button_B_K2Node_InputActionEvent_7(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button B_K2Node_InputActionEvent_7", __pb.Bytes);
        }
        public void InpActEvt_Button_X_K2Node_InputActionEvent_6(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button X_K2Node_InputActionEvent_6", __pb.Bytes);
        }
        public void InpActEvt_Button_Y_K2Node_InputActionEvent_5(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button Y_K2Node_InputActionEvent_5", __pb.Bytes);
        }
        public void InpActEvt_SpaceBar_K2Node_InputKeyEvent_1(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_SpaceBar_K2Node_InputKeyEvent_1", __pb.Bytes);
        }
        public void InpActEvt_SpaceBar_K2Node_InputKeyEvent_0(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_SpaceBar_K2Node_InputKeyEvent_0", __pb.Bytes);
        }
        public void InpActEvt_Button_X_K2Node_InputActionEvent_4(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button X_K2Node_InputActionEvent_4", __pb.Bytes);
        }
        public void InpActEvt_Button_X_K2Node_InputActionEvent_3(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button X_K2Node_InputActionEvent_3", __pb.Bytes);
        }
        public void InpActEvt_Button_A_K2Node_InputActionEvent_2(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button A_K2Node_InputActionEvent_2", __pb.Bytes);
        }
        public void InpActEvt_Button_X_K2Node_InputActionEvent_1(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button X_K2Node_InputActionEvent_1", __pb.Bytes);
        }
        public void InpActEvt_Button_A_K2Node_InputActionEvent_0(Key Key)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Key);
            CallRaw("InpActEvt_Button A_K2Node_InputActionEvent_0", __pb.Bytes);
        }
        public void UpdateCamera(Transform Transform, float fovY, bool screenOn)
        {
