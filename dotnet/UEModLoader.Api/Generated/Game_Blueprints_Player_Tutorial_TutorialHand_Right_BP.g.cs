...
namespace UEModLoader.Game
{
    public class TutorialHand_Right_BP_C : TutorialHand_Base_BP_C
    {
        ...
        public TutorialHand_Right_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new TutorialHand_Right_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new TutorialHand_Right_BP_C(p);
