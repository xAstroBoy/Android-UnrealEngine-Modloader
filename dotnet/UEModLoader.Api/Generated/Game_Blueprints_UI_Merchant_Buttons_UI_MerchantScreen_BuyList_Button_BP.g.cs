...
namespace UEModLoader.Game
{
    public class UI_MerchantScreen_BuyList_Button_BP_C : UI_MerchantScreen_Button_BP_C
    {
        ...
        public UI_MerchantScreen_BuyList_Button_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_MerchantScreen_BuyList_Button_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_MerchantScreen_BuyList_Button_BP_C(p);
