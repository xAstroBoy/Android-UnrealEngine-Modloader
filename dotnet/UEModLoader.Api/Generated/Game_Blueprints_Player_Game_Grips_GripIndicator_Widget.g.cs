...
namespace UEModLoader.Game
{
    public class GripIndicator_Widget_C : VR4GamePlayerGripIndicatorWidget
    {
        ...
        public GripIndicator_Widget_C(System.IntPtr ptr) : base(ptr) {}
        public static new GripIndicator_Widget_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new GripIndicator_Widget_C(p);
        ...
        public WidgetAnimation ShrinkToDot { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new WidgetAnimation(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetAnimation GrowToRing { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new WidgetAnimation(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public Image CircleImage { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public Image dot { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void SetParameters(LinearColor Color, Vector2D Scale)
        {
            var __pb = new ParamBuffer(24);
            __pb.Set<System.IntPtr>(0x0, Color);
            __pb.Set<System.IntPtr>(0x10, Scale);
