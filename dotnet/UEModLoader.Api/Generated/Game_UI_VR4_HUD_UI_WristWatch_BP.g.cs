...
namespace UEModLoader.Game
{
    public class UI_WristWatch_BP_C : UI_WristWatch_Base_BP_C
    {
        ...
        public UI_WristWatch_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_WristWatch_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_WristWatch_BP_C(p);
        ...
        public SceneComponent AshleyRoot { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent TickAnchor { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent HpPlane { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Watch_Display { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        public WidgetComponent Widget_Face { get { var __p = GetAt<System.IntPtr>(0x268); return __p==System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x268, value?.Pointer ?? System.IntPtr.Zero); }
        public SceneComponent TickAnchorAshley { get { var __p = GetAt<System.IntPtr>(0x270); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x270, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent HpPlaneAshley { get { var __p = GetAt<System.IntPtr>(0x278); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x278, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent TickAshley { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Tick { get { var __p = GetAt<System.IntPtr>(0x288); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x288, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public UI_WristWatch_Face_Widget_C WatchWidget { get { var __p = GetAt<System.IntPtr>(0x2D8); return __p==System.IntPtr.Zero?null:new UI_WristWatch_Face_Widget_C(__p); } set => SetAt(0x2D8, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public VR4PlayerHand HandLeft { get { var __p = GetAt<System.IntPtr>(0x2E8); return __p==System.IntPtr.Zero?null:new VR4PlayerHand(__p); } set => SetAt(0x2E8, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4PlayerHand HandRight { get { var __p = GetAt<System.IntPtr>(0x2F0); return __p==System.IntPtr.Zero?null:new VR4PlayerHand(__p); } set => SetAt(0x2F0, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4Bio4PlayerHand_Left_BP_C Bio4HandLeft { get { var __p = GetAt<System.IntPtr>(0x2F8); return __p==System.IntPtr.Zero?null:new VR4Bio4PlayerHand_Left_BP_C(__p); } set => SetAt(0x2F8, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4Bio4PlayerHand_Right_BP_C Bio4HandRight { get { var __p = GetAt<System.IntPtr>(0x300); return __p==System.IntPtr.Zero?null:new VR4Bio4PlayerHand_Right_BP_C(__p); } set => SetAt(0x300, value?.Pointer ?? System.IntPtr.Zero); }
        public bool NoGame { get => Native.GetPropBool(Pointer, "NoGame"); set => Native.SetPropBool(Pointer, "NoGame", value); }
        public MaterialInstanceDynamic HpMaterial { get { var __p = GetAt<System.IntPtr>(0x310); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x310, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public MaterialInstanceDynamic HpMaterialAshley { get { var __p = GetAt<System.IntPtr>(0x328); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x328, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void UpdateMercTime(System.IntPtr Min, System.IntPtr Sec, System.IntPtr Csec, bool isWarning)
        {
