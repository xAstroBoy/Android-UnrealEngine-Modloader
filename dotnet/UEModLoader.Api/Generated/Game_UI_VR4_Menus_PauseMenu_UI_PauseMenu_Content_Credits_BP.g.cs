...
namespace UEModLoader.Game
{
    public class UI_PauseMenu_Content_Credits_BP_C : UI_PauseMenu_Content_BP_C
    {
        ...
        public UI_PauseMenu_Content_Credits_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new UI_PauseMenu_Content_Credits_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new UI_PauseMenu_Content_Credits_BP_C(p);
        ...
        public SceneComponent ScreenAttach { get { var __p = GetAt<System.IntPtr>(0x248); return __p==System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x248, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Track_Right { get { var __p = GetAt<System.IntPtr>(0x250); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x250, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Track_Left { get { var __p = GetAt<System.IntPtr>(0x258); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x258, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMeshComponent Frame_Right { get { var __p = GetAt<System.IntPtr>(0x260); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x260, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public StaticMeshComponent FilesPanel { get { var __p = GetAt<System.IntPtr>(0x280); return __p==System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x280, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent PopBack { get { var __p = GetAt<System.IntPtr>(0x290); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x290, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent PopForward { get { var __p = GetAt<System.IntPtr>(0x2A0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2A0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Panel_SlideOut { get { var __p = GetAt<System.IntPtr>(0x2B0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2B0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent FoldUp { get { var __p = GetAt<System.IntPtr>(0x2C0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2C0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Unfold { get { var __p = GetAt<System.IntPtr>(0x2D0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2D0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TimelineComponent Panel_SlideIn { get { var __p = GetAt<System.IntPtr>(0x2E0); return __p==System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x2E0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public CreditsUIScreen_BP_C CreditsScreen { get { var __p = GetAt<System.IntPtr>(0x2F8); return __p==System.IntPtr.Zero?null:new CreditsUIScreen_BP_C(__p); } set => SetAt(0x2F8, value?.Pointer ?? System.IntPtr.Zero); }
