...
namespace UEModLoader.Game
{
    public class VR4GamePlayerKnife_BP_C : VR4GamePlayerKnife
    {
        ...
        public VR4GamePlayerKnife_BP_C(System.IntPtr ptr) : base(ptr) {}
        public static new VR4GamePlayerKnife_BP_C FromPointer(System.IntPtr p) => p==System.IntPtr.Zero?null:new VR4GamePlayerKnife_BP_C(p);
        ...
        public AudioComponent SFX_Knife { get { var __p = GetAt<System.IntPtr>(0x6D8); return __p==System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x6D8, value?.Pointer ?? System.IntPtr.Zero); }
        public VR4GamePlayerGripIKTarget PrimaryGripIKTarget { get { var __p = GetAt<System.IntPtr>(0x6E0); return __p==System.IntPtr.Zero?null:new VR4GamePlayerGripIKTarget(__p); } set => SetAt(0x6E0, value?.Pointer ?? System.IntPtr.Zero); }
        public bool LastActivate { get => Native.GetPropBool(Pointer, "LastActivate"); set => Native.SetPropBool(Pointer, "LastActivate", value); }
        public MaterialInstanceDynamic TEST_TEST { get { var __p = GetAt<System.IntPtr>(0x6F0); return __p==System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x6F0, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public System.IntPtr KnifeSwingEnded => AddrOf(0x700); // 
        public TutorialHelper_C ActiveTutorial { get { var __p = GetAt<System.IntPtr>(0x710); return __p==System.IntPtr.Zero?null:new TutorialHelper_C(__p); } set => SetAt(0x710, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMesh PrimaryMesh { get { var __p = GetAt<System.IntPtr>(0x718); return __p==System.IntPtr.Zero?null:new StaticMesh(__p); } set => SetAt(0x718, value?.Pointer ?? System.IntPtr.Zero); }
        public StaticMesh HolsteredMesh { get { var __p = GetAt<System.IntPtr>(0x720); return __p==System.IntPtr.Zero?null:new StaticMesh(__p); } set => SetAt(0x720, value?.Pointer ?? System.IntPtr.Zero); }
        public SoundBase SFXHolsterGrab { get { var __p = GetAt<System.IntPtr>(0x728); return __p==System.IntPtr.Zero?null:new SoundBase(__p); } set => SetAt(0x728, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public TArray<System.IntPtr> OriginalMaterials => new TArray<System.IntPtr>(AddrOf(0x738)); // TArray<UObject*>
        public MaterialInterface GoldenGunMaterial { get { var __p = GetAt<System.IntPtr>(0x748); return __p==System.IntPtr.Zero?null:new MaterialInterface(__p); } set => SetAt(0x748, value?.Pointer ?? System.IntPtr.Zero); }
        ...
        public void PlayHitParticle(Transform particleTransform, EKnifeSlashParticle particleType)
        {
            var __pb = new ParamBuffer(49);
            __pb.Set<System.IntPtr>(0x0, particleTransform);
