...
namespace UEModLoader.Game
{
    public class UI_Inventory_BottomPanel_C : Actor
    {
        ...
        public UI_Inventory_BottomPanel_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new UI_Inventory_BottomPanel_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new UI_Inventory_BottomPanel_C(p);
        ...
        public StaticMeshComponent GUI_Inventory_Drawer_Base { get { var __p = GetAt<global::System.IntPtr>(0x228); return __p==global::System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x228, value?.Pointer ?? global::System.IntPtr.Zero); }
        public StaticMeshComponent GUI_Inventory_Drawer_Top { get { var __p = GetAt<global::System.IntPtr>(0x230); return __p==global::System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x230, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent TableTiltParent { get { var __p = GetAt<global::System.IntPtr>(0x238); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x238, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent AttachePoint { get { var __p = GetAt<global::System.IntPtr>(0x240); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x240, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent TrayParent { get { var __p = GetAt<global::System.IntPtr>(0x248); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x248, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent PanelParent { get { var __p = GetAt<global::System.IntPtr>(0x250); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x250, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_Rotate { get { var __p = GetAt<global::System.IntPtr>(0x268); return __p==global::System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x268, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public TimelineComponent Timeline_SlideTray { get { var __p = GetAt<global::System.IntPtr>(0x280); return __p==global::System.IntPtr.Zero?null:new TimelineComponent(__p); } set => SetAt(0x280, value?.Pointer ?? global::System.IntPtr.Zero); }
        public UI_Button_Discard_BP_C Ref_DiscardButton { get { var __p = GetAt<global::System.IntPtr>(0x288); return __p==global::System.IntPtr.Zero?null:new UI_Button_Discard_BP_C(__p); } set => SetAt(0x288, value?.Pointer ?? global::System.IntPtr.Zero); }
        public global::System.IntPtr InOutAnimationFinished => AddrOf(0x290); // 
