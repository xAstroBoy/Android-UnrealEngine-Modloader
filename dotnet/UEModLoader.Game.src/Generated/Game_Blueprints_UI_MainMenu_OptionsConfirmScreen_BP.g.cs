...
namespace UEModLoader.Game
{
    public class OptionsConfirmScreen_BP_C : VR4UIScreen
    {
        ...
        public OptionsConfirmScreen_BP_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new OptionsConfirmScreen_BP_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new OptionsConfirmScreen_BP_C(p);
        ...
        public WidgetComponent Header_Widget { get { var __p = GetAt<global::System.IntPtr>(0x258); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x258, value?.Pointer ?? global::System.IntPtr.Zero); }
        public WidgetComponent RejectButton_Widget { get { var __p = GetAt<global::System.IntPtr>(0x260); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x260, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4UIButtonComponent VR4UIButton_Reject { get { var __p = GetAt<global::System.IntPtr>(0x268); return __p==global::System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x268, value?.Pointer ?? global::System.IntPtr.Zero); }
        public WidgetComponent ConfirmButton_Widget { get { var __p = GetAt<global::System.IntPtr>(0x270); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x270, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4UIButtonComponent VR4UIButton_Confirm { get { var __p = GetAt<global::System.IntPtr>(0x278); return __p==global::System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x278, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public UI_MainMenu_NewGame_Button_Widget_C ConfimButton { get { var __p = GetAt<global::System.IntPtr>(0x288); return __p==global::System.IntPtr.Zero?null:new UI_MainMenu_NewGame_Button_Widget_C(__p); } set => SetAt(0x288, value?.Pointer ?? global::System.IntPtr.Zero); }
        public UI_MainMenu_NewGame_Button_Widget_C RejectButton { get { var __p = GetAt<global::System.IntPtr>(0x290); return __p==global::System.IntPtr.Zero?null:new UI_MainMenu_NewGame_Button_Widget_C(__p); } set => SetAt(0x290, value?.Pointer ?? global::System.IntPtr.Zero); }
