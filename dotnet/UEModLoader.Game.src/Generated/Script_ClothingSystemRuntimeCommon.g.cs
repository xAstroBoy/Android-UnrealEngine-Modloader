...
namespace UEModLoader.Game
{
    ...
    {
        public ClothConfig_Legacy(global::System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public ClothConstraintSetup_Legacy(global::System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public ClothLODDataCommon(global::System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public ClothPhysicalMeshData(global::System.IntPtr ptr) : base(ptr) {}
        public TArray<global::System.IntPtr> Vertices => new TArray<global::System.IntPtr>(AddrOf(0x0)); // TArray<struct>
        public TArray<global::System.IntPtr> Normals => new TArray<global::System.IntPtr>(AddrOf(0x10)); // TArray<struct>
        public TArray<global::System.IntPtr> Indices => new TArray<global::System.IntPtr>(AddrOf(0x20)); // TArray<uint32>
        public global::System.IntPtr WeightMaps => AddrOf(0x30); // 
        public TArray<global::System.IntPtr> InverseMasses => new TArray<global::System.IntPtr>(AddrOf(0x80)); // TArray<float>
        public TArray<global::System.IntPtr> BoneData => new TArray<global::System.IntPtr>(AddrOf(0x90)); // TArray<struct>
        ...
        public TArray<global::System.IntPtr> SelfCollisionIndices => new TArray<global::System.IntPtr>(AddrOf(0xA8)); // TArray<uint32>
        public TArray<global::System.IntPtr> MaxDistances => new TArray<global::System.IntPtr>(AddrOf(0xB8)); // TArray<float>
        public TArray<global::System.IntPtr> BackstopDistances => new TArray<global::System.IntPtr>(AddrOf(0xC8)); // TArray<float>
        public TArray<global::System.IntPtr> BackstopRadiuses => new TArray<global::System.IntPtr>(AddrOf(0xD8)); // TArray<float>
        public TArray<global::System.IntPtr> AnimDriveMultipliers => new TArray<global::System.IntPtr>(AddrOf(0xE8)); // TArray<float>
    }

    public class PointWeightMap : StructProxy
    {
        public PointWeightMap(global::System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public ClothParameterMask_Legacy(global::System.IntPtr ptr) : base(ptr) {}
        ...
        public TArray<global::System.IntPtr> Values => new TArray<global::System.IntPtr>(AddrOf(0x18)); // TArray<float>
    ...
    public class ClothConfigCommon : ClothConfigBase
    {
        ...
        public ClothConfigCommon(global::System.IntPtr ptr) : base(ptr) {}
        public static new ClothConfigCommon FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ClothConfigCommon(p);
    ...
    public class ClothSharedConfigCommon : ClothConfigCommon
    {
        ...
        public ClothSharedConfigCommon(global::System.IntPtr ptr) : base(ptr) {}
        public static new ClothSharedConfigCommon FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ClothSharedConfigCommon(p);
    ...
    public class ClothingAssetCustomData : Object
    {
        ...
        public ClothingAssetCustomData(global::System.IntPtr ptr) : base(ptr) {}
        public static new ClothingAssetCustomData FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ClothingAssetCustomData(p);
    ...
    public class ClothingAssetCommon : ClothingAssetBase
    {
        ...
        public ClothingAssetCommon(global::System.IntPtr ptr) : base(ptr) {}
        public static new ClothingAssetCommon FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ClothingAssetCommon(p);
        ...
        public PhysicsAsset PhysicsAsset { get { var __p = GetAt<global::System.IntPtr>(0x48); return __p==global::System.IntPtr.Zero?null:new PhysicsAsset(__p); } set => SetAt(0x48, value?.Pointer ?? global::System.IntPtr.Zero); }
        public global::System.IntPtr ClothConfigs => AddrOf(0x50); // 
        public ClothConfigBase ClothSharedSimConfig { get { var __p = GetAt<global::System.IntPtr>(0xA0); return __p==global::System.IntPtr.Zero?null:new ClothConfigBase(__p); } set => SetAt(0xA0, value?.Pointer ?? global::System.IntPtr.Zero); }
        public ClothConfigBase ClothSimConfig { get { var __p = GetAt<global::System.IntPtr>(0xA8); return __p==global::System.IntPtr.Zero?null:new ClothConfigBase(__p); } set => SetAt(0xA8, value?.Pointer ?? global::System.IntPtr.Zero); }
        public ClothConfigBase ChaosClothSimConfig { get { var __p = GetAt<global::System.IntPtr>(0xB0); return __p==global::System.IntPtr.Zero?null:new ClothConfigBase(__p); } set => SetAt(0xB0, value?.Pointer ?? global::System.IntPtr.Zero); }
        public TArray<global::System.IntPtr> ClothLODData => new TArray<global::System.IntPtr>(AddrOf(0xB8)); // TArray<UObject*>
        public TArray<global::System.IntPtr> LODData => new TArray<global::System.IntPtr>(AddrOf(0xC8)); // TArray<struct>
        public TArray<global::System.IntPtr> LodMap => new TArray<global::System.IntPtr>(AddrOf(0xD8)); // TArray<int32>
        public TArray<global::System.IntPtr> UsedBoneNames => new TArray<global::System.IntPtr>(AddrOf(0xE8)); // TArray<FName>
        public TArray<global::System.IntPtr> UsedBoneIndices => new TArray<global::System.IntPtr>(AddrOf(0xF8)); // TArray<int32>
        public int ReferenceBoneIndex { get => GetAt<int>(0x108); set => SetAt(0x108, value); }
        public ClothingAssetCustomData CustomData { get { var __p = GetAt<global::System.IntPtr>(0x110); return __p==global::System.IntPtr.Zero?null:new ClothingAssetCustomData(__p); } set => SetAt(0x110, value?.Pointer ?? global::System.IntPtr.Zero); }
    ...
    public class ClothLODDataCommon_Legacy : Object
    {
        ...
        public ClothLODDataCommon_Legacy(global::System.IntPtr ptr) : base(ptr) {}
        public static new ClothLODDataCommon_Legacy FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ClothLODDataCommon_Legacy(p);
        ...
        public ClothPhysicalMeshDataBase_Legacy PhysicalMeshData { get { var __p = GetAt<global::System.IntPtr>(0x28); return __p==global::System.IntPtr.Zero?null:new ClothPhysicalMeshDataBase_Legacy(__p); } set => SetAt(0x28, value?.Pointer ?? global::System.IntPtr.Zero); }
