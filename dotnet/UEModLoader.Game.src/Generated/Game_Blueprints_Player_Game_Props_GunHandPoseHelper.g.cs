...
namespace UEModLoader.Game
{
    public class GunHandPoseHelper_C : ActorComponent
    {
        ...
        public GunHandPoseHelper_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new GunHandPoseHelper_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new GunHandPoseHelper_C(p);
        ...
        public VR4DynamicHandPoseComponent HandPoseObject_PrimaryGripGrabbedStatic { get { var __p = GetAt<global::System.IntPtr>(0xE0); return __p==global::System.IntPtr.Zero?null:new VR4DynamicHandPoseComponent(__p); } set => SetAt(0xE0, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public VR4GamePlayerGun OwningGun { get { var __p = GetAt<global::System.IntPtr>(0xF0); return __p==global::System.IntPtr.Zero?null:new VR4GamePlayerGun(__p); } set => SetAt(0xF0, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public VR4DynamicHandPoseComponent HandPoseObject_PrimaryGripGrabbedAnim { get { var __p = GetAt<global::System.IntPtr>(0x100); return __p==global::System.IntPtr.Zero?null:new VR4DynamicHandPoseComponent(__p); } set => SetAt(0x100, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public void SetHandPoses(global::System.IntPtr Normal, global::System.IntPtr TriggerDiscipline, global::System.IntPtr PullTrigger)
        {
            var __pb = new ParamBuffer(48);
            __pb.Set<global::System.IntPtr>(0x0, Normal);
            __pb.Set<global::System.IntPtr>(0x10, TriggerDiscipline);
            __pb.Set<global::System.IntPtr>(0x20, PullTrigger);
            CallRaw("SetHandPoses", __pb.Bytes);
        }
        public void PlayPrimaryGripHandPoseAnimation(global::System.IntPtr HandPoses)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, HandPoses);
