...
namespace UEModLoader.Game
{
    public class HelpSelection_C : VR4UIScreen
    {
        ...
        public HelpSelection_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new HelpSelection_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new HelpSelection_C(p);
        ...
        public SceneComponent RightPanel { get { var __p = GetAt<global::System.IntPtr>(0x258); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x258, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent Info { get { var __p = GetAt<global::System.IntPtr>(0x260); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x260, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent LeftPanel { get { var __p = GetAt<global::System.IntPtr>(0x268); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x268, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent LowerTray { get { var __p = GetAt<global::System.IntPtr>(0x270); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x270, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent Center { get { var __p = GetAt<global::System.IntPtr>(0x278); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x278, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public Actor BindingActor { get { var __p = GetAt<global::System.IntPtr>(0x288); return __p==global::System.IntPtr.Zero?null:new Actor(__p); } set => SetAt(0x288, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4UIButtonComponent HelpButton { get { var __p = GetAt<global::System.IntPtr>(0x290); return __p==global::System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x290, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public TArray<global::System.IntPtr> ButtonList => new TArray<global::System.IntPtr>(AddrOf(0x2A0)); // TArray<UObject*>
        public UI_PauseMenu_Header_BP_C Header { get { var __p = GetAt<global::System.IntPtr>(0x2B0); return __p==global::System.IntPtr.Zero?null:new UI_PauseMenu_Header_BP_C(__p); } set => SetAt(0x2B0, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public void HelpButtonPressed(VR4UIComponent component, global::System.IntPtr State)
        {
