...
namespace UEModLoader.Game
{
    public class LoadGameEntry_BP_C : Actor
    {
        ...
        public LoadGameEntry_BP_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new LoadGameEntry_BP_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new LoadGameEntry_BP_C(p);
        ...
        public WidgetComponent Widget_Entry { get { var __p = GetAt<global::System.IntPtr>(0x228); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x228, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public UI_LoadGame_Entry_Widget_C Ref_Entry_Widget { get { var __p = GetAt<global::System.IntPtr>(0x250); return __p==global::System.IntPtr.Zero?null:new UI_LoadGame_Entry_Widget_C(__p); } set => SetAt(0x250, value?.Pointer ?? global::System.IntPtr.Zero); }
        public void SetEntryText(bool SetEntryBlank, int Index, global::System.IntPtr Chapter, int Saves, global::System.IntPtr Time, int Round, EGameMode Mode, bool IsEndGameSave)
        {
