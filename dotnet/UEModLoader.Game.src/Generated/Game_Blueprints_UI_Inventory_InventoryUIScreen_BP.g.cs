...
namespace UEModLoader.Game
{
    public class InventoryUIScreen_BP_C : VR4InventoryUIScreen
    {
        ...
        public InventoryUIScreen_BP_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new InventoryUIScreen_BP_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new InventoryUIScreen_BP_C(p);
        ...
        public SceneComponent ExitPromptPoint { get { var __p = GetAt<global::System.IntPtr>(0x3C8); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x3C8, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent AttachePoint { get { var __p = GetAt<global::System.IntPtr>(0x3D0); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x3D0, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public TArray<global::System.IntPtr> QuickSelectSlots => new TArray<global::System.IntPtr>(AddrOf(0x3E0)); // TArray<UObject*>
        public Inventory_QuickSelectSlot_BP_C DroppedQuickSelectSlot { get { var __p = GetAt<global::System.IntPtr>(0x3F0); return __p==global::System.IntPtr.Zero?null:new Inventory_QuickSelectSlot_BP_C(__p); } set => SetAt(0x3F0, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Inventory_GridHighlight_C GridHighlight { get { var __p = GetAt<global::System.IntPtr>(0x3F8); return __p==global::System.IntPtr.Zero?null:new Inventory_GridHighlight_C(__p); } set => SetAt(0x3F8, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Inventory_GridHighlight_C GridHighlight_RightHand { get { var __p = GetAt<global::System.IntPtr>(0x400); return __p==global::System.IntPtr.Zero?null:new Inventory_GridHighlight_C(__p); } set => SetAt(0x400, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public InventoryScreen_ExitPrompt_BP_C ExitPrompt { get { var __p = GetAt<global::System.IntPtr>(0x410); return __p==global::System.IntPtr.Zero?null:new InventoryScreen_ExitPrompt_BP_C(__p); } set => SetAt(0x410, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4ItemTransform LastUniqueMoveTransform => new VR4ItemTransform(AddrOf(0x418));
        public AttacheCase LastUniqueMoveCase { get { var __p = GetAt<global::System.IntPtr>(0x428); return __p==global::System.IntPtr.Zero?null:new AttacheCase(__p); } set => SetAt(0x428, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public InventoryScreen_LeonDisplay_BP_C LeonDisplay { get { var __p = GetAt<global::System.IntPtr>(0x438); return __p==global::System.IntPtr.Zero?null:new InventoryScreen_LeonDisplay_BP_C(__p); } set => SetAt(0x438, value?.Pointer ?? global::System.IntPtr.Zero); }
        public global::System.IntPtr OnGrabbedItem => AddrOf(0x440); // 
        public global::System.IntPtr OnReleasedItem => AddrOf(0x450); // 
        public global::System.IntPtr OnCancelledMoveItem => AddrOf(0x460); // 
        public VR4UIButtonComponent LeonDisplayButton { get { var __p = GetAt<global::System.IntPtr>(0x470); return __p==global::System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x470, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4UIButtonComponent AshleyDisplayButton { get { var __p = GetAt<global::System.IntPtr>(0x478); return __p==global::System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x478, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4UIComponent DragAndDropTarget { get { var __p = GetAt<global::System.IntPtr>(0x480); return __p==global::System.IntPtr.Zero?null:new VR4UIComponent(__p); } set => SetAt(0x480, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public void UpdateCharacterDisplayState(global::System.IntPtr ItemHandle)
        {
            var __pb = new ParamBuffer(8);
            __pb.Set<global::System.IntPtr>(0x0, ItemHandle);
        ...
        public void UpdateQuickSlotState(global::System.IntPtr ItemHandle)
        {
            var __pb = new ParamBuffer(8);
            __pb.Set<global::System.IntPtr>(0x0, ItemHandle);
