...
namespace UEModLoader.Game
{
    ...
    {
        public InAppPurchaseProductInfo(global::System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public InAppPurchaseRestoreInfo(global::System.IntPtr ptr) : base(ptr) {}
        public string Identifier => Native.ReadFStringAt(AddrOf(0x0)); // FString
    ...
    {
        public NamedInterfaceDef(global::System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public NamedInterface(global::System.IntPtr ptr) : base(ptr) {}
        public string InterfaceName => Native.FNameToString(GetAt<int>(0x0)); // FName
        public FName InterfaceName_Raw { get => GetAt<FName>(0x0); set => SetAt(0x0, value); }
        public Object InterfaceObject { get { var __p = GetAt<global::System.IntPtr>(0x8); return __p==global::System.IntPtr.Zero?null:new Object(__p); } set => SetAt(0x8, value?.Pointer ?? global::System.IntPtr.Zero); }
    }

    public class InAppPurchaseProductRequest : StructProxy
    {
        public InAppPurchaseProductRequest(global::System.IntPtr ptr) : base(ptr) {}
    ...
    public class NamedInterfaces : Object
    {
        ...
        public NamedInterfaces(global::System.IntPtr ptr) : base(ptr) {}
        public static new NamedInterfaces FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new NamedInterfaces(p);
        ...
        public TArray<global::System.IntPtr> NamedInterfaces_2 => new TArray<global::System.IntPtr>(AddrOf(0x28)); // TArray<struct>
        public TArray<global::System.IntPtr> NamedInterfaceDefs => new TArray<global::System.IntPtr>(AddrOf(0x38)); // TArray<struct>
    }

    public class TurnBasedMatchInterface : Interface
    {
        public const string UeClassName = "TurnBasedMatchInterface";
        public TurnBasedMatchInterface(global::System.IntPtr ptr) : base(ptr) {}
        public static new TurnBasedMatchInterface FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new TurnBasedMatchInterface(p);
        ...
        public void OnMatchReceivedTurn(global::System.IntPtr Match, bool bDidBecomeActive)
        {
            var __pb = new ParamBuffer(17);
            __pb.Set<global::System.IntPtr>(0x0, Match);
            __pb.Set<byte>(0x10, (byte)(bDidBecomeActive?1:0));
            CallRaw("OnMatchReceivedTurn", __pb.Bytes);
        }
        public void OnMatchEnded(global::System.IntPtr Match)
        {
