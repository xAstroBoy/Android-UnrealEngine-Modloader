...
namespace UEModLoader.Game
{
    public class UI_PauseMenu_Tab_Widget_C : UserWidget
    {
        ...
        public UI_PauseMenu_Tab_Widget_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new UI_PauseMenu_Tab_Widget_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new UI_PauseMenu_Tab_Widget_C(p);
        ...
        public Image Image_BG_Narrow { get { var __p = GetAt<global::System.IntPtr>(0x238); return __p==global::System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x238, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Image Image_BG_Wide { get { var __p = GetAt<global::System.IntPtr>(0x240); return __p==global::System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x240, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Image Image_BGFlash_Narrow { get { var __p = GetAt<global::System.IntPtr>(0x248); return __p==global::System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x248, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Image Image_BGFlash_Wide { get { var __p = GetAt<global::System.IntPtr>(0x250); return __p==global::System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x250, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Image Image_BGHighlight_Narrow { get { var __p = GetAt<global::System.IntPtr>(0x258); return __p==global::System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x258, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Image Image_BGHighlight_Wide { get { var __p = GetAt<global::System.IntPtr>(0x260); return __p==global::System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x260, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Image Image_Icon { get { var __p = GetAt<global::System.IntPtr>(0x268); return __p==global::System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x268, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Image Image_IconHighlight { get { var __p = GetAt<global::System.IntPtr>(0x270); return __p==global::System.IntPtr.Zero?null:new Image(__p); } set => SetAt(0x270, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Overlay Overlay_NewIndicator { get { var __p = GetAt<global::System.IntPtr>(0x278); return __p==global::System.IntPtr.Zero?null:new Overlay(__p); } set => SetAt(0x278, value?.Pointer ?? global::System.IntPtr.Zero); }
        public UI_NewNotification_C UI_NewNotification { get { var __p = GetAt<global::System.IntPtr>(0x280); return __p==global::System.IntPtr.Zero?null:new UI_NewNotification_C(__p); } set => SetAt(0x280, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public global::System.IntPtr MercenariesColors => AddrOf(0x4C0); // struct UI_WidgetColorsMercenaries_Struct
        ...
        public void ChangeColors(global::System.IntPtr IconColor, global::System.IntPtr HighlightColor, global::System.IntPtr BackgroundColor)
        {
            var __pb = new ParamBuffer(120);
            __pb.Set<global::System.IntPtr>(0x0, IconColor);
            __pb.Set<global::System.IntPtr>(0x28, HighlightColor);
