...
namespace UEModLoader.Game
{
    public class BP_DynamicTutorialManager_C : VR4DynamicTutorialManager
    {
        ...
        public BP_DynamicTutorialManager_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new BP_DynamicTutorialManager_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new BP_DynamicTutorialManager_C(p);
        ...
        public SceneComponent DefaultSceneRoot { get { var __p = GetAt<global::System.IntPtr>(0x2E8); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x2E8, value?.Pointer ?? global::System.IntPtr.Zero); }
        public TutorialHand_Base_BP_C LeftHandOverride { get { var __p = GetAt<global::System.IntPtr>(0x2F0); return __p==global::System.IntPtr.Zero?null:new TutorialHand_Base_BP_C(__p); } set => SetAt(0x2F0, value?.Pointer ?? global::System.IntPtr.Zero); }
        public TutorialHand_Base_BP_C RightHandOverride { get { var __p = GetAt<global::System.IntPtr>(0x2F8); return __p==global::System.IntPtr.Zero?null:new TutorialHand_Base_BP_C(__p); } set => SetAt(0x2F8, value?.Pointer ?? global::System.IntPtr.Zero); }
