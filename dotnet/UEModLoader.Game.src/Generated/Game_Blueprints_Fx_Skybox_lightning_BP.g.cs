...
namespace UEModLoader.Game
{
    public class Skybox_lightning_BP_C : Actor
    {
        ...
        public Skybox_lightning_BP_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new Skybox_lightning_BP_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new Skybox_lightning_BP_C(p);
        ...
        public ArrowComponent LightDirectionArrow { get { var __p = GetAt<global::System.IntPtr>(0x228); return __p==global::System.IntPtr.Zero?null:new ArrowComponent(__p); } set => SetAt(0x228, value?.Pointer ?? global::System.IntPtr.Zero); }
        public StaticMeshComponent SkyboxMesh { get { var __p = GetAt<global::System.IntPtr>(0x230); return __p==global::System.IntPtr.Zero?null:new StaticMeshComponent(__p); } set => SetAt(0x230, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SpotLightComponent SpotLight { get { var __p = GetAt<global::System.IntPtr>(0x238); return __p==global::System.IntPtr.Zero?null:new SpotLightComponent(__p); } set => SetAt(0x238, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public MaterialInstanceDynamic SkyMaterial { get { var __p = GetAt<global::System.IntPtr>(0x248); return __p==global::System.IntPtr.Zero?null:new MaterialInstanceDynamic(__p); } set => SetAt(0x248, value?.Pointer ?? global::System.IntPtr.Zero); }
        public TArray<global::System.IntPtr> LightningLocations => new TArray<global::System.IntPtr>(AddrOf(0x250)); // TArray<struct>
