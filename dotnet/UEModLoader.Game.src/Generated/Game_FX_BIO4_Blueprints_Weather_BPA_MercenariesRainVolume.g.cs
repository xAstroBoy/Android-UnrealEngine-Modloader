...
namespace UEModLoader.Game
{
    public class BPA_MercenariesRainVolume_C : Actor
    {
        ...
        public BPA_MercenariesRainVolume_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new BPA_MercenariesRainVolume_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new BPA_MercenariesRainVolume_C(p);
        ...
        public AudioComponent LightningAudio { get { var __p = GetAt<global::System.IntPtr>(0x228); return __p==global::System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x228, value?.Pointer ?? global::System.IntPtr.Zero); }
        public AudioComponent RainAudio { get { var __p = GetAt<global::System.IntPtr>(0x230); return __p==global::System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x230, value?.Pointer ?? global::System.IntPtr.Zero); }
        public ParticleSystemComponent ParticleSystem { get { var __p = GetAt<global::System.IntPtr>(0x238); return __p==global::System.IntPtr.Zero?null:new ParticleSystemComponent(__p); } set => SetAt(0x238, value?.Pointer ?? global::System.IntPtr.Zero); }
        public BPC_RainLogic_C BPC_RainLogic { get { var __p = GetAt<global::System.IntPtr>(0x240); return __p==global::System.IntPtr.Zero?null:new BPC_RainLogic_C(__p); } set => SetAt(0x240, value?.Pointer ?? global::System.IntPtr.Zero); }
        public BPFX_MercenariesLightning_C Lightning_FX { get { var __p = GetAt<global::System.IntPtr>(0x248); return __p==global::System.IntPtr.Zero?null:new BPFX_MercenariesLightning_C(__p); } set => SetAt(0x248, value?.Pointer ?? global::System.IntPtr.Zero); }
        public MinMaxFloat LightningTimerRange => new MinMaxFloat(AddrOf(0x250));
        public TArray<global::System.IntPtr> LightningSound => new TArray<global::System.IntPtr>(AddrOf(0x258)); // TArray<UObject*>
