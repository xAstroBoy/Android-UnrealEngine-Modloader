...
namespace UEModLoader.Game
{
    public class ShootingRangeCoverScreen_BP_C : LoadGameCoverScreen_Base_BP_C
    {
        ...
        public ShootingRangeCoverScreen_BP_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new ShootingRangeCoverScreen_BP_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ShootingRangeCoverScreen_BP_C(p);
        ...
        public WidgetComponent Widget_Heading { get { var __p = GetAt<global::System.IntPtr>(0x260); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x260, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4UIButtonComponent VR4UIButton_loadSave { get { var __p = GetAt<global::System.IntPtr>(0x268); return __p==global::System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x268, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4UIButtonComponent VR4UIButton_practiceMode { get { var __p = GetAt<global::System.IntPtr>(0x270); return __p==global::System.IntPtr.Zero?null:new VR4UIButtonComponent(__p); } set => SetAt(0x270, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent Button { get { var __p = GetAt<global::System.IntPtr>(0x278); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x278, value?.Pointer ?? global::System.IntPtr.Zero); }
        public WidgetComponent LoadSave_Button_Widget { get { var __p = GetAt<global::System.IntPtr>(0x280); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x280, value?.Pointer ?? global::System.IntPtr.Zero); }
        public WidgetComponent PracticeMode_Button_Widget { get { var __p = GetAt<global::System.IntPtr>(0x288); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x288, value?.Pointer ?? global::System.IntPtr.Zero); }
        public UI_MainMenu_NewGame_Button_Widget_C Ref_PracticeModeButton { get { var __p = GetAt<global::System.IntPtr>(0x290); return __p==global::System.IntPtr.Zero?null:new UI_MainMenu_NewGame_Button_Widget_C(__p); } set => SetAt(0x290, value?.Pointer ?? global::System.IntPtr.Zero); }
        public UI_MainMenu_NewGame_Button_Widget_C Ref_LoadSaveButton { get { var __p = GetAt<global::System.IntPtr>(0x298); return __p==global::System.IntPtr.Zero?null:new UI_MainMenu_NewGame_Button_Widget_C(__p); } set => SetAt(0x298, value?.Pointer ?? global::System.IntPtr.Zero); }
        public UI_CoverScreen_Widget_C Ref_HeadingWidget { get { var __p = GetAt<global::System.IntPtr>(0x2A0); return __p==global::System.IntPtr.Zero?null:new UI_CoverScreen_Widget_C(__p); } set => SetAt(0x2A0, value?.Pointer ?? global::System.IntPtr.Zero); }
        public global::System.IntPtr StartPracticeMode => AddrOf(0x2A8); // 
