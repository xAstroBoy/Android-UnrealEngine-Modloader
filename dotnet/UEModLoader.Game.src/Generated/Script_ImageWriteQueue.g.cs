...
namespace UEModLoader.Game
{
    ...
    {
        public ImageWriteOptions(global::System.IntPtr ptr) : base(ptr) {}
        public EDesiredImageFormat Format { get => (EDesiredImageFormat)GetAt<byte>(0x0); set => SetAt(0x0, (byte)value); }
        public global::System.IntPtr OnComplete => AddrOf(0x4); // 
    ...
    public class ImageWriteBlueprintLibrary : BlueprintFunctionLibrary
    {
        ...
        public ImageWriteBlueprintLibrary(global::System.IntPtr ptr) : base(ptr) {}
        public static new ImageWriteBlueprintLibrary FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ImageWriteBlueprintLibrary(p);
        ...
        public static global::System.IntPtr NativeFunc_ExportToDisk => Memory.ModuleBase() + 0x702EC74;
        public void ExportToDisk(Texture Texture, global::System.IntPtr Filename, global::System.IntPtr Options)
        {
            var __pb = new ParamBuffer(128);
            __pb.SetObject(0x0, Texture);
            __pb.Set<global::System.IntPtr>(0x8, Filename);
            __pb.Set<global::System.IntPtr>(0x20, Options);
