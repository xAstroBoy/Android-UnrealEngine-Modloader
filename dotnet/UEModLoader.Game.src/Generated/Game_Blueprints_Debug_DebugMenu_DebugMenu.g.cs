...
namespace UEModLoader.Game
{
    public class DebugMenu_C : VR4DebugScreenActor
    {
        ...
        public DebugMenu_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new DebugMenu_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new DebugMenu_C(p);
        ...
        public VR4Bio4PlayerPawn Player { get { var __p = GetAt<global::System.IntPtr>(0x238); return __p==global::System.IntPtr.Zero?null:new VR4Bio4PlayerPawn(__p); } set => SetAt(0x238, value?.Pointer ?? global::System.IntPtr.Zero); }
        public TArray<global::System.IntPtr> ActiveOptionList => new TArray<global::System.IntPtr>(AddrOf(0x240)); // TArray<FName>
        public TArray<global::System.IntPtr> ActiveOptionsWidgets => new TArray<global::System.IntPtr>(AddrOf(0x250)); // TArray<UObject*>
        ...
        public TArray<global::System.IntPtr> BoolStrings => new TArray<global::System.IntPtr>(AddrOf(0x268)); // TArray<FString>
        public DebugMenuWidget_C ParentWidget { get { var __p = GetAt<global::System.IntPtr>(0x278); return __p==global::System.IntPtr.Zero?null:new DebugMenuWidget_C(__p); } set => SetAt(0x278, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public stage1debugmap_C Stage1Map { get { var __p = GetAt<global::System.IntPtr>(0x288); return __p==global::System.IntPtr.Zero?null:new stage1debugmap_C(__p); } set => SetAt(0x288, value?.Pointer ?? global::System.IntPtr.Zero); }
        public stage2debugmap_C Stage2Map { get { var __p = GetAt<global::System.IntPtr>(0x290); return __p==global::System.IntPtr.Zero?null:new stage2debugmap_C(__p); } set => SetAt(0x290, value?.Pointer ?? global::System.IntPtr.Zero); }
        public stage3debugmap_C Stage3Map { get { var __p = GetAt<global::System.IntPtr>(0x298); return __p==global::System.IntPtr.Zero?null:new stage3debugmap_C(__p); } set => SetAt(0x298, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public TArray<global::System.IntPtr> PIckupItemQuickMenu => new TArray<global::System.IntPtr>(AddrOf(0x2B0)); // TArray<enum>
        public bool ShowAllItems { get => Native.GetPropBool(Pointer, "ShowAllItems"); set => Native.SetPropBool(Pointer, "ShowAllItems", value); }
        public TArray<global::System.IntPtr> PreviousMenus => new TArray<global::System.IntPtr>(AddrOf(0x2C8)); // TArray<uint8>
        ...
        public TArray<global::System.IntPtr> Favorites => new TArray<global::System.IntPtr>(AddrOf(0x388)); // TArray<FName>
        ...
        public global::System.IntPtr UnlockTooltipText => AddrOf(0x3B0); // 
        ...
        public void BuildUnlockableTooltips(global::System.IntPtr OptionName, global::System.IntPtr Tooltip)
        {
            var __pb = new ParamBuffer(32);
            __pb.Set<global::System.IntPtr>(0x0, OptionName);
            __pb.Set<global::System.IntPtr>(0x10, Tooltip);
            CallRaw("BuildUnlockableTooltips", __pb.Bytes);
        }
        public void IsUnlockEnabled(EMercenariesUnlockable MercenariesUnlock, global::System.IntPtr EnchancementString, bool IsUnlocked, bool IsEnabled)
        {
            var __pb = new ParamBuffer(26);
            __pb.Set<byte>(0x0, (byte)MercenariesUnlock);
            __pb.Set<global::System.IntPtr>(0x8, EnchancementString);
            __pb.Set<byte>(0x18, (byte)(IsUnlocked?1:0));
            __pb.Set<byte>(0x19, (byte)(IsEnabled?1:0));
            CallRaw("IsUnlockEnabled", __pb.Bytes);
        }
        public void ProcessUnlocks(global::System.IntPtr OptionName)
        {
        ...
        public void ProcessNewRaiseWeaponSetting(global::System.IntPtr Setting)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, Setting);
        ...
        public void ProcessCutsceneSetting(global::System.IntPtr NewSetting)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, NewSetting);
            CallRaw("ProcessCutsceneSetting", __pb.Bytes);
        }
        public void ProcessFinishGameDifficulty(global::System.IntPtr NewSetting)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, NewSetting);
        ...
        public void ProcessFogSetting(global::System.IntPtr NewSetting)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, NewSetting);
        ...
        public void ProcessPixelDensitySetting(global::System.IntPtr NewSetting)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, NewSetting);
            CallRaw("ProcessPixelDensitySetting", __pb.Bytes);
        }
        public void CreateActiveOption(global::System.IntPtr Option)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, Option);
            CallRaw("CreateActiveOption", __pb.Bytes);
        }
        public void ProcessParticleSetting(global::System.IntPtr NewSetting)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, NewSetting);
            CallRaw("ProcessParticleSetting", __pb.Bytes);
        }
        public void BuildTooltip(global::System.IntPtr Return)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, Return);
        ...
        public void GetActiveOption(global::System.IntPtr CurrentOption)
        {
            var __pb = new ParamBuffer(72);
            __pb.Set<global::System.IntPtr>(0x0, CurrentOption);
            CallRaw("GetActiveOption", __pb.Bytes);
        }
        public void GetOptionIndex(global::System.IntPtr Option, int CurrentIndex)
        {
        ...
        public void ProcessNewSetting(global::System.IntPtr NewSetting)
        {
            var __pb = new ParamBuffer(16);
            __pb.Set<global::System.IntPtr>(0x0, NewSetting);
