...
namespace UEModLoader.Game
{
    ...
    {
        public ChaosPhysicsCollisionInfo(global::System.IntPtr ptr) : base(ptr) {}
        public PrimitiveComponent component { get { var __p = GetAt<global::System.IntPtr>(0x0); return __p==global::System.IntPtr.Zero?null:new PrimitiveComponent(__p); } set => SetAt(0x0, value?.Pointer ?? global::System.IntPtr.Zero); }
        public PrimitiveComponent OtherComponent { get { var __p = GetAt<global::System.IntPtr>(0x8); return __p==global::System.IntPtr.Zero?null:new PrimitiveComponent(__p); } set => SetAt(0x8, value?.Pointer ?? global::System.IntPtr.Zero); }
    ...
    {
        public ChaosBreakEvent(global::System.IntPtr ptr) : base(ptr) {}
        public PrimitiveComponent component { get { var __p = GetAt<global::System.IntPtr>(0x0); return __p==global::System.IntPtr.Zero?null:new PrimitiveComponent(__p); } set => SetAt(0x0, value?.Pointer ?? global::System.IntPtr.Zero); }
    ...
    {
        public ChaosHandlerSet(global::System.IntPtr ptr) : base(ptr) {}
        public global::System.IntPtr ChaosHandlers => AddrOf(0x8); // 
    }

    public class BreakEventCallbackWrapper : StructProxy
    {
        public BreakEventCallbackWrapper(global::System.IntPtr ptr) : base(ptr) {}
    }

    public class ChaosDebugSubstepControl : StructProxy
    {
        public ChaosDebugSubstepControl(global::System.IntPtr ptr) : base(ptr) {}
    ...
    public class ChaosDebugDrawComponent : ActorComponent
    {
        ...
        public ChaosDebugDrawComponent(global::System.IntPtr ptr) : base(ptr) {}
        public static new ChaosDebugDrawComponent FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ChaosDebugDrawComponent(p);
    ...
    public class ChaosEventListenerComponent : ActorComponent
    {
        ...
        public ChaosEventListenerComponent(global::System.IntPtr ptr) : base(ptr) {}
        public static new ChaosEventListenerComponent FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ChaosEventListenerComponent(p);
    ...
    public class ChaosGameplayEventDispatcher : ChaosEventListenerComponent
    {
        ...
        public ChaosGameplayEventDispatcher(global::System.IntPtr ptr) : base(ptr) {}
        public static new ChaosGameplayEventDispatcher FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ChaosGameplayEventDispatcher(p);
        ...
        public global::System.IntPtr CollisionEventRegistrations => AddrOf(0x1C8); // 
        public global::System.IntPtr BreakEventRegistrations => AddrOf(0x218); // 
    }

    public class ChaosNotifyHandlerInterface : Interface
    {
        public const string UeClassName = "ChaosNotifyHandlerInterface";
        public ChaosNotifyHandlerInterface(global::System.IntPtr ptr) : base(ptr) {}
        public static new ChaosNotifyHandlerInterface FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ChaosNotifyHandlerInterface(p);
    ...
    public class ChaosSolverEngineBlueprintLibrary : BlueprintFunctionLibrary
    {
        ...
        public ChaosSolverEngineBlueprintLibrary(global::System.IntPtr ptr) : base(ptr) {}
        public static new ChaosSolverEngineBlueprintLibrary FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ChaosSolverEngineBlueprintLibrary(p);
        ...
        public static global::System.IntPtr NativeFunc_ConvertPhysicsCollisionToHitResult => Memory.ModuleBase() + 0x9237918;
        public global::System.IntPtr ConvertPhysicsCollisionToHitResult(global::System.IntPtr PhysicsCollision)
        {
            var __pb = new ParamBuffer(248);
            __pb.Set<global::System.IntPtr>(0x0, PhysicsCollision);
    ...
    public class ChaosSolver : Object
    {
        ...
        public ChaosSolver(global::System.IntPtr ptr) : base(ptr) {}
        public static new ChaosSolver FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ChaosSolver(p);
    ...
    public class ChaosSolverActor : Actor
    {
        ...
        public ChaosSolverActor(global::System.IntPtr ptr) : base(ptr) {}
        public static new ChaosSolverActor FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ChaosSolverActor(p);
        ...
        public BillboardComponent SpriteComponent { get { var __p = GetAt<global::System.IntPtr>(0x280); return __p==global::System.IntPtr.Zero?null:new BillboardComponent(__p); } set => SetAt(0x280, value?.Pointer ?? global::System.IntPtr.Zero); }
        public ChaosGameplayEventDispatcher GameplayEventDispatcherComponent { get { var __p = GetAt<global::System.IntPtr>(0x2A0); return __p==global::System.IntPtr.Zero?null:new ChaosGameplayEventDispatcher(__p); } set => SetAt(0x2A0, value?.Pointer ?? global::System.IntPtr.Zero); }
        /// <summary>[Native] thunk RVA 0x9238F64 — hookable via Hooks.InstallAt(NativeFunc_SetSolverActive).</summary>
        public static global::System.IntPtr NativeFunc_SetSolverActive => Memory.ModuleBase() + 0x9238F64;
        ...
        public static global::System.IntPtr NativeFunc_SetAsCurrentWorldSolver => Memory.ModuleBase() + 0x9239018;
    ...
    public class ChaosSolverSettings : DeveloperSettings
    {
        ...
        public ChaosSolverSettings(global::System.IntPtr ptr) : base(ptr) {}
        public static new ChaosSolverSettings FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new ChaosSolverSettings(p);
