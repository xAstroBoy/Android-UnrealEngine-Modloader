...
// Package: /Game/Blueprints/Player/Game/Props/Holsters/PropHolster_Gun1_Seated
using System;

namespace UEModLoader.Game
{
    public class PropHolster_Gun1_Seated_C : Base_PropHolster_Icon_C
    {
        public const string UeClassName = "PropHolster_Gun1_Seated_C";
        public PropHolster_Gun1_Seated_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new PropHolster_Gun1_Seated_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new PropHolster_Gun1_Seated_C(p);
        public static PropHolster_Gun1_Seated_C FirstOf() { var o = UObject.FindFirstOf(UeClassName); return o==null?null:new PropHolster_Gun1_Seated_C(o.Pointer); }
        public static PropHolster_Gun1_Seated_C[] All() { var a = UObject.FindAllOf(UeClassName); var r = new PropHolster_Gun1_Seated_C[a.Length]; for(int i=0;i<a.Length;i++) r[i]=new PropHolster_Gun1_Seated_C(a[i].Pointer); return r; }
        ...
        public void ExecuteUbergraph_PropHolster_Gun1_Seated(int EntryPoint)
        {
            var __pb = new ParamBuffer(4);
            __pb.Set(0x0, EntryPoint);
            CallRaw("ExecuteUbergraph_PropHolster_Gun1_Seated", __pb.Bytes);
        }
    }
