...
namespace UEModLoader.Game
{
    public class Button_Main_C : Actor
    {
        ...
        public Button_Main_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new Button_Main_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new Button_Main_C(p);
        ...
        public SceneComponent Root { get { var __p = GetAt<global::System.IntPtr>(0x238); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x238, value?.Pointer ?? global::System.IntPtr.Zero); }
        public global::System.IntPtr DisplayText => AddrOf(0x240); // 
        public int ButtonId { get => GetAt<int>(0x258); set => SetAt(0x258, value); }
        public Vector2D Size => new Vector2D(AddrOf(0x25C));
        public Button_MainWidget_C ButtonWidget { get { var __p = GetAt<global::System.IntPtr>(0x268); return __p==global::System.IntPtr.Zero?null:new Button_MainWidget_C(__p); } set => SetAt(0x268, value?.Pointer ?? global::System.IntPtr.Zero); }
        public global::System.IntPtr Colors => AddrOf(0x270); // struct Button_Main_Atr
        public bool Enabled { get => Native.GetPropBool(Pointer, "Enabled"); set => Native.SetPropBool(Pointer, "Enabled", value); }
        public global::System.IntPtr ButtonPressed => AddrOf(0x2F8); // 
        public VR4UIScreen ParentMenu { get { var __p = GetAt<global::System.IntPtr>(0x308); return __p==global::System.IntPtr.Zero?null:new VR4UIScreen(__p); } set => SetAt(0x308, value?.Pointer ?? global::System.IntPtr.Zero); }
