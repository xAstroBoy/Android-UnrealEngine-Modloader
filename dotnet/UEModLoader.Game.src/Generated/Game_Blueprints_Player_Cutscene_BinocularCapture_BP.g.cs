...
namespace UEModLoader.Game
{
    public class BinocularCapture_BP_C : Actor
    {
        ...
        public BinocularCapture_BP_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new BinocularCapture_BP_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new BinocularCapture_BP_C(p);
        ...
        public WidgetComponent BinocularOverlay { get { var __p = GetAt<global::System.IntPtr>(0x228); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x228, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneCaptureComponent2D BinocularCaptureComponent2D { get { var __p = GetAt<global::System.IntPtr>(0x230); return __p==global::System.IntPtr.Zero?null:new SceneCaptureComponent2D(__p); } set => SetAt(0x230, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public BinocularOverlay_BP_C Ref_Widget { get { var __p = GetAt<global::System.IntPtr>(0x248); return __p==global::System.IntPtr.Zero?null:new BinocularOverlay_BP_C(__p); } set => SetAt(0x248, value?.Pointer ?? global::System.IntPtr.Zero); }
        public VR4CutsceneManager_BP_C Ref_CutsceneManager { get { var __p = GetAt<global::System.IntPtr>(0x250); return __p==global::System.IntPtr.Zero?null:new VR4CutsceneManager_BP_C(__p); } set => SetAt(0x250, value?.Pointer ?? global::System.IntPtr.Zero); }
