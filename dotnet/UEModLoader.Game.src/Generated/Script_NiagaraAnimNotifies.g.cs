...
namespace UEModLoader.Game
{
    public class AnimNotifyState_TimedNiagaraEffect : AnimNotifyState
    {
        ...
        public AnimNotifyState_TimedNiagaraEffect(global::System.IntPtr ptr) : base(ptr) {}
        public static new AnimNotifyState_TimedNiagaraEffect FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new AnimNotifyState_TimedNiagaraEffect(p);
        ...
        public NiagaraSystem Template { get { var __p = GetAt<global::System.IntPtr>(0x30); return __p==global::System.IntPtr.Zero?null:new NiagaraSystem(__p); } set => SetAt(0x30, value?.Pointer ?? global::System.IntPtr.Zero); }
    ...
    public class AnimNotify_PlayNiagaraEffect : AnimNotify
    {
        ...
        public AnimNotify_PlayNiagaraEffect(global::System.IntPtr ptr) : base(ptr) {}
        public static new AnimNotify_PlayNiagaraEffect FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new AnimNotify_PlayNiagaraEffect(p);
        ...
        public NiagaraSystem Template { get { var __p = GetAt<global::System.IntPtr>(0x38); return __p==global::System.IntPtr.Zero?null:new NiagaraSystem(__p); } set => SetAt(0x38, value?.Pointer ?? global::System.IntPtr.Zero); }
        public Vector LocationOffset => new Vector(AddrOf(0x40));
        public Rotator RotationOffset => new Rotator(AddrOf(0x4C));
        ...
        public static global::System.IntPtr NativeFunc_GetSpawnedEffect => Memory.ModuleBase() + 0x5BCD6A4;
        public FXSystemComponent GetSpawnedEffect()
        {
            var __pb = new ParamBuffer(8);
            CallRaw("GetSpawnedEffect", __pb.Bytes);
            { var __p = __pb.Get<global::System.IntPtr>(0x0); return __p==global::System.IntPtr.Zero?null:new FXSystemComponent(__p); }
        }
    }
