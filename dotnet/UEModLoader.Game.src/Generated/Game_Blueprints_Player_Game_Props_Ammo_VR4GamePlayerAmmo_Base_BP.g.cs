...
namespace UEModLoader.Game
{
    public class VR4GamePlayerAmmo_Base_BP_C : VR4GamePlayerAmmo
    {
        ...
        public VR4GamePlayerAmmo_Base_BP_C(global::System.IntPtr ptr) : base(ptr) {}
        public static new VR4GamePlayerAmmo_Base_BP_C FromPointer(global::System.IntPtr p) => p==global::System.IntPtr.Zero?null:new VR4GamePlayerAmmo_Base_BP_C(p);
        ...
        public AudioComponent SFX_Ammo_Grab { get { var __p = GetAt<global::System.IntPtr>(0x638); return __p==global::System.IntPtr.Zero?null:new AudioComponent(__p); } set => SetAt(0x638, value?.Pointer ?? global::System.IntPtr.Zero); }
        ...
        public VR4GamePlayerGripIKTarget PrimaryGripSkeletalIKTarget { get { var __p = GetAt<global::System.IntPtr>(0x658); return __p==global::System.IntPtr.Zero?null:new VR4GamePlayerGripIKTarget(__p); } set => SetAt(0x658, value?.Pointer ?? global::System.IntPtr.Zero); }
        public WidgetComponent AmmoCounterOutside { get { var __p = GetAt<global::System.IntPtr>(0x660); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x660, value?.Pointer ?? global::System.IntPtr.Zero); }
        public WidgetComponent AmmoCounterInside { get { var __p = GetAt<global::System.IntPtr>(0x668); return __p==global::System.IntPtr.Zero?null:new WidgetComponent(__p); } set => SetAt(0x668, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent Pivot { get { var __p = GetAt<global::System.IntPtr>(0x670); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x670, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SceneComponent TopRef { get { var __p = GetAt<global::System.IntPtr>(0x678); return __p==global::System.IntPtr.Zero?null:new SceneComponent(__p); } set => SetAt(0x678, value?.Pointer ?? global::System.IntPtr.Zero); }
        public SkeletalMeshComponent PouchMesh { get { var __p = GetAt<global::System.IntPtr>(0x680); return __p==global::System.IntPtr.Zero?null:new SkeletalMeshComponent(__p); } set => SetAt(0x680, value?.Pointer ?? global::System.IntPtr.Zero); }
        public AmmoPouch_AnimBP_C AnimBP { get { var __p = GetAt<global::System.IntPtr>(0x688); return __p==global::System.IntPtr.Zero?null:new AmmoPouch_AnimBP_C(__p); } set => SetAt(0x688, value?.Pointer ?? global::System.IntPtr.Zero); }
        public TArray<global::System.IntPtr> PouchMags => new TArray<global::System.IntPtr>(AddrOf(0x690)); // TArray<UObject*>
        ...
        public AmmoPouchWidget_C CounterInside { get { var __p = GetAt<global::System.IntPtr>(0x6D0); return __p==global::System.IntPtr.Zero?null:new AmmoPouchWidget_C(__p); } set => SetAt(0x6D0, value?.Pointer ?? global::System.IntPtr.Zero); }
        public AmmoPouchWidget_C CounterOutside { get { var __p = GetAt<global::System.IntPtr>(0x6D8); return __p==global::System.IntPtr.Zero?null:new AmmoPouchWidget_C(__p); } set => SetAt(0x6D8, value?.Pointer ?? global::System.IntPtr.Zero); }
        public TArray<global::System.IntPtr> ReloadHandPosePair => new TArray<global::System.IntPtr>(AddrOf(0x6E0)); // TArray<struct>
        ...
        public TArray<global::System.IntPtr> OriginalMats => new TArray<global::System.IntPtr>(AddrOf(0x6F8)); // TArray<UObject*>
