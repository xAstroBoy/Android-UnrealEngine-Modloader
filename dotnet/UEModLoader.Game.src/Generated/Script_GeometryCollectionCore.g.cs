...
namespace UEModLoader.Game
{
    ...
    {
        public RecordedTransformTrack(global::System.IntPtr ptr) : base(ptr) {}
        public TArray<global::System.IntPtr> Records => new TArray<global::System.IntPtr>(AddrOf(0x0)); // TArray<struct>
    }

    public class RecordedFrame : StructProxy
    {
        public RecordedFrame(global::System.IntPtr ptr) : base(ptr) {}
        public TArray<global::System.IntPtr> Transforms => new TArray<global::System.IntPtr>(AddrOf(0x0)); // TArray<struct>
        public TArray<global::System.IntPtr> TransformIndices => new TArray<global::System.IntPtr>(AddrOf(0x10)); // TArray<int32>
        public TArray<global::System.IntPtr> PreviousTransformIndices => new TArray<global::System.IntPtr>(AddrOf(0x20)); // TArray<int32>
        public TArray<global::System.IntPtr> DisabledFlags => new TArray<global::System.IntPtr>(AddrOf(0x30)); // TArray<bool>
        public TArray<global::System.IntPtr> Collisions => new TArray<global::System.IntPtr>(AddrOf(0x40)); // TArray<struct>
        public TArray<global::System.IntPtr> Breakings => new TArray<global::System.IntPtr>(AddrOf(0x50)); // TArray<struct>
        public global::System.IntPtr Trailings => AddrOf(0x60); // 
        public float Timestamp { get => GetAt<float>(0xB0); set => SetAt(0xB0, value); }
    }

    public class SolverTrailingData : StructProxy
    {
        public SolverTrailingData(global::System.IntPtr ptr) : base(ptr) {}
    ...
    {
        public SolverBreakingData(global::System.IntPtr ptr) : base(ptr) {}
        public Vector Location => new Vector(AddrOf(0x0));
        public Vector Velocity => new Vector(AddrOf(0xC));
        public Vector AngularVelocity => new Vector(AddrOf(0x18));
        public float Mass { get => GetAt<float>(0x24); set => SetAt(0x24, value); }
    ...
    {
        public SolverCollisionData(global::System.IntPtr ptr) : base(ptr) {}
        public Vector Location => new Vector(AddrOf(0x0));
