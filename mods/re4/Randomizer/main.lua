...
local POOL = {
    ...
    -- ── Everything else the ENGINE can actually construct ──────────────
    -- The pool listed 70 entries but only 26 distinct emIds, while the jump
    -- table (ArmEmCallProlog, the ground truth for "has a real init") says 75
    -- ids are usable: 67 native + the 8 cut villagers install_cut_villager_fix
    -- wires to the id-9 ganado init. So 49 usable enemies — the ENTIRE em4x
    -- ganado range included — were simply never listed, which is why variety
    -- felt thin. Only em4b/em4e have no init at all (vehicles / Houdai cannon).
    --
    -- Named by emId + the .das they load (from EmFileTbl -> FileTbl). NOT given
    -- invented character names — the existing HUNK/Wesker/Krauser labels in the
    ...
    {"Ashley  [em/pl11.das]", {3,0,0,0,0,0,0,232,3}, nil, "NPC / Player models", false, true},
    ...
    {"Ashley 2  [em/pl15.das]", {5,0,0,0,0,0,0,232,3}, nil, "NPC / Player models", false, true},
    {"Tyrant (em09)  [em/em10.das]", {9,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
    {"Ashley 3  [em/pl18.das]", {12,0,0,0,0,0,0,232,3}, nil, "NPC / Player models", false, true},
    ...
    {"Bella Sister  [em/em16.das]", {22,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"em17  [em/em17.das]", {23,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Merchant  [em/em18.das]", {24,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"em19  [em/em19.das]", {25,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Wolf (Friendly)  [em/em21.das]", {33,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Cow  [em/em26.das]", {38,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Black Bass  [em/em27.das]", {39,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Bat  [em/em29.das]", {41,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Novistador Boss  [em/em2c.das]", {44,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Spider  [em/em2e.das]", {46,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Salamander  [em/em2f.das]", {47,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Saddler NPC 0  [em/em30.das]", {48,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Saddler After  [em/em31.das]", {49,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Mendez NPC  [em/em34.das]", {52,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Truck  [em/em3b.das]", {59,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"Helicopter  [em/em3d.das]", {61,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    ...
    {"Saddler (Ada)  [em/em3f.das]", {63,0,0,0,0,0,0,232,3}, nil, "More Enemies", false, true},
    {"SW Zombie Ganado (em40)  [em/em40.das]", {64,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Zombie Ganado B (em41)  [em/em41.das]", {65,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Villager Ganado (em42)  [em/em42.das]", {66,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Soldier Ganado (em43)  [em/em43.das]", {67,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em44)  [em/em44.das]", {68,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em45)  [em/em45.das]", {69,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em46)  [em/em46a.das]", {70,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em47)  [em/em47.das]", {71,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em48)  [em/em48.das]", {72,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em49)  [em/em49.das]", {73,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em4a)  [em/em4a.das]", {74,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em4c)  [em/em4ca.das]", {76,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em4d)  [em/em4da.das]", {77,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"SW Ganado (em4f)  [em/em4fa.das]", {79,0,0,0,0,0,0,232,3}, nil, "em4x Ganados", false, true},
    {"HUNK  [em/em10.das] (cut villager -> id-9 ganado AI)", {6,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
    {"Police  [em/em10.das] (cut villager -> id-9 ganado AI)", {7,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
    {"em08  [em/em10.das] (cut villager -> id-9 ganado AI)", {8,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
    {"Krauser (NPC)  [em/em10.das] (cut villager -> id-9 ganado AI)", {10,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
    {"em0b  [em/em10.das] (cut villager -> id-9 ganado AI)", {11,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
    {"Wesker  [em/em10.das] (cut villager -> id-9 ganado AI)", {13,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
    {"Novistador Boss Event  [em/em10.das] (cut villager -> id-9 ganado AI)", {51,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
    {"Verdugo (No2)  [em/em10.das] (cut villager -> id-9 ganado AI)", {55,0,0,0,0,0,0,232,3}, nil, "Ganados (cut/extra)", false, true},
}
